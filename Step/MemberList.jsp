						...
						<div class="list-menu">
							<ul class="list">
                                <li class="menu active" id="lnb1">
									<a href="/GMQDisplay-master/Step/DeleteMember.jsp" onClick="location.href='/GMQDisplay-master/Step/MemberList.jsp';">회원 통합 목록</a>
								</li>
					...
					<div class="box-mymem-state">
						...
						<div class="my-info-manage">
							<div class="member info">
								<p class="link-arrow lrg" data-omni="info:profile view more">관리자 정보</p>
								<ul>
									<li>
...
try {
	 ...
	 Class.forName("org.gjt.mm.mysql.Driver");  
 	 Connection con4 = DriverManager.getConnection(db_url, db_id, db_password);

     String jsql4 = "select * from user";   
	 PreparedStatement  pstmt4 = con4.prepareStatement(jsql4);
	 ResultSet  rs4 = pstmt4.executeQuery();
%>		
					<div class="box-mymem-order">
						<header class="con-header-basic type01">
							<h2 class="con-tit">회원 통합 목록</h2>
						</header>
					</div>
					<!-- e : 주문 내역 -->
					...
					<div class="my-boardListWrap" id="my-boardListWrap">
						<div class="listHeader">
							<div class="head-area">
								<h3 class="tit" style="font-size: 1.5em; margin-bottom: 10px;">회원 조회</h3>
							</div>
						</div>
<%
		while(rs4.next()){
			String userID = rs4.getString("userID");   //  다음 각 함수들의 인수들은 테이블의 각 필드명들임
    		String userPassword =  rs4.getString("userPassword");	
									...
									<div class=" boardlist-area" data-omni="SM-A346N|SM-A346NLGBKOO"
										...
										<div class="my-boardlist">
											<div class="boardlist-image">
													...
													<h1 class="option" style="margin-top:30px;"><%=userName%></h1>
											...
											<div class="boardlist-spec">
												...
												<h1 class="title">비밀번호 : <%=userPassword%></h1>
											...
											<div class="boardlist-delete">
                                                <!-- 삭제버튼 -->
                                                <button type="button" class="btn-delete" name="deleteHotList" data-mno="<%=userID%>">
													<%=userName%> 삭제
												</button>
                                            </div>		
			</div>
...
<script>
	$(document).on('click', '.btn-delete', function() {
		...
		$.ajax({
			type: 'POST',
			url: '/GMQDisplay-master/Step/DeleteMember.jsp',
			data: { mno: mno },
