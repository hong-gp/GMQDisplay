...
try {
	...
	while(rs.next()){
			...
			String Mcompany = rs.getString("Mcompany");
    		String Mname =  rs.getString("Mname");	
			String Mlaunch = rs.getString("Mlaunch");
			int Mprice =  rs.getInt("Mprice");
			int Msale =  rs.getInt("Msale");						
%>
                                <li>
                                    ...
                                    <div class="boardlist-area" data-omni="SM-A346N|SM-A346NLGBKOO"
                                        ...
                                        <div style="display:none;" name="share-area">
                                            <form id="share-form-G000292151">
                                                <input type="hidden" name="title" value="<%=Mname%>">
                                                <input type="hidden" name="description" value="<%=Mno%>">
                                        ...
                                        <div class="my-boardlist">
                                            ...
                                            <div class="boardlist-spec">
                                                ...
                                                <!-- 모델코드 -->
                                                <p class="label"><%=Mno%></p>
                                                <p class="option"><%=rs.getString("Mlaunch")%></p>
                                            </div>
...
<script>
	$(document).on('click', '.btn-delete', function() {
		...
		$.ajax({
			type: 'POST',
			url: '/GMQDisplay-master/Step/DeleteProduct.jsp',
			data: { mno: mno },
