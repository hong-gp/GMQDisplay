									...
									<div class=" boardlist-area" data-omni=""
										...
										<div class="my-boardlist">
                                            ...
                                            <div class="boardlist-spec">
                                                <p class="type">
												<%=userService%>&nbsp;&nbsp;&nbsp;&nbsp;<%=userCategory%>
												
                                                </p>
                                                <!-- 상품 명 -->
                                                <p class="title">작성자 : <%=rs.getString("userID")%></p><br>
                                                <!-- 모델코드 -->
                                                
                                                <p class="title"> 제 목 : <%=userTitle%></p>
												 <p class="option">내용 : <%=userContent%></p>
                                            <p class="label"></p>
											</div>
                                            ...
                                            <div class="boardlist-delete">
                                                ...
                                                <button type="button" class="btn-delete" name="deleteHotList" data-mno="<%=userContent%>">
													<%=userID%>삭제
												</button>
                                            </div>
                                        </div>
...
<script>
	$(document).on('click', '.btn-delete', function() {
		...
		$.ajax({
			type: 'POST',
			url: '/GMQDisplay-master/Step/DeleteReport.jsp',
			data: { mno: mno },
