                ...
                <div class="conbox customer-center-conbox" id="my-hot-list">
                  ...
                  <div class="my-boardListWrap" id="my-boardListWrap">
						<div class="listHeader">
							<div class="head-area">
								<h3 class="tit" style="font-size: 1.5em; margin-bottom: 10px;">상품평 조회</h3>
							</div>
						</div>
...
try {
	 ...
	 String jsql = "select * from review where userID=?";	
									...
									<div class=" boardlist-area" data-omni=""
										...
										<div class="my-boardlist">
                                            ...
                                            <div class="boardlist-spec">
                                                ...
                                                <!-- 상품 명 -->
                                                <p class="title"><a
                                                        href="/GMQDisplay-master/product/<%=Mno%>.jsp"><%=Mno%></a></p>
                                                <!-- 모델코드 -->
                                                <p class="label"></p>
                                                <p class="option">작성자 : <%=rs.getString("userID")%></p><br>
												 내용 : <%=review_comment%>
                                            </div>

                                            <div class="boardlist-delete">
                                                
                                                <button type="button" class="btn-delete" name="deleteHotList" data-mno="<%=review_comment%>">
													<%=userID%> 삭제
												</button>
                                            </div>
                                        </div>
...
<script>
	$(document).on('click', '.btn-delete', function() {
		...
		$.ajax({
			type: 'POST',
			url: '/GMQDisplay-master/Step/DeleteReview.jsp',
			data: { mno: mno },
