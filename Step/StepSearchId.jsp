    ...
    <div class="com_container v_align v_align_top">
        <div class="row">
            <div class="col-sm-7 col-xs-12 log_left">
                <div class="top_area">
                    <div class="login_title">GMQDisplay 아이디 찾기</div>
                    <form id="" name="SarchId" action="StepSearchIdOk.jsp" width="400" method="post">
                        
                        <div class="form_item">
                            <input type="text" name="StepID" id="" value="" placeholder="이메일을 입력하세요" class="input_style"  data-theme="a" oninput="validateComments(this)">
                        </div>
						<input type="submit" class="btn_small" value="아이디 찾기">
