...
try {
    ...
    String StepID = request.getParameter("StepID");
	 ...
	 String jsql = "select  StepID  from Step where StepID = ?"; 
        ...
        <div class="row">
                ...
                <div class="top_area">
                    <div class="login_title" style="margin-left:80px;">회원님의 아이디를 찾았습니다!</div>
                        ...
                        <div class="form_item" style="margin-left:30px;">
						  <h3>* 회원님의 아이디는 <font style="text-decoration:underline;"><%=rs.getString("StepID")%></font> 입니다. *</h3>
                        </div>
                    ...
                    <div class="form_item" style="text-align: center;">
                        <button class="btn_small" style="margin-right:20px;" onclick="location.href='/GMQDisplay-master/Step/StepLogin.html'">관리자 로그인</button>
            ...
            <div class="col-sm-5 col-xs-12 log_right">
                <div class="top_area">
                    ...
                    <a href="./StepSign.html" class="btn_small">회원가입</a>
                </div>
