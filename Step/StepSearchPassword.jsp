    ...
    <div class="com_container v_align v_align_top">
        <div class="row">
            <div class="col-sm-7 col-xs-12 log_left">
                <div class="top_area">
                    <div class="login_title">GMQDisplay 비밀번호 찾기</div>

				<form name="SarchId" action="StepSearchPasswordOk.jsp" width="400" method="post">
                        <div class="form_item">
                            <input type="text" name="StepID_1" id="" value="" placeholder="이메일을 입력하세요." class="input_style">
                        </div>
                        <div class="form_item">
                            <input type="text" name="StepID" id="" value="" placeholder="아이디를 입력하세요" class="input_style">
                        </div>
						<input type="submit" class="btn_small" value="찾기">
					

                      
                                <!--<a href="./Help/ForgotPassWord%EF%B9%96system_id=G5&amp;function=Login&amp;lang=ko-kr&amp;return_url=https%EF%B9%95%EA%A4%B7%EA%A4%B7www.GMQDisplay.com%EA%A4%B7ko-kr%EA%A4%B7index.login.html" class="text_btn">비밀번호를 잊으셨나요?</a>-->
                    ...
                    <div class="form_item" style="text-align: center;">
                        <button class="btn_small" style="margin-right:20px;" onclick="location.href='/GMQDisplay-master/Step/StepLogin.html'">로그인</button>
						<button class="btn_small" style="margin-left:20px;" onclick="location.href='/GMQDisplay-master/Step/StepSearchId.jsp'">아이디 찾기</button>
                    </div>
            ...
            <div class="col-sm-5 col-xs-12 log_right">
                <div class="top_area">
                    ...
                    <a href="/GMQDisplay-master/Step/StepSign.html" class="btn_small">회원가입</a>
                </div>
