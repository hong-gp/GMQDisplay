...
try {
    ...
    String StepID_1 = request.getParameter("StepID");            
    String StepID = request.getParameter("StepID");

	 String jsql = "select  StepPassword  from Step where StepID = ?"; 
    ...
    <div class="com_container v_align v_align_top">
        <div class="row">
            <div class="col-sm-7 col-xs-12 log_left">
                <div class="top_area">
                    <div class="login_title" style="margin-left:80px;">회원님의 비밀번호를 찾았습니다!</div>
					<hr>
                        <div class="form_item" style="margin-left:70px;">
                          <h3>* 회원님의 비밀번호는 <font style="text-decoration:underline;"><%=rs.getString("StepPassword")%></font> 입니다. *</h3>
                        </div>					
        ...
        <div class="row">
            <div class="col-sm-7 col-xs-12 log_left">
                <div class="top_area">
                    ...
                    <div class="form_item" style="text-align: center;">
                        <button class="btn_small" style="margin-right:20px;" onclick="location.href='/GMQDisplay-master/Step/StepSearchId.jsp'">아이디 찾기</button>
						<button class="btn_small" style="margin-left:20px;" onclick="location.href='/GMQDisplay-master/Step/StepSearchPassword.jsp'">비밀번호 찾기</button>
                    </div>
