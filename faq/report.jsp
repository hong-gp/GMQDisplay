			...
			<div id="cs_header">
				<div id="cs_GNB_main">
		            ...
		            <ul>
		                ...
		                <li class="biz">
		                	<a href="#"><span class="blind">비즈니스 센터</span></a>
		                </li>
		                <li class="notice ">
			...
			<div class="footer__inner">
				<dl class="footer__notice">
					<dt class="title">공지</dt>
												<dd class="subj">
								<a href="http://help.danawa.com/noticeDetail.php?listSeq=5046833" target="_blank">[채용공고] 신입/경력 사원 모집</a>
							</dd>
										</dl>
				<ul class="footer__menu">
					<li class="item"><a href="introduction.html" target="_blank">GMQ Display 소개</a></li>
					<li class="item"><a href="../person.html" target="_blank">개인정보처리방침</a></li>
				</ul>
			</div>
		</div>
			...
			<div class="footer__inner">
				<div class="footer__info">
					<div class="footer__about">
						...
						<span class="txt">대표: 김기록</span><br><span class="txt">사업자번호: 000-00-00000</span>
						<span class="txt">통신판매업: 제0000-남서울대-00000호</span>
						<span class="txt">부가통신사업: 제000000호<a href="http://www.ftc.go.kr/bizCommPop.do?wrkr_no=1178140065" class="btn_footer" target="_blank">사업자정보확인</a></span>
					</div>
					<div class="footer__law">
									...
									<div class="layer__footer-law">
										<div class="layer__footer-law__detail">
											...
											<dl class="row">
												...
												<dd class="cont">이용약관 및 서비스 안내 참조<br>(동의 없이 무단복제 및 가공을 금함)<a href="http://www.danawa.com/info/agreement.html" target="_blank" class="btn_footer">이용약관 보기</a></dd>
											</dl>
										</div>
						...
						<a href="http://help.danawa.com/bizCenter/index.php?depth1=11" class="btn_footer" target="_blank">콘텐츠이용안내</a>
					</div>
				...
				<div class="footer__cs">
					...
					<div class="service">
						...
						<a href="#" target="_blank" onclick="window.open('#','_blank', 'width=800, height=900, toolbar=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no'); return false;" class="link link--inquiry">문의/제안</a>
					...
					<ul class="info">
						...
						<li class="item">이메일: GMQ Display@naver.com</li>
					</ul>
					<ul class="relative">
						<li class="item">
