        ...
        <div class="row">
            <div class="col-sm-7 col-xs-12 log_left">
                <div class="top_area">
                    ...
                    <form id="" name="SarchId" action="SearchIdOk.jsp" width="400" method="post">
                        
                        <div class="form_item">
                            <input type="text" name="userID" id="" value="" placeholder="이메일을 입력하세요" class="input_style"  data-theme="a" oninput="validateComments(this)">
                        </div>
