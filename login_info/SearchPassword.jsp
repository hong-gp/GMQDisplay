...
<head>
    ...
    <title>GMQDisplay 패스워드 찾기 | GMQDisplay 한국</title>
    ...
    <div class="com_container v_align v_align_top">
        <div class="row">
            <div class="col-sm-7 col-xs-12 log_left">
				...
				<form name="SarchId" action="SearchPasswordOk.jsp" width="400" method="post">
                        <div class="form_item">
                            <input type="text" name="userID_1" id="" value="" placeholder="이메일을 입력하세요." class="input_style">
                        </div>
                        <div class="form_item">
                            <input type="text" name="userID" id="" value="" placeholder="아이디를 입력하세요" class="input_style">
                        </div>
                    ...
                    <div class="form_item" style="text-align: center;">
						...
						<button class="btn_small" style="margin-left:20px;" onclick="location.href='/GMQDisplay-master/login_info/SearchId.jsp'">아이디 찾기</button>
                    </div>
