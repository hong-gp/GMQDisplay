...
try {
    ...
    String userID_1 = request.getParameter("userID");            
    String userID = request.getParameter("userID");

	 String jsql = "select  userPassword  from user where userID = ?"; 
                ...
                <div class="top_area">
					...
					<hr>
                        <div class="form_item" style="margin-left:70px;">
                          <h3>* 회원님의 비밀번호는 <font style="text-decoration:underline;"><%=rs.getString("userPassword")%></font> 입니다. *</h3>
                        </div>					
