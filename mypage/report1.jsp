                ...
                <div class="conbox customer-center-conbox" id="my-hot-list">
                  ...
                  <div class="my-boardListWrap" id="my-boardListWrap">
						<div class="listHeader">
							<div class="head-area">
								<h3 class="tit" style="font-size: 1.5em; margin-bottom: 10px;">신고 · 문의 · 제안</h3>
							</div>
						</div>
...
try {
	 ...
	 String jsql = "select * from userService where userID=?";	
...
%>
		...
		style="padding: 47px; border: 1px solid #ddd; border-radius: 20px; background: #f7f7f7; text-align: center; margin-top: 20px;">
			<p class="txt">등록된 문의가 없습니다.</p>							
		</div>
<%
	} else {
		do {
		String userCategory = rs.getString("userCategory");
		String userService = rs.getString("userService");
		String userTitle = rs.getString("userTitle");
		String userContent = rs.getString("userContent");					
%>
							<ul style="border-bottom: 1px solid #eee;">
								<li>
									<!-- case 판매중이 아닌 경우 stopSale class 추가 -->
									<div class=" boardlist-area" data-omni=""
										data-omni-price="">

										<div class="my-boardlist">
											
											<div class="boardlist-spec" style="width: 30%; padding-right: 10px;">
												<p class="type">
													<%=userService%>&nbsp;&nbsp;&nbsp;&nbsp;<%=userCategory%><br>
												</p>
												
												<!-- 상품 명 -->
												<p class="title">
													<h2>제 목: <a href="#"><%=userTitle %></a></h2>
											...
											<div class="boardlist-cart" id="boardlist-cart" data-ctpath="/" value="12">
												<h3 style="font-color:blue;">내용 </h3><br>
												<p>- <%=userContent %></p>	
											</div>
										</div>
									</div>
...
%>
                            ...
                            <div class="paging" id="interestPage">
							<span class="btn_first">
							<a class="btn_paging first" href="javascript:;" style="cursor: default;">맨 처음 페이지로 가기</a></span>
							<span class="btn_prev"><a href="javascript:;" style="cursor: default;">이전 페이지로 가기</a>
							</span>
                                <ul>
                                    <li class="active"><a href="javascript:;" class="pageClass currentPage"
                                            style="cursor: default;">1</a></li>
                                </ul>
								<span class="btn_next"><a href="javascript:;" style="cursor: default;">다음 페이지로 가기</a></span>
								<span class="btn_last"><a href="javascript:;" style="cursor: default;">맨 마지막 페이지로 가기</a></span>
                            </div>
                        </div>
						</div>
				</section>
											...
											<ul>
												...
												<li class="productLine1">
													...
													<ul>
														...
														<li><a href="monitors.html?genre=rpg/sports/fighting" data-omni="product_RPG/Sports/fights">RPG/Sports/fights</a></li>
														...
														<li><a href="monitors.html?genre=videogame" data-omni="product_videogame">비디오/콘솔용</a></li>
												...
												<li class="productLine2">
													<h3>추천 케어</h3>
													<ul>
														<li><a href="./recommend/index_game.html;"
																data-omni="product_smartphones">게임용 추천케어</a></li>
														<li><a href="./recommend/index_game1.html;"
												...
												<li>
													...
													<ul>
														<li><a href="./AI-Line/bespokestudio test.html;" 
												...
												<li class="row2">
													<ul>
														<li>
															<h3><a href="javascript:void(0);">사이트·회사 소개</a></h3>
															<ul>
																<li><a href="./about-us/company-info/index.html"
																		data-omni="about-us_company-info">GMQ Display 소개</a></li>
																<li><a href="./about-us/company-info/index.html"
										...
										<div class="footer-inner copyrightGroup">
											<div class="copyrightBox">
												<p class="copyright">Copyright &copy; 2023 GMQDisplay. All Rights
													Reserved.</p>
												<div class="mark-box">
													<a href="javascript/index.html" title="웹접근성 우수사이트 인증서 : 새창으로 열기"
														class="btn-mark btn-wa" data-popup-target="popupWA"
														data-omni="local logo_wa">
														<img class="pc-ver"
															src="./static/images/common/icon-footer-wa.svg"
															alt="웹접근성 우수사이트">
														<img class="mo-ver"
															src="./static/images/common/icon-footer-wa-mo.jpg"
															alt="웹접근성 우수사이트">
														웹접근성 우수사이트
													</a>
													<a href="javascript:openPrivacy();"
														title="개인정보 보호 우수사이트 인증서 : 새창으로 열기"
														class="btn-mark btn-eprivacy" data-omni="local logo_eprivacy">
														<img src="./static/images/common/icon-footer-eprivacy.svg"
															alt="개인정보보호 우수사이트">개인정보보호 우수사이트
													</a>
												</div>
											</div>
										</div>
									...
									<div class="footer-content">
										<div class="footer-inner btnBottomGroup">
											<div class="cs-btn">
												<ul class="korean">
													<li><a
															href="./function/ipredirection/ipredirectionLocalList/index.html">한국/한국어
														</a></li><!-- 200918 추가 -->
												</ul>
												<ul>
											...
											<div class="clause-links">
												...
												<div id="dropClauseList02"
													...
													<button class="droplist-button" title="서비스별 개인정보처리방침">개인정보처리방침<span
															class="blind">하위 메뉴 있음</span></button>
													<ul class="droplist" tabindex="-1"
											...
											<div class="link-box">
												<div class="sns-btn">
													<div class="wrap-sns">
														...
														<ul>
															<li><a href="#" class="btn-fb" title="새창 열림"
																	target="_blank">
																	<span class="blind">facebook</span></a></li>
															<li><a href="#" class="btn-yt" title="새창 열림"
																	target="_blank">
																	<span class="blind">youtube</span></a></li>
															<li><a href="#" class="btn-ig" title="새창 열림"
																	target="_blank">
																	<span class="blind">instagram</span></a></li>
															<li><a href="#" class="btn-pf" title="새창 열림"
																	target="_blank">
																	<span class="blind">카카오톡 플러스친구</span></a></li>
															<li><a href="#" class="btn-tw" title="새창 열림"
																	target="_blank">
