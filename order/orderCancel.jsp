...
<%
	...
	try {
		String sql = "DELETE FROM orderInfo WHERE userID=? ORDER BY order_id DESC LIMIT 1;"; 
		PreparedStatement pstmt = con.prepareStatement(sql);
		pstmt.setString(1, id);

		pstmt.executeUpdate();

		String sql2 = "DELETE FROM orderItem WHERE userID=? ORDER BY order_id DESC LIMIT 1;"; 
