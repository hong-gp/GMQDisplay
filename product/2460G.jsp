	...
	<div class="pd-Container" id="pd-inner-cont">
		<div class="pg-location ">
			<div class="pg-location-inner">
				...
				<span>한성컴퓨터 ULTRON PLUS 리얼 144 게이밍</span>
			</div>
		</div>

		<section class="content" role="product_content_search">
			<div id="goods_detail_wrap" class="conbox" data-ctpath="/sec/" data-kakaokey="5880e4317936087f2764a5d340e6bca6" data-facebookid="" data-goods-id="2460G"
			data-goods-tp-cd="10" data-goods-Nm="한성컴퓨터 ULTRON PLUS 리얼 144 게이밍" data-admin-yn="" data-admin-price-yn="" data-task-id="" data-task-dtl-no="">

				<input type="hidden" name="returnUrl" value="./../static/images/product/2460G"/>
				<!-- s : 제품구매영역 -->
		...
		<div class="prod-image">
			<div class="prod-image-view" style="width:660px; height:660px;">
				<div>
					...
					<div>
							<img src="./../static/images/product/2460G_2.png" data-lazy="./../static/images/product/2460G_2.png" alt="좌측 30도" data-img-tp="10" data-seq="2">
					</div>
					<div>
							<img src="./../static/images/product/2460G_3.png" data-lazy="./../static/images/product/2460G_3.png" alt="우측 30도" data-img-tp="10" data-seq="3">
					</div>
				</div>
			<div class="prod-image-navi-wrap">
				<ol class="prod-image-navi">
						<li><span><a href="javascript:;">
						<img src="./../static/images/product/2460G_1.png" alt="정면"></a></span></li>
						<li><span><a href="javascript:;">
						<img src="./../static/images/product/2460G_2.png" alt="좌측30도"></a></span></li>
						<li><span><a href="javascript:;">
						<img src="./../static/images/product/2460G_3.png" alt="우측30도"></a></span></li>
				</ol>
			</div>
			<div class="opt-btn">
				<!-- 이미지 삭제 및 em 태그 추가 -->
		...
		$("#mySpriteSpin").spritespin({
              ...
              // 로딩시 자동 롤링
					...
					<script type="text/javascript">
						$(document).ready(function () {
							...
							if(!isReady){
								...
								//옵션 변경
								$(goodsMain.vGoodsWrapId).data("goods-id", "2460G");
							}
							...
							//비교하기 버튼 클래스 추가
							$(".link-compare-i").addClass(isCompareDataStorageGoods("2460G")?'disabled':'');
				...
				/* 			var goodsOrdTpCd = ""
						...
						<div class="itm-info-detail" id="itmInfoDetail" data-mdl-code="2460G" data-url-nm="monitors" data-fmy-grp-nm="gaming-ls27bg654ekxkr-d2c" data-goods-nm="한성컴퓨터 ULTRON PLUS 리얼 144 게이밍" data-sale-stat="12" data-mdl-nm="2460G" data-fmy-eng-nm="gaming-ls27bg654ekxkr-d2c" data-goods-id="G000277237" data-envmt-gb-cd="prd" data-fast-dlvr-yn="N">
							...
							<input type="hidden" name="goodsNm" id="goodsNm" value="한성컴퓨터 ULTRON PLUS 리얼 144 게이밍">
							<input type="hidden" name="mdlCode" id="mdlCode" value="2460G">
...
function Urlsend(sns) {
    var thisUrl = "http://localhost:8080/GMQDisplay-master/product/2460G.jsp";
						...
						<div class="bookmarkTooltip flashTooltip bookmarkOn">
							<div>
							 ...
							 <div class="bookmarkTooltip flashTooltip bookmarkOff">
								...
								<h1 class="itm-info-title" id="goodsDetailNm">한성컴퓨터 ULTRON PLUS 리얼 144 게이밍</h1>
								<div class="itm-sku b2c-itm-sku compare-box-align">2460G</div>
										<!-- B2C, 패넷, 패넷 디플 PD페이지 비교하기 버튼 추가 s --> 
										<div class="compare">
												<a href="javascript:void(0);" class="link-compare-i" onclick="readyCompare(this)" data-goods-id="2460G" data-mdl-code="2460G " data-comp-disp-clsf-en-nm="monitors">
												비교하기
												</a>
											</div>
								...
								<script>
									...
									<div class="itm-price itm-type">
										...
										<dt>기준가
											 ...
											 <dd>
												<span data-price="137560" class="pd-total-price">137,560</span>원
											</dd>
										</dl>
												<script type="text/javascript">
													if('137560' == '0'){
												...
												<dt>회원가</dt>
												<!-- 회원가 -->
												<dd><span class="discount" style="text-decoration-line: line-through">129,900</span>원</dd>
												</dl>
											...
											<div class="dropDown-content itm-eventInfo">
												<div id="membership-info">
													<a href="javascript:MemDisplay();" class="dropButton" id="membershipDropBtn">
														<span>GMQDisplay 멤버십 <strong id="membership-ptn-top">1275 포인트</strong> 적립</span>
														...
														<div class="dropcontent" id="TabMembership">
															<div class="casewrap point-nomember" style="display: block;" >
																<p class="emphasis-txt border-line">GMQ Display
																	<em class="case-blue membership-ptn"> 포인트 1275 (기본 0.1%)</em> 적립 예정
																</p>
										...
										<!-- 회원 할인 적용 예상가 -->
											...
											<a class="sp-custom-c1071-1 ins-banner" href="javascript:void(0);"><div class="ins-pd-inline-banner" style="margin-top:15px;"></div></a>
												...
												<div  class="tooltip-content1" style="display:none;" id="divToggle3">
													...
													<strong data-price="127560">127,560</strong><span>원</span>
												</dl>
											</div>
																					 <div class="box-btn">
																								<div class="box-cto">
...
<!-- 추가된 부분 -->
	    ...
	    <section class="component-bar" role="product_content_search">
	        <div class="component-bar-inner">
	            <div>
	                <div class="itm-title-text" id="goods-title-text">한성컴퓨터&nbsp;ULTRON&nbsp;PLUS&nbsp;리얼&nbsp;144&nbsp;게이밍</div>
...
<div class="wrap-component feature-benefit pt-none pb-none w1440px img-bottom">
	...
	<div class="visual-area">
			<img src="./../static/images/explain/2460G_1.jpg" class="objGif">
	</div>
		<div class="component-text">
			<div class="component-text-inner">
				<div class="box-title">
					
					<h2 class="title mo-ver lrg" style="color:#FFB400">한성컴퓨터 ULTRON PLUS 리얼 144 게이밍</h2><br>
					<h2 class="title pc-ver lrg" style="color:#FFB400">한성컴퓨터 ULTRON PLUS 리얼 144 게이밍</h2><br>

					<p class="desc mo-ver "style="color:black;">얇은 3면 슬림베젤 디자인에 FHD(1920x1080)해상도와 165Hz 주사율을 지원하며<br>선명한 VA 광시야각 패널의 27인치 평면형 모니터 입니다.</p>
					<p class="desc pc-ver "style="color:black;">얇은 3면 슬림베젤 디자인에 FHD(1920x1080)해상도와 165Hz 주사율을 지원하며<br>선명한 VA 광시야각 패널의 27인치 평면형 모니터 입니다.</p>
				</div>
			</div>
		</div>	
	</div>
...
<div class="wrap-component feature-benefit pt-none pb-none w1440px img-bottom      ">
	<div class="component-contents  pt-wide pb-none txt-mid-center txtm-top-center "  style="background-color:#FFFFFF" data-cptnm="">
		<div class="visual-area  ">
			<img src="./../static/images/explain/2460G_2.jpg" class="objGif">
		</div>
		<div class="component-text">
			<div class="component-text-inner">
				<div class="box-title">
					<h2 class="title mo-ver lrg" style="color:black">슬림하고 간결한 디자인</h2><br>	
					<h2 class="title pc-ver lrg" style="color:black">슬림하고 간결한 디자인</h2><br>

					<p class="desc mo-ver "style="color:black;">얇은 테두리와 3면 베젤 두께는 화면 시청에 더욱 집중할 수 있고<br>듀얼 모니터 구성시에도 하나의 화면처럼 자연스러운 구성이 가능합니다.</p>
					<p class="desc pc-ver "style="color:black;">얇은 테두리와 3면 베젤 두께는 화면 시청에 더욱 집중할 수 있고<br>듀얼 모니터 구성시에도 하나의 화면처럼 자연스러운 구성이 가능합니다.</p>
				</div>
			</div>
		</div>		
	</div>
...
<div class="wrap-component feature-benefit pt-none pb-none w1440px img-bottom      ">
	<div class="component-contents  pt-wide pb-none txt-mid-center txtm-top-center "  style="background-color:#FFFFFF" data-cptnm="">
		<div class="visual-area  ">
			<img src="./../static/images/explain/2460G_3.jpg" class="objGif">
		</div>
		<div class="component-text">
			<div class="component-text-inner">
				<div class="box-title">
					<h2 class="title mo-ver lrg" style="color:black">VA 광시야각</h2><br>	
					<h2 class="title pc-ver lrg" style="color:black">VA 광시야각</h2><br>

					<p class="desc mo-ver "style="color:black;">VA 광시야각 패널을 탑재하여 상하좌우 어느 각도에서도 왜곡이 없고,<br>생생한 화면을 위한 색의 자연스러움을 극대화하도록 설계하였습니다.</p><br>
					<p class="desc pc-ver "style="color:black;">VA 광시야각 패널을 탑재하여 상하좌우 어느 각도에서도 왜곡이 없고,<br>생생한 화면을 위한 색의 자연스러움을 극대화하도록 설계하였습니다.</p><br>
				</div>
			</div>
		</div>
	</div>
...
<div class="wrap-component feature-benefit pt-none pb-none w1440px img-bottom      ">
	<div class="component-contents  pt-wide pb-none txt-mid-center txtm-top-center "  style="background-color:#FFFFFF" data-cptnm="">
		<div class="visual-area  ">
			<img src="./../static/images/explain/2460G_4.jpg" class="objGif">	
		</div>
		<div class="component-text">
			<div class="component-text-inner">
				<div class="box-title">
					<h2 class="title mo-ver lrg" style="color:black">더 넓고 선명한 FHD 화질</h2><br>	
					<h2 class="title pc-ver lrg" style="color:black">더 넓고 선명한 FHD 화질</h2><br>

					<p class="desc mo-ver "style="color:black;">HD(1280x720)대비 더욱 넓어진 화면 영역보다 선명한 화질인<br>FHD(1920x1080)은 게임화면의 비주얼과 엔터테인먼트의 환경을 한단계 진화 시킵니다.</p><br>
					<p class="desc pc-ver "style="color:black;">HD(1280x720)대비 더욱 넓어진 화면 영역보다 선명한 화질인<br>FHD(1920x1080)은 게임화면의 비주얼과 엔터테인먼트의 환경을 한단계 진화 시킵니다.</p><br>
				</div>
			</div>
		</div>
	</div>	
...
<div class="wrap-component feature-benefit pt-none pb-none w1440px img-bottom      ">
	<div class="component-contents  pt-wide pb-none txt-mid-center txtm-top-center "  style="background-color:#FFFFFF" data-cptnm="">
		<div class="visual-area  ">
			<img src="./../static/images/explain/2460G_5.jpg" class="objGif">	
		</div>
		<div class="component-text">
			<div class="component-text-inner">
				<div class="box-title">
					<h2 class="title mo-ver lrg" style="color:black">현실보다 생동감 넘치는 컬러</h2><br>	
					<h2 class="title pc-ver lrg" style="color:black">현실보다 생동감 넘치는 컬러</h2><br>

					<p class="desc mo-ver "style="color:black;">sRGB 99% 뛰어난 색상 표현력, 3,000:1의 명암비와 300cd/m의 최대 화면 밝기로<br>현실보다 더 생동감 넘치는 다채로운 표현력의 화면을 경험해보세요.</p><br>
					<p class="desc pc-ver "style="color:black;">sRGB 99% 뛰어난 색상 표현력, 3,000:1의 명암비와 300cd/m의 최대 화면 밝기로<br>현실보다 더 생동감 넘치는 다채로운 표현력의 화면을 경험해보세요.</p><br>
				</div>
			</div>
		</div>
		<div class="visual-area  ">
			<img src="./../static/images/explain/2460G_6.jpg" class="objGif">	
		</div>
	</div>
</div>
...
<div class="spec-table-wrap"><h3 class="spec-itm-title" id="cstrt-nm">한성컴퓨터 ULTRON PLUS 리얼 144 게이밍</h3>
...
<p class="spec-desc">300cd&nbsp;</p>
</li>
<li>
<strong class="spec-title">명암비</strong>
<p class="spec-desc">3000:1&nbsp;</p>
</li>
<li>
...
<p class="spec-desc">616.3 x 442.8 x 160.9mm&nbsp;</p>
</li>
<li>
<strong class="spec-title">스텐드 제외 제품크기(HxWxD)(mm)</strong>
<p class="spec-desc"> 616.3 x 364.3 x 38.7mm&nbsp;</p>
</li>
<li>
<strong class="spec-title">제품 무게(kg)</strong>
<p class="spec-desc">3.2kg&nbsp;</p>
</li>
</ol>
</dd>
</dl>
...
<p class="spec-desc">Display Port케이블, 전원 어댑터, 모니터, 받침대+스탠드, 베사홀 브라켓, 스탠드조립나사&nbsp;</p>
</li>
</ol>
</dd>
</dl>
...
<p class="spec-desc"><img src="//images.samsung.com/is/image/samsung/p5/sec/common/icon-kc.png?$ORIGIN_PNG$" alt="KC 인증 로고">R-R-ANM-UL27FJ7P</p>
</li>
</ol>
</dd>
</dl>
...
<div class="dropcontent fixWidth"  id="specContents" style="display:none;"></div>
<div class="spec-link-box" style="display:none">
<!-- B2C, 패넷만 노출 -->
<div class="spec-link-box-inner"></div>
</div>
</div>
</article>
						...
						-->
											...
											<div class="review-lt-keywordsbar">
												...
												try {
													...
													sql_keyword += "WHERE Mno='2460G' AND review_keyword LIKE '%G01%' UNION ALL ";
													sql_keyword += "SELECT 'G02' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='2460G' AND review_keyword LIKE '%G02%' UNION ALL ";
													sql_keyword += "SELECT 'G03' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='2460G' AND review_keyword LIKE '%G03%' UNION ALL ";
													sql_keyword += "SELECT 'G04' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='2460G' AND review_keyword LIKE '%G04%' UNION ALL ";
													sql_keyword += "SELECT 'G05' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='2460G' AND review_keyword LIKE '%G05%' UNION ALL ";
													sql_keyword += "SELECT 'G06' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='2460G' AND review_keyword LIKE '%G06%' UNION ALL ";
													sql_keyword += "SELECT 'G07' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='2460G' AND review_keyword LIKE '%G07%' UNION ALL ";
													sql_keyword += "SELECT 'G08' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='2460G' AND review_keyword LIKE '%G08%' UNION ALL ";
													sql_keyword += "SELECT 'G09' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='2460G' AND review_keyword LIKE '%G09%' UNION ALL ";
													sql_keyword += "SELECT 'G10' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='2460G' AND review_keyword LIKE '%G10%' UNION ALL ";
													sql_keyword += "SELECT 'G99' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='2460G' AND review_keyword LIKE '%G99%'";
									...
									<div class="review-content-body">
										...
										<div id="commentList">
											...
											<%
											// 작성된 리뷰 조회
											String sql_list = "SELECT * FROM review WHERE Mno='2460G'";
