					...
					<ol class="share-tooltip-box">												
						...
						try {
							...
							if (id != null) { 
								...
								pstmt_wish.setString(2, "32UN650");

								ResultSet rs_wish = pstmt_wish.executeQuery();
								if (rs_wish.next()) {
						%>
							<button type="button" class="btn-good on" title="" form="32UN650">
								<i class="icon ico-large ico-goods">좋아요 미선택</i>
							</button>
						<%
								} else {
						%>
							<button type="button" class="btn-good " title="" form="32UN650">
								<i class="icon ico-large ico-goods">좋아요 미선택</i>
							</button>
						<%
								}
											 ...
											 <dd>
												...
												<dd>
													<div class="dropOption" id="dropOption-1001-1">
														<span class="itm-color-object" style="background-color:#000000;" data-omni="color_블랙">화이트</span>
														<span class="selectedOption">화이트</span> 
													</div>
												</dd>
												</dl>
<!-- 구매 수량 -->
