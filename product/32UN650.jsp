	...
	<div class="pd-Container" id="pd-inner-cont">
		<div class="pg-location ">
			<div class="pg-location-inner">
				...
				<a href="#">전문가용 모니터</a>
				<a href="./../monitors.html?genre=videogame">비디오/콘솔용</a>
				<span>LG전자 32UN650</span>
			</div>
		</div>

		<section class="content" role="product_content_search">
			<div id="goods_detail_wrap" class="conbox" data-ctpath="/sec/" data-kakaokey="5880e4317936087f2764a5d340e6bca6" data-facebookid="" data-goods-id="32UN650"
			data-goods-tp-cd="10" data-goods-Nm="LG전자 32UN650" data-admin-yn="" data-admin-price-yn="" data-task-id="" data-task-dtl-no="">

				<input type="hidden" name="returnUrl" value="./../static/images/product/32UN650"/>
				<!-- s : 제품구매영역 -->
		...
		<div class="prod-image">
			<div class="prod-image-view">
				<div>
							<img src="./../static/images/product/32UN650_1.png" alt="LG전자 32UN650 32UN650정면" data-img-tp="10" data-seq="1">
				</div>
					<div>
							<img src="./../static/images/product/32UN650_2.png" data-lazy="./../static/images/product/32UN650_2.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 좌측 30도" data-img-tp="10" data-seq="2">
								</div>
					<div>
							<img src="./../static/images/product/32UN650_3.png" data-lazy="./../static/images/product/32UN650_3.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 우측 30도" data-img-tp="10" data-seq="3">
								</div>
					<div>
							<img src="./../static/images/product/32UN650_4.png" data-lazy="./../static/images/product/32UN650_4.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 모서리 디테일" data-img-tp="10" data-seq="4">
								</div>
					<div>
							<img src="./../static/images/product/32UN650_5.png" data-lazy="./../static/images/product/32UN650_5.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 피봇" data-img-tp="10" data-seq="5">
								</div>
					</div>
			<div class="prod-image-navi-wrap">
				<ol class="prod-image-navi">
					<li><span><a href="javascript:;"><img src="./../static/images/product/32UN650_1.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 정면"></a></span></li>
						<li><span><a href="javascript:;"><img src="./../static/images/product/32UN650_2.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 좌측 30도"></a></span></li>
						<li><span><a href="javascript:;"><img src="./../static/images/product/32UN650_3.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 우측 30도"></a></span></li>
						<li><span><a href="javascript:;"><img src="./../static/images/product/32UN650_4.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 모서리 디테일"></a></span></li>
						<li><span><a href="javascript:;"><img src="./../static/images/product/32UN650_5.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 피봇"></a></span></li>
						</ol>
			</div>
			<div class="opt-btn">
				<!-- 이미지 삭제 및 em 태그 추가 -->
		...
		$("#mySpriteSpin").spritespin({
              ...
              // 로딩시 자동 롤링
					...
					<script type="text/javascript">
						$(document).ready(function () {
							...
							if(!isReady){
								...
								//옵션 변경
								$(goodsMain.vGoodsWrapId).data("goods-id", "32UN650");
							}
							...
							//비교하기 버튼 클래스 추가
							$(".link-compare-i").addClass(isCompareDataStorageGoods("32UN650")?'disabled':'');
				...
				/* 			var goodsOrdTpCd = ""
						...
						<div class="itm-info-detail" id="itmInfoDetail" data-mdl-code="32UN650" data-url-nm="monitors" data-fmy-grp-nm="gaming-ls27bg654ekxkr-d2c" data-goods-nm="LG전자 32UN650" data-sale-stat="12" data-mdl-nm="32UN650" data-fmy-eng-nm="gaming-ls27bg654ekxkr-d2c" data-goods-id="G000277237" data-envmt-gb-cd="prd" data-fast-dlvr-yn="N">
							...
							<input type="hidden" name="goodsNm" id="goodsNm" value="LG전자 32UN650">
							<input type="hidden" name="mdlCode" id="mdlCode" value="32UN650">
...
function Urlsend(sns) {
    var thisUrl = "http://localhost:8080/GMQDisplay-master/product/32UN650.jsp";
						...
						<div class="bookmarkTooltip flashTooltip bookmarkOn">
							<div>
							 ...
							 <div class="bookmarkTooltip flashTooltip bookmarkOff">
								...
								<h1 class="itm-info-title" id="goodsDetailNm">LG전자 32UN650</h1>
								<div class="itm-sku b2c-itm-sku compare-box-align">32UN650</div>
										<!-- B2C, 패넷, 패넷 디플 PD페이지 비교하기 버튼 추가 s --> 
										<div class="compare">
												<a href="javascript:void(0);" class="link-compare-i" onclick="readyCompare(this)" data-goods-id="32UN650" data-mdl-code="32UN650 " data-comp-disp-clsf-en-nm="monitors">
												비교하기
												</a>
											</div>
							...
							<!-- 가격이 없을 경우 영역 노출 X -->
								<script>
									...
									<div class="itm-price itm-type">
										<div>
											<input type="hidden" id="originalPrice" value="549000">	                               		
											<input type="hidden" id="discountAmount" value="0">
											<input type="hidden" id="lastPrice" value="549000">
										...
										<dt>기준가
											 ...
											 <dd>
												<span data-price="549000" class="pd-total-price">549,000</span>원
											</dd>
										</dl>
												<script type="text/javascript">
													if('549000' == '0'){
												...
												<dt>회원가</dt>
												<!-- 회원가 -->
												<dd><span class="discount" style="text-decoration-line: line-through">542,000</span>원</dd>
												</dl>
...
<form name="form" method="post" action="/GMQDisplay-master/order/order.jsp">
	<input type="hidden" name="Mno" value="32UN650" />
											...
											<div class="dropDown-content itm-eventInfo">
												<div id="membership-info">
													<a href="javascript:MemDisplay();" class="dropButton" id="membershipDropBtn">
														<span>GMQDisplay 멤버십 <strong id="membership-ptn-top">5390 포인트</strong> 적립</span>
														...
														<div class="dropcontent" id="TabMembership">
															<div class="casewrap point-nomember" style="display: block;" >
																<p class="emphasis-txt border-line">GMQ Display
																	<em class="case-blue membership-ptn"> 포인트 5390 (기본 0.1%)</em> 적립 예정
																</p>
										...
										<!-- 회원 할인 적용 예상가 -->
											...
											<a class="sp-custom-c1071-1 ins-banner" href="javascript:void(0);"><div class="ins-pd-inline-banner" style="margin-top:15px;"></div></a>
												...
												<div  class="tooltip-content1" style="display:none;" id="divToggle3">
													...
													<strong data-price="539000">539,000</strong><span>원</span>
												</dl>
											</div>
																					 <div class="box-btn">
																								<div class="box-cto">
...
<!-- 추가된 부분 -->
	    ...
	    <section class="component-bar" role="product_content_search">
	        <div class="component-bar-inner">
	            <div>
	                <div class="itm-title-text" id="goods-title-text">LG전자 32UN650</div>
		...
		<div class="component-text">
			<div class="component-text-inner">
				<div class="box-title"">
					...
					<h2 class="title mo-ver lrg" style="color:ORANGE">LG전자 32UN650</h2><br>	
					<h2 class="title pc-ver lrg" style="color:ORANGE">LG전자 32UN650</h2><br>

					<h2 class="title mo-ver lrg" style="color:WHITE">&nbsp;<br>울트라HD 4K로 즐기는 생생하고 선명한 화질</h2><br>	
					<h2 class="title pc-ver lrg" style="color:WHITE">&nbsp;<br>울트라HD 4K로 즐기는 생생하고 선명한 화질</h2><br>
				</div>
			</div>
		</div>
<div class="visual-area ">
	<img src="./../static/images/explain/32UN650_1.png"" class="objGif">
</div>
</div>
</div>
...
<div class="wrap-component feature-benefit pt-none pb-none w1440px img-bottom      ">
	<div class="component-contents  pt-wide pb-none txt-mid-center txtm-top-center "  style="background-color:#FFFFFF" data-cptnm="">
		<div class="component-text">
			<div class="component-text-inner">
				<div class="box-title">
					<h2 class="title mo-ver lrg" style="color:#000000">IPS 패널 · 4K 해상도로 <br>어느각도에서나 <br>생생한 컬러, 더욱선명하고 또렷하게</h2><br>
					<h2 class="title pc-ver lrg" style="color:#000000">IPS 패널 · 4K 해상도로 <br>어느각도에서나 <br>생생한 컬러, 더욱선명하고 또렷하게</h2><br>

					<p class="desc mo-ver "style="color:#000000">상하좌우 178º의 넓은 시야각으로 선명한 색상을 구현합니다</p>
					<p class="desc pc-ver "style="color:#000000">상하좌우 178º의 넓은 시야각으로 선명한 색상을 구현합니다</p>

					<p class="desc mo-ver "style="color:#000000">UHD(3840 x 2160) 해상도로, Full HD (1920 x 1080) 대비 픽셀수가 4배 더 많아 다양한 작업을 보다 선명하고 넓은 화면으로 즐기실 수 있습니다.</p>
					<p class="desc pc-ver "style="color:#000000">UHD(3840 x 2160) 해상도로, Full HD (1920 x 1080) 대비 픽셀수가 4배 더 많아 다양한 작업을 보다 선명하고 넓은 화면으로 즐기실 수 있습니다.</p>

					<p class="desc mo-ver "style="color:#000000">DCI-P3 95%의 색영역 4K 디스플레이의 넓은 색영역과 명암비를 보여주어 고해상도 이미지의 색을 정확하게 볼 수 있습니다.</p>
					<p class="desc pc-ver "style="color:#000000">DCI-P3 95%의 색영역 4K 디스플레이의 넓은 색영역과 명암비를 보여주어 고해상도 이미지의 색을 정확하게 볼 수 있습니다.</p>

					<p class="desc mo-ver "style="color:#000000">HDR 10으로 생생함과 선명함을 실감할 수 있습니다.</p>
					<p class="desc pc-ver "style="color:#000000">HDR 10으로 생생함과 선명함을 실감할 수 있습니다.</p>
				</div>
			</div>
		</div>	
	</div>
		<!-- 두번째 사진 -->
<div class="visual-area  ">
<img src="./../static/images/explain/32UN650_2.png"" class="objGif">
</div>
</div>
...
<div class="wrap-component feature-benefit pt-none pb-none w1440px img-bottom      ">
	<div class="component-contents  pt-wide pb-none txt-mid-center txtm-top-center "  style="background-color:#FFFFFF" data-cptnm="">
		<div class="component-text">
			<div class="component-text-inner">
				<div class="box-title">
					<h2 class="title mo-ver lrg" style="color:#666666">엔터테인먼트에 최적화된 모니터</h2><br>	
					<h2 class="title pc-ver lrg" style="color:#666666">엔터테인먼트에 최적화된 모니터</h2><br>

					<h2 class="title mo-ver lrg" style="color:orange">FreeSync™로 끊김없는 게이밍</h2><br>	
					<h2 class="title pc-ver lrg" style="color:orange">FreeSync™로 끊김없는 게이밍</h2><br>

					<p class="desc mo-ver "style="color:black;">고해상도 게임 시 그래픽 카드의 프레임 레이트와 모니터 주사율과의 차이로 인해<br><br>발생하는 화면 찢어짐 현상과 버벅거림을 없애줘 부드러운 화면을 제공합니다.</p>
					<p class="desc pc-ver "style="color:black;">고해상도 게임 시 그래픽 카드의 프레임 레이트와 모니터 주사율과의 차이로 인해<br><br>발생하는 화면 찢어짐 현상과 버벅거림을 없애줘 부드러운 화면을 제공합니다.</p>
				</div>
			</div>
		</div>	
		<div class="component-text">
			<div class="component-text-inner">
				<div class="box-title">
					...
					<h2 class="title mo-ver lrg" style="color:orange">다크맵 모드 · 액션모드</h2><br>	
					<h2 class="title pc-ver lrg" style="color:orange">다크맵 모드 · 액션모드</h2><br>

					<p class="desc mo-ver "style="color:black;">어두운 화면의 명암비를 높여 색감의 차이를 드러내어
어두운 곳에 숨어있는 적을 좀 더 분명히 인지할 수 있습니다.<br><br>그래픽카드의 인풋 신호를 모니터 스케일러를 거치지 않고 통과시켜 인풋렉이나 프레임 지연 없이 즉각 반응합니다</p>
					<p class="desc pc-ver "style="color:black;">어두운 화면의 명암비를 높여 색감의 차이를 드러내어
어두운 곳에 숨어있는 적을 좀 더 분명히 인지할 수 있습니다.<br><br>그래픽카드의 인풋 신호를 모니터 스케일러를 거치지 않고 통과시켜 인풋렉이나 프레임 지연 없이 즉각 반응합니다</p>
				</div>
			</div>
		</div>	
	...
	<!-- 두번째 사진 -->
<div class="visual-area  ">
<img src="./../static/images/explain/32UN650_3.PNG"" class="objGif">
</div>
</div>
<br><br><br><br><br>
...
<div class="wrap-component feature-benefit pt-none pb-none w1440px img-bottom      ">
	<div class="component-contents  pt-wide pb-none txt-mid-center txtm-top-center "  style="background-color:#FFFFFF" data-cptnm="">
		<div class="component-text">
			<div class="component-text-inner">
				<div class="box-title">
					<h2 class="title mo-ver lrg" style="color:#666666">사용자 편의성을 높인 기능</h2><br>	
					<h2 class="title pc-ver lrg" style="color:#666666">사용자 편의성을 높인 기능</h2><br>

					<h2 class="title mo-ver lrg" style="color:orange">&nbsp;<br>눈에 편안한 기능</h2>	
					<h2 class="title pc-ver lrg" style="color:orange">&nbsp;<br>눈에 편안한 기능</h2>

					<p class="desc mo-ver "style="color:black;">->&nbsp;&nbsp;사용자 눈에 편안한 기능을 지원하여 오랜 시간 화면을 보아도 눈에 편안함을 제공합니다.<br><br>->&nbsp;&nbsp;스탠드 조절로 나에게 딱 맞는 환경을 조성할 수 있습니다.</p><br>
					<p class="desc pc-ver "style="color:black;">->&nbsp;&nbsp;사용자 눈에 편안한 기능을 지원하여 오랜 시간 화면을 보아도 눈에 편안함을 제공합니다.<br><br>->&nbsp;&nbsp;스탠드 조절로 나에게 딱 맞는 환경을 조성할 수 있습니다.</p><br>
				</div>
			</div>
		</div>	
	</div>
...
<div class="component-contents  pt-wide pb-none txt-mid-center txtm-top-center "  style="background-color:#FFFFFF" data-cptnm="">
		<div class="visual-area  ">
<!-- 세번째 사진 -->
<img src="./../static/images/explain/32UN650_4.png"" class="objGif">	
</div>
...
<div class="spec-table-wrap"><h3 class="spec-itm-title" id="cstrt-nm">LG전자 32UN650</h3>
...
<p class="spec-desc">3,840 x 2,160(UHD)&nbsp;</p>
</li>
<li>
<strong class="spec-title">응답속도 (ms)</strong>
<p class="spec-desc">5ms(GtG at Faster)&nbsp;</p>
</li>
<li>
...
<p class="spec-desc">5 x 2(Maxx Audio)&nbsp;</p>
</li>
<li>
<strong class="spec-title">공장색교정</strong>
<p class="spec-desc">지원&nbsp;</p>
</li>
<li>
<strong class="spec-title">리더모드</strong>
<p class="spec-desc">지원&nbsp;</p>
</li>
<li>
<strong class="spec-title">색약자 색보정 모드</strong>
<p class="spec-desc">지원&nbsp;</p>
</li>
<li>
<strong class="spec-title">플리커 세이프</strong>
<p class="spec-desc">지원&nbsp;</p>
</li>
<li>
<strong class="spec-title">소프트웨어 컨트롤</strong>
<p class="spec-desc">지원&nbsp;</p>
</li>
<li>
<strong class="spec-title">듀얼PC 컨트롤</strong>
<p class="spec-desc">지원&nbsp;</p>
</li>
<li>
<strong class="spec-title">스마트에너지세이빙(절전)</strong>
<p class="spec-desc">지원&nbsp;</p>
</li>
<li>
...
<li>
<strong class="spec-title">다크맵 모드</strong>
<p class="spec-desc">지원&nbsp;</p>
</li>
<li>
<strong class="spec-title">액션모드</strong>
<p class="spec-desc">지원&nbsp;</p>
</li>
</ol>
</dd>
...
<p class="spec-desc">714.3 x 595.9 x 226.7mm&nbsp;</p>
</li>
<li>
<strong class="spec-title">스텐드 제외 제품크기(HxWxD)(mm)</strong>
<p class="spec-desc"> 714.3 x 420.1 x 45.7mm&nbsp;</p>
</li>
<li>
<strong class="spec-title">제품 무게(kg)</strong>
<p class="spec-desc">6.5kg&nbsp;</p>
</li>
</ol>
</dd>
</dl>
...
<p class="spec-desc">어댑터, 파워 코드, HDMI 케이블, DP포트 케이블&nbsp;</p>
</li>
</ol>
</dd>
</dl>
...
<p class="spec-desc">R-R-LGE-32UN650&nbsp;</p>
</li>
<li>
<strong class="spec-title">무상보증기간</strong>
<p class="spec-desc">1년 무상보증&nbsp;</p>
</li>
<li>
<strong class="spec-title">제조회사</strong>
<p class="spec-desc">LG전자(주)&nbsp;</p>
</li>
<li>
<strong class="spec-title">등록년월</strong>
<p class="spec-desc">2020년 09월&nbsp;</p>
<li>
<strong class="spec-title">제조국</strong>
						...
						-->
											...
											<div class="review-lt-keywordsbar">
												...
												try {
													...
													sql_keyword += "WHERE Mno='32UN650' AND review_keyword LIKE '%G01%' UNION ALL ";
													sql_keyword += "SELECT 'G02' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='32UN650' AND review_keyword LIKE '%G02%' UNION ALL ";
													sql_keyword += "SELECT 'G03' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='32UN650' AND review_keyword LIKE '%G03%' UNION ALL ";
													sql_keyword += "SELECT 'G04' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='32UN650' AND review_keyword LIKE '%G04%' UNION ALL ";
													sql_keyword += "SELECT 'G05' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='32UN650' AND review_keyword LIKE '%G05%' UNION ALL ";
													sql_keyword += "SELECT 'G06' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='32UN650' AND review_keyword LIKE '%G06%' UNION ALL ";
													sql_keyword += "SELECT 'G07' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='32UN650' AND review_keyword LIKE '%G07%' UNION ALL ";
													sql_keyword += "SELECT 'G08' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='32UN650' AND review_keyword LIKE '%G08%' UNION ALL ";
													sql_keyword += "SELECT 'G09' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='32UN650' AND review_keyword LIKE '%G09%' UNION ALL ";
													sql_keyword += "SELECT 'G10' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='32UN650' AND review_keyword LIKE '%G10%' UNION ALL ";
													sql_keyword += "SELECT 'G99' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='32UN650' AND review_keyword LIKE '%G99%'";
									...
									<div class="review-content-body">
										...
										<div id="commentList">
											...
											<%
											// 작성된 리뷰 조회
											String sql_list = "SELECT * FROM review WHERE Mno='32UN650'";
