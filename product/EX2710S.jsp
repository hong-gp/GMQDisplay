					...
					<ol class="share-tooltip-box">												
						...
						try {
							...
							if (id != null) { 
								...
								pstmt_wish.setString(2, "EX2710S");

								ResultSet rs_wish = pstmt_wish.executeQuery();
								if (rs_wish.next()) {
						%>
							<button type="button" class="btn-good on" title="" form="EX2710S">
								<i class="icon ico-large ico-goods">좋아요 미선택</i>
							</button>
						<%
								} else {
						%>
							<button type="button" class="btn-good " title="" form="EX2710S">
								<i class="icon ico-large ico-goods">좋아요 미선택</i>
							</button>
						<%
								}
...
<!-- e : 이벤트 상품평 팝업 --></article>
		              	<!--3rd 파티 상품은 특장점/상품평/유의사항만 노출 -->
	        	<article class="component-con component08" id="compGoodsRelation1" style="display:none;">
		            	<!-- 연관제품-->
		            	<script type="text/javascript">
	// 연관제품 상세 호출
