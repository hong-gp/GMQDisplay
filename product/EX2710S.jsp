	...
	<div class="pd-Container" id="pd-inner-cont">
		<div class="pg-location ">
			<div class="pg-location-inner">
				...
				<a href="#">게임용 모니터</a>
				<a href="./../monitors.html?genre=fps/rts">FPS/RTS</a>
				<span>BenQ 모비우스</span>
			</div>
		</div>

		<section class="content" role="product_content_search">
			<div id="goods_detail_wrap" class="conbox" data-ctpath="/sec/" data-kakaokey="5880e4317936087f2764a5d340e6bca6" data-facebookid="" data-goods-id="EX2710S"
			data-goods-tp-cd="10" data-goods-Nm="BenQ 모비우스" data-admin-yn="" data-admin-price-yn="" data-task-id="" data-task-dtl-no="">

				<input type="hidden" name="returnUrl" value="./../static/images/product/EX2710S"/>
				<!-- s : 제품구매영역 -->
		...
		<div class="prod-image">
			<div class="prod-image-view">
				<div>
							<img src="./../static/images/product/EX2710S_1.png" alt="BenQ 모비우스 EX2710S정면" data-img-tp="10" data-seq="1">
				</div>
					<div>
							<img src="./../static/images/product/EX2710S_2.png" data-lazy="./../static/images/product/EX2710S_2.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 좌측 30도" data-img-tp="10" data-seq="2">
								</div>
					<div>
							<img src="./../static/images/product/EX2710S_3.png" data-lazy="./../static/images/product/EX2710S_3.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 우측 30도" data-img-tp="10" data-seq="3">
								</div>
					<div>
							<img src="./../static/images/product/EX2710S_4.png" data-lazy="./../static/images/product/EX2710S_4.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 모서리 디테일" data-img-tp="10" data-seq="4">
								</div>
					<div>
							<img src="./../static/images/product/EX2710S_5.png" data-lazy="./../static/images/product/EX2710S_5.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 피봇" data-img-tp="10" data-seq="5">
								</div>
					</div>
			<div class="prod-image-navi-wrap">
				<ol class="prod-image-navi">
					<li><span><a href="javascript:;"><img src="./../static/images/product/EX2710S_1.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 정면"></a></span></li>
						<li><span><a href="javascript:;"><img src="./../static/images/product/EX2710S_2.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 좌측 30도"></a></span></li>
						<li><span><a href="javascript:;"><img src="./../static/images/product/EX2710S_3.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 우측 30도"></a></span></li>
						<li><span><a href="javascript:;"><img src="./../static/images/product/EX2710S_4.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 모서리 디테일"></a></span></li>
						<li><span><a href="javascript:;"><img src="./../static/images/product/EX2710S_5.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 피봇"></a></span></li>
						</ol>
			</div>
			<div class="opt-btn">
				<!-- 이미지 삭제 및 em 태그 추가 -->
		...
		$("#mySpriteSpin").spritespin({
              ...
              // 로딩시 자동 롤링
					...
					<script type="text/javascript">
						$(document).ready(function () {
							...
							if(!isReady){
								...
								//옵션 변경
								$(goodsMain.vGoodsWrapId).data("goods-id", "EX2710S");
							}
							...
							//비교하기 버튼 클래스 추가
							$(".link-compare-i").addClass(isCompareDataStorageGoods("EX2710S")?'disabled':'');
				...
				/* 			var goodsOrdTpCd = ""
						...
						<div class="itm-info-detail" id="itmInfoDetail" data-mdl-code="EX2710S" data-url-nm="monitors" data-fmy-grp-nm="gaming-ls27bg654ekxkr-d2c" data-goods-nm="BenQ 모비우스" data-sale-stat="12" data-mdl-nm="EX2710S" data-fmy-eng-nm="gaming-ls27bg654ekxkr-d2c" data-goods-id="G000277237" data-envmt-gb-cd="prd" data-fast-dlvr-yn="N">
							...
							<input type="hidden" name="goodsNm" id="goodsNm" value="BenQ 모비우스">
							<input type="hidden" name="mdlCode" id="mdlCode" value="EX2710S">
...
function Urlsend(sns) {
    var thisUrl = "http://localhost:8080/GMQDisplay-master/product/EX2710S.jsp";
						...
						<div class="bookmarkTooltip flashTooltip bookmarkOn">
							<div>
							 ...
							 <div class="bookmarkTooltip flashTooltip bookmarkOff">
								...
								<h1 class="itm-info-title" id="goodsDetailNm">BenQ 모비우스</h1>
								<div class="itm-sku b2c-itm-sku compare-box-align">EX2710S</div>
										<!-- B2C, 패넷, 패넷 디플 PD페이지 비교하기 버튼 추가 s --> 
										<div class="compare">
												<a href="javascript:void(0);" class="link-compare-i" onclick="readyCompare(this)" data-goods-id="EX2710S" data-mdl-code="EX2710S " data-comp-disp-clsf-en-nm="monitors">
												비교하기
												</a>
											</div>
							...
							<!-- 가격이 없을 경우 영역 노출 X -->
								<script>
									...
									<div class="itm-price itm-type">
										<div>
											<input type="hidden" id="originalPrice" value="341500">	                               		
											<input type="hidden" id="discountAmount" value="0">
											<input type="hidden" id="lastPrice" value="341500">
										...
										<dt>기준가
											 ...
											 <dd>
												<span data-price="341500" class="pd-total-price">341,500</span>원
											</dd>
										</dl>
												<script type="text/javascript">
													if('341500' == '0'){
												...
												<dt>회원가</dt>
												<!-- 회원가 -->
												<dd><span class="discount" style="text-decoration-line: line-through">331,500</span>원</dd>
												</dl>
...
<!-- 구매 수량 -->
<form name="form" method="post" action="../buy/BuyEX2710S.html">
	<input type="hidden" name="Mno" value="EX2710S" />
											...
											<div class="dropDown-content itm-eventInfo">
												<div id="membership-info">
													<a href="javascript:MemDisplay();" class="dropButton" id="membershipDropBtn">
														<span>GMQDisplay 멤버십 <strong id="membership-ptn-top">3200 포인트</strong> 적립</span>
														...
														<div class="dropcontent" id="TabMembership">
															<div class="casewrap point-nomember" style="display: block;" >
																<p class="emphasis-txt border-line">GMQ Display
																	<em class="case-blue membership-ptn"> 포인트 3200 (기본 0.1%)</em> 적립 예정
																</p>
										...
										<!-- 회원 할인 적용 예상가 -->
											...
											<a class="sp-custom-c1071-1 ins-banner" href="javascript:void(0);"><div class="ins-pd-inline-banner" style="margin-top:15px;"></div></a>
												...
												<div  class="tooltip-content1" style="display:none;" id="divToggle3">
													<p style="margin-top:10px;"><b>할인 금액</b> : 21,500원</p>
												</div>
												</dt>
													<strong data-price="320000">320,000</strong><span>원</span>
												</dl>
											</div>
																					 <div class="box-btn">
																								<div class="box-cto">
...
<!-- 추가된 부분 -->
	    ...
	    <section class="component-bar" role="product_content_search">
	        <div class="component-bar-inner">
	            <div>
	                <div class="itm-title-text" id="goods-title-text">BenQ 모비우스</div>
...
<div class="wrap-component feature-benefit pt-none pb-none w1440px img-bottom" >
	<div class="component-contents  pt-wide pb-none txt-mid-center txtm-top-center "  style="background-image:url('./../static/images/explain/EX2710S_6.png') " data-cptnm="">
		<div class="component-text">
			<div class="component-text-inner">
				<div class="box-title"">
					<img src="./../static/images/explain/EX2710S_0.png" class="objGif"><br>
					<h2 class="title mo-ver lrg" style="color:white">벤큐 프리미엄 게이밍 브랜드 모비우스</h2><br>	
					<h2 class="title pc-ver lrg" style="color:white">벤큐 프리미엄 게이밍 브랜드 모비우스</h2><br>
					<h2 class="title mo-ver lrg" style="color:ORANGE">MOBIUZ EX2710S</h2><br>	
					<h2 class="title pc-ver lrg" style="color:ORANGE">MOBIUZ EX2710S</h2><br>
				</div>
			</div>
		</div>
<div class="visual-area ">
	<img src="./../static/images/explain/EX2710S_1.png"" class="objGif">
</div>
</div>
</div>
...
<div class="wrap-component feature-benefit pt-none pb-none w1440px img-bottom      ">
	<div class="component-contents  pt-wide pb-none txt-mid-center txtm-top-center "  style="background-color:#FFFFFF" data-cptnm="">
		<div class="component-text">
			<div class="component-text-inner">
				<div class="box-title">
					<h2 class="title mo-ver lrg" style="color:#000000">MOBIUZ EX2710S와 함께<br>게임을 즐기십시오.</h2>
					
					<h2 class="title pc-ver lrg" style="color:#000000">MOBIUZ EX2710S와 함께<br>게임을 즐기십시오.</h2><br>

					<p class="desc mo-ver "style="color:#000000">EX2710S는 165Hz의 주사율과 AMD 프리싱크 프리미엄 기능을<br>탑재하여 잔상을 최소화 하여 부드러운 게이밍 화면을 보여줍니다.</p>
					
					<p class="desc pc-ver "style="color:#000000">EX2710S는 165Hz의 주사율과 AMD 프리싱크 프리미엄 기능을<br>탑재하여 잔상을 최소화 하여 부드러운 게이밍 화면을 보여줍니다.</p><br>

					<p class="desc mo-ver "style="color:#000000">IPS광시야각 패널은 어떤 각도에서도 놀라운 색상을 나타내며,<br>벤큐만의 독자적은 HDRi 기술로 디테일한 이미지를 표현합니다.</p>
					
					<p class="desc pc-ver "style="color:#000000">IPS광시야각 패널은 어떤 각도에서도 놀라운 색상을 나타내며,<br>벤큐만의 독자적은 HDRi 기술로 디테일한 이미지를 표현합니다.</p><br>

					<p class="desc mo-ver "style="color:#000000">주변공간을 가득 채워주는 트레볼로의 트루 사운드로<br>몰입감을 선사합니다.</p>
					
					<p class="desc pc-ver "style="color:#000000">주변공간을 가득 채워주는 트레볼로의 트루 사운드로<br>몰입감을 선사합니다.</p>
				</div>
			</div>
		</div>	
	</div>
		<!-- 두번째 사진 -->
<div class="visual-area  ">
<img src="./../static/images/explain/EX2710S_2.png"" class="objGif">
</div>
</div>
...
<div class="wrap-component feature-benefit pt-none pb-none w1440px img-bottom">
	<div class="component-contents  pt-wide pb-none txt-mid-center txtm-top-center "  style="background-color:#FFFFFF" data-cptnm="">
		...
		<div class="component-text">
			<div class="component-text-inner">
				<div class="box-title">
					<h2 class="title mo-ver lrg" style="color:#666666">강화된 성능</h2><br>	
					<h2 class="title pc-ver lrg" style="color:#666666">강화된 성능</h2><br>

					<h2 class="title mo-ver lrg" style="color:orange">EXpanded Performance</h2><br>	
					<h2 class="title pc-ver lrg" style="color:orange">EXpanded Performance</h2><br>

					<h2 class="title mo-ver lrg" style="color:#000000">HDRi : Intelligent Optimization</h2><br>	
					<h2 class="title pc-ver lrg" style="color:#000000">HDRi : Intelligent Optimization</h2><br>

					<p class="desc mo-ver "style="color:black;">HDRi의 디테일과 함께 여러분을 게임 속으로 끌어들입니다.<br>분리형 센서는 주변조도를 감지하고,<br>화면의 HDR영상을 조정하여 이상적인 디스플레이를 제공합니다.</p>
					<p class="desc pc-ver "style="color:black;">HDRi의 디테일과 함께 여러분을 게임 속으로 끌어들입니다.<br>분리형 센서는 주변조도를 감지하고,<br>화면의 HDR영상을 조정하여 이상적인 디스플레이를 제공합니다.</p>
				</div>
			</div>
		</div>	
	<div class="visual-area  ">
<img src="./../static/images/explain/EX2710S_3.png"" class="objGif">
</div>
	</div>
		</div>
...
<div class="wrap-component feature-benefit pt-none pb-none w1440px img-bottom      ">
	<div class="component-contents  pt-wide pb-none txt-mid-center txtm-top-center "  style="background-image:url('./../static/images/explain/EX2710S_6.png')" data-cptnm="">
		<div class="component-text">
			<div class="component-text-inner">
				<div class="box-title">
					<h2 class="title mo-ver lrg" style="color:#cccccc">강력한 사운드</h2><br>	
					<h2 class="title pc-ver lrg" style="color:#cccccc">강화된 사운드</h2><br>

					<h2 class="title mo-ver lrg" style="color:orange">EXpansive Sound</h2>	
					<h2 class="title pc-ver lrg" style="color:orange">EXpansive Sounde</h2>

					<p class="desc mo-ver "style="color:white;">EX2710S는 2개의 2.5W 스피커와 DSP칩이 내장되었으며,<br>3가지 사용자 지정 사운드 모드가 있습니다.<br>각 시나리오에 맞게 오디오 설정을 선택하실 수 있습니다.</p><br>
					<p class="desc pc-ver "style="color:white;">EX2710S는 2개의 2.5W 스피커와 DSP칩이 내장되었으며,<br>3가지 사용자 지정 사운드 모드가 있습니다.<br>각 시나리오에 맞게 오디오 설정을 선택하실 수 있습니다.</p><br>

					<p class="desc mo-ver "style="color:white;">완벽한 몰입을 위해 DSP칩과 스피커 어레이는<br>증폭된 깊이와 강도를 제공합니다.</p>
					<p class="desc pc-ver "style="color:white;">완벽한 몰입을 위해 DSP칩과 스피커 어레이는<br>증폭된 깊이와 강도를 제공합니다.</p>
				</div>
			</div>
		</div>	
	</div>
...
<div class="component-contents  pt-wide pb-none txt-mid-center txtm-top-center "  style="background-color:#FFFFFF" data-cptnm="">
		<div class="visual-area  ">
<!-- 세번째 사진 -->
<img src="./../static/images/explain/EX2710S_4.png"" class="objGif">	
</div>
		<div class="component-text">
			<div class="component-text-inner">
				<div class="box-title">
					<h2 class="title mo-ver lrg" style="color:orange">블랙 이퀄라이저(Black eQualizer)</h2><br>	
					<h2 class="title pc-ver lrg" style="color:orange">블랙 이퀄라이저(Black eQualizer)</h2><br>

					<p class="desc mo-ver "style="color:black;">벤큐의 블랙 이퀄라이저(Black eQualizer)모드는,<br>적용시 어두운 암부 영역만을 사용자가 원하는 0~10단계로<br>조정함으로써 화면의 왜곡을 최소한으로 줄이고<br>식별에 용이하게 도와주는 기능입니다.<br><br>FPS게임 시 적이나 물체를 보다 빠르게 발견할 수 있으며,<br>섬광탄이 터져도 빠르게 시야를 회복합니다.</p><br>
					<p class="desc pc-ver "style="color:black;">벤큐의 블랙 이퀄라이저(Black eQualizer)모드는,<br>적용시 어두운 암부 영역만을 사용자가 원하는 0~10단계로<br>조정함으로써 화면의 왜곡을 최소한으로 줄이고<br>식별에 용이하게 도와주는 기능입니다.<br><br>FPS게임 시 적이나 물체를 보다 빠르게 발견할 수 있으며,<br>섬광탄이 터져도 빠르게 시야를 회복합니다.</p><br>
				</div>
			</div>
		</div>	
	</div>
	<div class="visual-area  ">
<!-- 네번째 사진 -->
<img src="./../static/images/explain/EX2710S_5.png"" class="objGif">	
</div>
</div>
...
<div class="spec-table-wrap"><h3 class="spec-itm-title" id="cstrt-nm">BENQ 모비우스 EX2710S</h3>
...
<p class="spec-desc">597.6 x 336.15&nbsp;</p>
</li>
<li>
...
<p class="spec-desc">99% sRGB&nbsp;</p>
</li>
<li>
<strong class="spec-title">디스플레이 색상</strong>
<p class="spec-desc">LED&nbsp;</p>
</li>
<li>
<strong class="spec-title">주사율</strong>
<p class="spec-desc">Max 165 Hz&nbsp;</p>
</li>
</ol>
</dd>
</dl>
...
<p class="spec-desc">2.5W x 2&nbsp;</p>
</li>
<li>
<strong class="spec-title">색온도</strong>
<p class="spec-desc">Bluish/Normal/Reddish/User mode&nbsp;</p>
</li>
<li>
<strong class="spec-title">K locker</strong>
<p class="spec-desc">지원&nbsp;</p>
</li>
<li>
<strong class="spec-title">OSD 언어</strong>
<p class="spec-desc">18개언어(한글지원)&nbsp;</p>
</li>
<li>
<strong class="spec-title">HDCP</strong>
<p class="spec-desc">2.2(HDMI 2.0, DP 1.2)&nbsp;</p>
</li>
<li>
...
<li>
<strong class="spec-title">로우블루라이트</strong>
<p class="spec-desc">지원&nbsp;</p>
</li>
<li>
<strong class="spec-title">B.I.+테크놀러지</strong>
<p class="spec-desc">지원&nbsp;</p>
</li>
<li>
<strong class="spec-title">ePaper</strong>
<p class="spec-desc">지원&nbsp;</p>
</li>
<li>
<strong class="spec-title">라이트튜너</strong>
<p class="spec-desc">지원&nbsp;</p>
</li>
<li>
<strong class="spec-title">FPS모드</strong>
<p class="spec-desc">지원&nbsp;</p>
</li>
<li>
<strong class="spec-title">모션 블러리 덕션</strong>
<p class="spec-desc">지원&nbsp;</p>
</li>
<li>
...
<li>
<strong class="spec-title">컬러바이브런스</strong>
<p class="spec-desc">지원&nbsp;</p>
</li>
<li>
...
<li>
<strong class="spec-title">AMD FreeSync Premium</strong>
<p class="spec-desc">지원&nbsp;</p>
</li>
</ol>
</dd>
...
<ol>
<li>
<strong class="spec-title">HDMI 2.0</strong>
<p class="spec-desc">x2&nbsp;</p>
</li>
<li>
<strong class="spec-title">DP 1.2</strong>
...
<ol>
<li>
<strong class="spec-title">제품크기(HxWxD)(mm)</strong>
<p class="spec-desc">539.59 x 614.1 x 216.7mm&nbsp;</p>
</li>
<li>
<strong class="spec-title">스텐드 제외 제품크기(HxWxD)(mm)</strong>
<p class="spec-desc">382.2 x 614.1 x 64.1mm&nbsp;</p>
</li>
<li>
<strong class="spec-title">제품 무게(kg)</strong>
<p class="spec-desc">6.2kg&nbsp;</p>
</li>
<li>
<strong class="spec-title">스텐드 제품 무게(kg)</strong>
<p class="spec-desc">4kg&nbsp;</p>
</li>
<li>
<strong class="spec-title">높낮이</strong>
<p class="spec-desc">130mm&nbsp;</p>
</li>
<li>
<strong class="spec-title">배사홀</strong>
<p class="spec-desc">지원&nbsp;</p>
</li>
</ol>
</dd>
...
<ol>
<li>
<strong class="spec-title">기본 구성품</strong>
<p class="spec-desc">퀵 스타트 가이드, 안전 지침서, HDMI2.0, 파워 케이블&nbsp;</p>
</li>
</ol>
</dd>
</dl>
...
<li>
<strong class="spec-title">파워세이빙모드, 대기모드</strong>
<p class="spec-desc">0.5W&nbsp;</p>
</li>
<li>
<strong class="spec-title">최대 소비전력</strong>
<p class="spec-desc">55W&nbsp;</p>
</li>
<li>
<strong class="spec-title">AMA</strong>
<p class="spec-desc">지원&nbsp;</p>
</li>
<li>
<strong class="spec-title">Windows 7, 8, 8.1, 10</strong>
<p class="spec-desc">호환&nbsp;</p>
</li>
<li>
<strong class="spec-title">KC</strong>
<p class="spec-desc">XU100626-20049A&nbsp;</p>
</li>
<li>
<strong class="spec-title">KCC</strong>
<p class="spec-desc">R-R-TPF-EX2710-T&nbsp;</p>
</li>
<li>
<strong class="spec-title">무상보증기간</strong>
<p class="spec-desc">패널포함 3년 무상보증&nbsp;</p>
</li>
<li>
<strong class="spec-title">제조회사</strong>
<p class="spec-desc">BENQ Corp&nbsp;</p>
</li>
<li>
<strong class="spec-title">등록년월</strong>
<p class="spec-desc">2021년 2월&nbsp;</p>
</li>
</ol>
</dd>
</dl>
						...
						-->
											...
											<div class="review-lt-keywordsbar">
												...
												try {
													...
													sql_keyword += "WHERE Mno='EX2710S' AND review_keyword LIKE '%G01%' UNION ALL ";
													sql_keyword += "SELECT 'G02' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='EX2710S' AND review_keyword LIKE '%G02%' UNION ALL ";
													sql_keyword += "SELECT 'G03' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='EX2710S' AND review_keyword LIKE '%G03%' UNION ALL ";
													sql_keyword += "SELECT 'G04' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='EX2710S' AND review_keyword LIKE '%G04%' UNION ALL ";
													sql_keyword += "SELECT 'G05' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='EX2710S' AND review_keyword LIKE '%G05%' UNION ALL ";
													sql_keyword += "SELECT 'G06' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='EX2710S' AND review_keyword LIKE '%G06%' UNION ALL ";
													sql_keyword += "SELECT 'G07' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='EX2710S' AND review_keyword LIKE '%G07%' UNION ALL ";
													sql_keyword += "SELECT 'G08' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='EX2710S' AND review_keyword LIKE '%G08%' UNION ALL ";
													sql_keyword += "SELECT 'G09' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='EX2710S' AND review_keyword LIKE '%G09%' UNION ALL ";
													sql_keyword += "SELECT 'G10' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='EX2710S' AND review_keyword LIKE '%G10%' UNION ALL ";
													sql_keyword += "SELECT 'G99' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='EX2710S' AND review_keyword LIKE '%G99%'";
									...
									<div class="review-content-body">
										...
										<div id="commentList">
											...
											<%
											// 작성된 리뷰 조회
											String sql_list = "SELECT * FROM review WHERE Mno='EX2710S'";
