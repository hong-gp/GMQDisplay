	...
	<div class="pd-Container" id="pd-inner-cont">
		<div class="pg-location ">
			<div class="pg-location-inner">
				...
				<a href="#">전문가용 모니터</a>
				<a href="./../monitors.html?genre=graphic">그래픽 작업용</a>
				<span>오디세이 Neo G9 123.8 cm</span>
			</div>
		</div>

		<section class="content" role="product_content_search">
			<div id="goods_detail_wrap" class="conbox" data-ctpath="/sec/" data-kakaokey="5880e4317936087f2764a5d340e6bca6" data-facebookid="" data-goods-id="LS49AG950NKXKR"
			data-goods-tp-cd="10" data-goods-Nm="오디세이 Neo G9 123.8 cm" data-admin-yn="" data-admin-price-yn="" data-task-id="" data-task-dtl-no="">

				<input type="hidden" name="returnUrl" value="./../static/images/product/LS49AG950NKXKR"/>
				<!-- s : 제품구매영역 -->
		...
		<div class="prod-image">
			<div class="prod-image-view">
				<div>
							<img src="./../static/images/product/LS49AG950NKXKR_1.png" alt="오디세이 Neo G9 123.8 cm LS49AG950NKXKR정면" data-img-tp="10" data-seq="1">
				</div>
					<div>
							<img src="./../static/images/product/LS49AG950NKXKR_2.png" data-lazy="./../static/images/product/LS49AG950NKXKR_2.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 좌측 30도" data-img-tp="10" data-seq="2">
								</div>
					<div>
							<img src="./../static/images/product/LS49AG950NKXKR_3.png" data-lazy="./../static/images/product/LS49AG950NKXKR_3.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 우측 30도" data-img-tp="10" data-seq="3">
								</div>
					<div>
							<img src="./../static/images/product/LS49AG950NKXKR_4.png" data-lazy="./../static/images/product/LS49AG950NKXKR_4.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 모서리 디테일" data-img-tp="10" data-seq="4">
								</div>
					<div>
							<img src="./../static/images/product/LS49AG950NKXKR_5.png" data-lazy="./../static/images/product/LS49AG950NKXKR_5.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 피봇" data-img-tp="10" data-seq="5">
								</div>
					</div>
			<div class="prod-image-navi-wrap">
				<ol class="prod-image-navi">
					<li><span><a href="javascript:;"><img src="./../static/images/product/LS49AG950NKXKR_1.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 정면"></a></span></li>
						<li><span><a href="javascript:;"><img src="./../static/images/product/LS49AG950NKXKR_2.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 좌측 30도"></a></span></li>
						<li><span><a href="javascript:;"><img src="./../static/images/product/LS49AG950NKXKR_3.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 우측 30도"></a></span></li>
						<li><span><a href="javascript:;"><img src="./../static/images/product/LS49AG950NKXKR_4.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 모서리 디테일"></a></span></li>
						<li><span><a href="javascript:;"><img src="./../static/images/product/LS49AG950NKXKR_5.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 피봇"></a></span></li>
						</ol>
			</div>
			<div class="opt-btn">
				<!-- 이미지 삭제 및 em 태그 추가 -->
		...
		$("#mySpriteSpin").spritespin({
              ...
              // 로딩시 자동 롤링
					...
					<script type="text/javascript">
						$(document).ready(function () {
							...
							if($("#membership-info").length > 0){
								var goods = new Array();
								var mainGoods = {
									goodsId : "LS49AG950NKXKR"
									, mdlCode : 'LS49AG950NKXKR'
							...
							if(!isReady){
								...
								//옵션 변경
								$(goodsMain.vGoodsWrapId).data("goods-id", "LS49AG950NKXKR");
							}
							...
							//비교하기 버튼 클래스 추가
							$(".link-compare-i").addClass(isCompareDataStorageGoods("LS49AG950NKXKR")?'disabled':'');
				...
				/* 			var goodsOrdTpCd = ""
						...
						<div class="itm-info-detail" id="itmInfoDetail" data-mdl-code="LS49AG950NKXKR" data-url-nm="monitors" data-fmy-grp-nm="gaming-ls27bg654ekxkr-d2c" data-goods-nm="오디세이 Neo G9 123.8 cm" data-sale-stat="12" data-mdl-nm="LS49AG950NKXKR" data-fmy-eng-nm="gaming-ls27bg654ekxkr-d2c" data-goods-id="G000277237" data-envmt-gb-cd="prd" data-fast-dlvr-yn="N">
							...
							<input type="hidden" name="goodsNm" id="goodsNm" value="오디세이 Neo G9 123.8 cm">
							<input type="hidden" name="mdlCode" id="mdlCode" value="LS49AG950NKXKR">
...
function Urlsend(sns) {
    var thisUrl = "http://localhost:8080/GMQDisplay-master/product/LS49AG950NKXKR.jsp";
						...
						<div class="bookmarkTooltip flashTooltip bookmarkOn">
							<div>
							 ...
							 <div class="bookmarkTooltip flashTooltip bookmarkOff">
								...
								<h1 class="itm-info-title" id="goodsDetailNm">오디세이 Neo G9 123.8 cm</h1>
								<div class="itm-sku b2c-itm-sku compare-box-align">LS49AG950NKXKR</div>
										<!-- B2C, 패넷, 패넷 디플 PD페이지 비교하기 버튼 추가 s --> 
										<div class="compare">
												<a href="javascript:void(0);" class="link-compare-i" onclick="readyCompare(this)" data-goods-id="LS49AG950NKXKR" data-mdl-code="LS49AG950NKXKR " data-comp-disp-clsf-en-nm="monitors">
												비교하기
												</a>
											</div>
							...
							<!-- 가격이 없을 경우 영역 노출 X -->
								<script>
									...
									<div class="itm-price itm-type">
										<div>
											<input type="hidden" id="originalPrice" value="2200000">	                               		
											<input type="hidden" id="discountAmount" value="0">
											<input type="hidden" id="lastPrice" value="2200000">
										...
										<dt>기준가
											 ...
											 <dd>
												<span data-price="2200000" class="pd-total-price">2,200,000</span>원
											</dd>
										</dl>
												<script type="text/javascript">
													if('2200000' == '0'){
												...
												<dt>회원가</dt>
												<!-- 회원가 -->
												<dd><span class="discount" style="text-decoration-line: line-through">2,150,000</span>원</dd>
												</dl>
...
<form name="form" method="post" action="/GMQDisplay-master/order/order.jsp">
	<input type="hidden" name="Mno" value="LS49AG950NKXKR" />
											...
											<div class="dropDown-content itm-eventInfo">
												<div id="membership-info">
													<a href="javascript:MemDisplay();" class="dropButton" id="membershipDropBtn">
														<span>GMQDisplay 멤버십 <strong id="membership-ptn-top">20500 포인트</strong> 적립</span>
														...
														<div class="dropcontent" id="TabMembership">
															<div class="casewrap point-nomember" style="display: block;" >
																<p class="emphasis-txt border-line">GMQ Display
																	<em class="case-blue membership-ptn"> 포인트 20500 (기본 0.1%)</em> 적립 예정
																</p>
										...
										<!-- 회원 할인 적용 예상가 -->
											...
											<a class="sp-custom-c1071-1 ins-banner" href="javascript:void(0);"><div class="ins-pd-inline-banner" style="margin-top:15px;"></div></a>
												...
												<div  class="tooltip-content1" style="display:none;" id="divToggle3">
													<p style="margin-top:10px;"><b>할인 금액</b> : 150,000원</p>
												</div>
												</dt>
													<strong data-price="2050000">2,050,000</strong><span>원</span>
												</dl>
											</div>
																					 <div class="box-btn">
																								<div class="box-cto">
...
<!-- 추가된 부분 -->
	    ...
	    <section class="component-bar" role="product_content_search">
	        <div class="component-bar-inner">
	            <div>
	                <div class="itm-title-text" id="goods-title-text">오디세이 Neo G9 123.8 cm</div>
...
<div class="wrap-component feature-benefit pt-none pb-none w1440px img-bottom" >
	<div class="component-contents  pt-wide pb-none txt-mid-center txtm-top-center "  style="background-image:url('./../static/images/explain/LS49AG950NKXKR_6.png') " data-cptnm="">
		<div class="visual-area ">
			<img src="./../static/images/explain/LS49AG950NKXKR_1.png"" class="objGif">
		</div>
	</div>
</div>
	...
	<div class="component-contents  pt-wide pb-none txt-mid-center txtm-top-center "  style="background-color:black;" data-cptnm="">
		<div class="component-text">
			<div class="component-text-inner">
				<div class="box-title">
					<h2 class="title mo-ver lrg" style="color:white">퀀텀 매트릭스 기술로 완성한<br>궁극의 화질</h2>
					
					<h2 class="title pc-ver lrg" style="color:white">퀀텀 매트릭스 기술로 완성한<br>궁극의 화질</h2>

					<p class="desc mo-ver "style="color:white">퀀텀 매트릭스 기술이 선사하는 최고 수준의 화질로 플레이하세요.<br>퀀텀 mini LED로 업그레이드된 2,048개 로컬 디밍 존은 밤하늘 은하수도 선명하게 표현해주며,<br>4,096단계의 세밀한 명암 조절이 블랙과 화이트를 완벽에 가깝게 표현해주죠.</p>
					
					<p class="desc pc-ver "style="color:white">퀀텀 매트릭스 기술이 선사하는 최고 수준의 화질로 플레이하세요.<br>퀀텀 mini LED로 업그레이드된 2,048개 로컬 디밍 존은 밤하늘 은하수도 선명하게 표현해주며,<br>4,096단계의 세밀한 명암 조절이 블랙과 화이트를 완벽에 가깝게 표현해주죠.</p>
				</div>
			</div>
		</div>	
	</div>
		<!-- 두번째 사진 -->
<div class="visual-area  ">
<img src="./../static/images/explain/LS49AG950NKXKR_2.png"" class="objGif">
</div>
</div>
...
<div class="wrap-component feature-benefit pt-none pb-none w1440px img-bottom">
	<div class="component-contents  pt-wide pb-none txt-mid-center txtm-top-center "  style="background-color:black;" data-cptnm="">
		<div class="visual-area  ">
			<img src="./../static/images/explain/LS49AG950NKXKR_3.png"" class="objGif">
		</div>
	</div>
</div>
...
<div class="spec-table-wrap"><h3 class="spec-itm-title" id="cstrt-nm">오디세이 Neo G9 123.8 cm</h3>
...
<p class="spec-desc">1191.936 x 335.232&nbsp;</p>
</li>
<li>
...
<p class="spec-desc">420 cd/㎡&nbsp;</p>
</li>
<li>
<strong class="spec-title">명암비</strong>
<p class="spec-desc">1,000,000:1&nbsp;</p>
</li>
<li>
...
<p class="spec-desc">5,120 x 1,440 &nbsp;</p>
</li>
<li>
...
<ol>
<li>
<strong class="spec-title">HDMI 2.1</strong>
<p class="spec-desc">x2&nbsp;</p>
</li>
<li>
<strong class="spec-title">DP 1.4</strong>
...
<li>
<strong class="spec-title">스텐드 포함 제품크기(HxWxD)(mm)</strong>
<p class="spec-desc">1149.5 x 537.2 x 418.3 mm&nbsp;</p>
</li>
<li>
<strong class="spec-title">스텐드 제외 제품크기(HxWxD)(mm)</strong>
<p class="spec-desc">1149.5 x 363.5 x 287.4 mm&nbsp;</p>
</li>
<li>
<strong class="spec-title">제품 무게(kg)</strong>
<p class="spec-desc">11.9 kg&nbsp;</p>
</li>
</ol>
</dd>
</dl>
...
<p class="spec-desc">XU100696-21078&nbsp;</p>
</li>
<li>
<strong class="spec-title">KCC</strong>
<p class="spec-desc"> R-R-SEC-S49AG950N&nbsp;</p>
</li>
<li>
...
<%
	try {
		...
		pstmt.setString(1, "LS49AG950NKXKR");
										...
										<div class="review-lt-condition">
											...
											<div class="review-lt-status">
												...
												try {
													...
													pstmt2.setString(1, "LS49AG950NKXKR");
													pstmt2.setInt(2, 5);
													...
													pstmt3.setString(1, "LS49AG950NKXKR");
													pstmt3.setInt(2, 4);
													...
													pstmt4.setString(1, "LS49AG950NKXKR");
													pstmt4.setInt(2, 3);
													...
													pstmt5.setString(1, "LS49AG950NKXKR");
													pstmt5.setInt(2, 2);
													...
													pstmt6.setString(1, "LS49AG950NKXKR");
													pstmt6.setInt(2, 1);
						...
						-->
											...
											<div class="review-lt-keywordsbar">
												...
												try {
													...
													sql_keyword += "WHERE Mno='LS49AG950NKXKR' AND review_keyword LIKE '%G01%' UNION ALL ";
													sql_keyword += "SELECT 'G02' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='LS49AG950NKXKR' AND review_keyword LIKE '%G02%' UNION ALL ";
													sql_keyword += "SELECT 'G03' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='LS49AG950NKXKR' AND review_keyword LIKE '%G03%' UNION ALL ";
													sql_keyword += "SELECT 'G04' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='LS49AG950NKXKR' AND review_keyword LIKE '%G04%' UNION ALL ";
													sql_keyword += "SELECT 'G05' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='LS49AG950NKXKR' AND review_keyword LIKE '%G05%' UNION ALL ";
													sql_keyword += "SELECT 'G06' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='LS49AG950NKXKR' AND review_keyword LIKE '%G06%' UNION ALL ";
													sql_keyword += "SELECT 'G07' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='LS49AG950NKXKR' AND review_keyword LIKE '%G07%' UNION ALL ";
													sql_keyword += "SELECT 'G08' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='LS49AG950NKXKR' AND review_keyword LIKE '%G08%' UNION ALL ";
													sql_keyword += "SELECT 'G09' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='LS49AG950NKXKR' AND review_keyword LIKE '%G09%' UNION ALL ";
													sql_keyword += "SELECT 'G10' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='LS49AG950NKXKR' AND review_keyword LIKE '%G10%' UNION ALL ";
													sql_keyword += "SELECT 'G99' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='LS49AG950NKXKR' AND review_keyword LIKE '%G99%'";
									...
									<div class="review-content-body">
										...
										<div id="commentList">
											...
											<%
											// 작성된 리뷰 조회
											String sql_list = "SELECT * FROM review WHERE Mno='LS49AG950NKXKR'";
