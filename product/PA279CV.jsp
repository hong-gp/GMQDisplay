	...
	<div class="pd-Container" id="pd-inner-cont">
		<div class="pg-location ">
			<div class="pg-location-inner">
				...
				<span>ASUS ProArt PA279CV 4K 인텍앤컴퍼니</span>
			</div>
		</div>

		<section class="content" role="product_content_search">
			<div id="goods_detail_wrap" class="conbox" data-ctpath="/sec/" data-kakaokey="5880e4317936087f2764a5d340e6bca6" data-facebookid="" data-goods-id="PA279CV"
			data-goods-tp-cd="10" data-goods-Nm="ASUS ProArt PA279CV 4K 인텍앤컴퍼니" data-admin-yn="" data-admin-price-yn="" data-task-id="" data-task-dtl-no="">

				<input type="hidden" name="returnUrl" value="./../static/images/product/PA279CV"/>
				<!-- s : 제품구매영역 -->
		...
		<div class="prod-image">
			<div class="prod-image-view">
				<div>
							<img src="./../static/images/product/PA279CV_1.png" alt="ASUS ProArt PA279CV 4K 인텍앤컴퍼니 PA279CV정면" data-img-tp="10" data-seq="1">
				</div>
					<div>
							<img src="./../static/images/product/PA279CV_2.png" data-lazy="./../static/images/product/PA279CV_2.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 좌측 30도" data-img-tp="10" data-seq="2">
								</div>
					<div>
							<img src="./../static/images/product/PA279CV_3.png" data-lazy="./../static/images/product/PA279CV_3.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 우측 30도" data-img-tp="10" data-seq="3">
								</div>
					<div>
							<img src="./../static/images/product/PA279CV_4.png" data-lazy="./../static/images/product/PA279CV_4.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 모서리 디테일" data-img-tp="10" data-seq="4">
								</div>
					<div>
							<img src="./../static/images/product/PA279CV_5.png" data-lazy="./../static/images/product/PA279CV_5.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 피봇" data-img-tp="10" data-seq="5">
								</div>
					</div>
			<div class="prod-image-navi-wrap">
				<ol class="prod-image-navi">
					<li><span><a href="javascript:;"><img src="./../static/images/product/PA279CV_1.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 정면"></a></span></li>
						<li><span><a href="javascript:;"><img src="./../static/images/product/PA279CV_2.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 좌측 30도"></a></span></li>
						<li><span><a href="javascript:;"><img src="./../static/images/product/PA279CV_3.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 우측 30도"></a></span></li>
						<li><span><a href="javascript:;"><img src="./../static/images/product/PA279CV_4.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 모서리 디테일"></a></span></li>
						<li><span><a href="javascript:;"><img src="./../static/images/product/PA279CV_5.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 피봇"></a></span></li>
						</ol>
			</div>
			<div class="opt-btn">
				<!-- 이미지 삭제 및 em 태그 추가 -->
		...
		$("#mySpriteSpin").spritespin({
              ...
              // 로딩시 자동 롤링
					...
					<script type="text/javascript">
						$(document).ready(function () {
							...
							if(!isReady){
								...
								//옵션 변경
								$(goodsMain.vGoodsWrapId).data("goods-id", "PA279CV");
							}
							...
							//비교하기 버튼 클래스 추가
							$(".link-compare-i").addClass(isCompareDataStorageGoods("PA279CV")?'disabled':'');
				...
				/* 			var goodsOrdTpCd = ""
						...
						<div class="itm-info-detail" id="itmInfoDetail" data-mdl-code="PA279CV" data-url-nm="monitors" data-fmy-grp-nm="gaming-ls27bg654ekxkr-d2c" data-goods-nm="ASUS ProArt PA279CV 4K 인텍앤컴퍼니" data-sale-stat="12" data-mdl-nm="PA279CV" data-fmy-eng-nm="gaming-ls27bg654ekxkr-d2c" data-goods-id="G000277237" data-envmt-gb-cd="prd" data-fast-dlvr-yn="N">
							...
							<input type="hidden" name="goodsNm" id="goodsNm" value="ASUS ProArt PA279CV 4K 인텍앤컴퍼니">
							<input type="hidden" name="mdlCode" id="mdlCode" value="PA279CV">
...
function Urlsend(sns) {
    var thisUrl = "http://localhost:8080/GMQDisplay-master/product/PA279CV.jsp";
						...
						<div class="bookmarkTooltip flashTooltip bookmarkOn">
							<div>
							 ...
							 <div class="bookmarkTooltip flashTooltip bookmarkOff">
								...
								<h1 class="itm-info-title" id="goodsDetailNm">ASUS ProArt PA279CV 4K 인텍앤컴퍼니</h1>
								<div class="itm-sku b2c-itm-sku compare-box-align">PA279CV</div>
										<!-- B2C, 패넷, 패넷 디플 PD페이지 비교하기 버튼 추가 s --> 
										<div class="compare">
												<a href="javascript:void(0);" class="link-compare-i" onclick="readyCompare(this)" data-goods-id="PA279CV" data-mdl-code="PA279CV " data-comp-disp-clsf-en-nm="monitors">
												비교하기
												</a>
											</div>
							...
							<!-- 가격이 없을 경우 영역 노출 X -->
								<script>
									...
									<div class="itm-price itm-type">
										<div>
											<input type="hidden" id="originalPrice" value="609000">	                               		
											<input type="hidden" id="discountAmount" value="0">
											<input type="hidden" id="lastPrice" value="609000">
										...
										<dt>기준가
											 ...
											 <dd>
												<span data-price="609000" class="pd-total-price">609,000</span>원
											</dd>
										</dl>
												<script type="text/javascript">
													if('609000' == '0'){
												...
												<dt>회원가</dt>
												<!-- 회원가 -->
												<dd><span class="discount" style="text-decoration-line: line-through">605,000</span>원</dd>
												</dl>
...
<form name="form" method="post" action="/GMQDisplay-master/order/order.jsp">
	<input type="hidden" name="Mno" value="PA279CV" />
											...
											<div class="dropDown-content itm-eventInfo">
												<div id="membership-info">
													<a href="javascript:MemDisplay();" class="dropButton" id="membershipDropBtn">
														<span>GMQDisplay 멤버십 <strong id="membership-ptn-top">5990 포인트</strong> 적립</span>
														...
														<div class="dropcontent" id="TabMembership">
															<div class="casewrap point-nomember" style="display: block;" >
																<p class="emphasis-txt border-line">GMQ Display
																	<em class="case-blue membership-ptn"> 포인트 5990 (기본 0.1%)</em> 적립 예정
																</p>
										...
										<!-- 회원 할인 적용 예상가 -->
											...
											<a class="sp-custom-c1071-1 ins-banner" href="javascript:void(0);"><div class="ins-pd-inline-banner" style="margin-top:15px;"></div></a>
												...
												<div  class="tooltip-content1" style="display:none;" id="divToggle3">
													...
													<strong data-price="599000">599,000</strong><span>원</span>
												</dl>
											</div>
																					 <div class="box-btn">
																								<div class="box-cto">
...
<!-- 추가된 부분 -->
	    ...
	    <section class="component-bar" role="product_content_search">
	        <div class="component-bar-inner">
	            <div>
	                <div class="itm-title-text" id="goods-title-text">ASUS ProArt PA279CV 4K 인텍앤컴퍼니</div>
...
<div class="wrap-component feature-benefit pt-none pb-none w1440px img-bottom" >
	<div class="component-contents  pt-wide pb-none txt-mid-center txtm-top-center "  style="background-color=black " data-cptnm="">
		<div class="visual-area ">
			<img src="./../static/images/explain/PA279CV_1.png"" class="objGif">
			<img src="./../static/images/explain/PA279CV_2.png"" class="objGif">
			<img src="./../static/images/explain/PA279CV_3.png"" class="objGif">
			<img src="./../static/images/explain/PA279CV_4.png"" class="objGif">
			<img src="./../static/images/explain/PA279CV_5.png"" class="objGif">
			<img src="./../static/images/explain/PA279CV_6.png"" class="objGif">
			<img src="./../static/images/explain/PA279CV_7.png"" class="objGif">
			<img src="./../static/images/explain/PA279CV_8.png"" class="objGif">
		</div>
	</div>
</div>
...
<div class="spec-table-wrap"><h3 class="spec-itm-title" id="cstrt-nm">ASUS ProArt PA279CV 4K 인텍앤컴퍼니</h3>
...
<p class="spec-desc">614 x 370 x 60&nbsp;</p>
</li>
<li>
<strong class="spec-title">제품 무게(kg)</strong>
<p class="spec-desc">5.7 kg&nbsp;</p>
</li>
</ol>
</dd>
</dl>
...
<p class="spec-desc">모니터 본체, DP 케이블, 전원 어뎁터, 보증서, 색상 사전 보정 보고서, 설명서 &nbsp;</p>
</li>
<li>
						...
						-->
											...
											<div class="review-lt-keywordsbar">
												...
												try {
													...
													sql_keyword += "WHERE Mno='PA279CV' AND review_keyword LIKE '%G01%' UNION ALL ";
													sql_keyword += "SELECT 'G02' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='PA279CV' AND review_keyword LIKE '%G02%' UNION ALL ";
													sql_keyword += "SELECT 'G03' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='PA279CV' AND review_keyword LIKE '%G03%' UNION ALL ";
													sql_keyword += "SELECT 'G04' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='PA279CV' AND review_keyword LIKE '%G04%' UNION ALL ";
													sql_keyword += "SELECT 'G05' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='PA279CV' AND review_keyword LIKE '%G05%' UNION ALL ";
													sql_keyword += "SELECT 'G06' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='PA279CV' AND review_keyword LIKE '%G06%' UNION ALL ";
													sql_keyword += "SELECT 'G07' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='PA279CV' AND review_keyword LIKE '%G07%' UNION ALL ";
													sql_keyword += "SELECT 'G08' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='PA279CV' AND review_keyword LIKE '%G08%' UNION ALL ";
													sql_keyword += "SELECT 'G09' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='PA279CV' AND review_keyword LIKE '%G09%' UNION ALL ";
													sql_keyword += "SELECT 'G10' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='PA279CV' AND review_keyword LIKE '%G10%' UNION ALL ";
													sql_keyword += "SELECT 'G99' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='PA279CV' AND review_keyword LIKE '%G99%'";
									...
									<div class="review-content-body">
										...
										<div id="commentList">
											...
											<%
											// 작성된 리뷰 조회
											String sql_list = "SELECT * FROM review WHERE Mno='PA279CV'";
