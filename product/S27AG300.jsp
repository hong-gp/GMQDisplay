	...
	<div class="pd-Container" id="pd-inner-cont">
		<div class="pg-location ">
			<div class="pg-location-inner">
				...
				<a href="#">게임용 모니터</a>
				<a href="./../monitors.html?genre=rpg/sports/fighting">Rpg/Sports/Fights</a>
				<span>삼성전자 오디세이 G3 S27AG300</span>
			</div>
		</div>

		<section class="content" role="product_content_search">
			<div id="goods_detail_wrap" class="conbox" data-ctpath="/sec/" data-kakaokey="5880e4317936087f2764a5d340e6bca6" data-facebookid="" data-goods-id="S27AG300"
			data-goods-tp-cd="10" data-goods-Nm="삼성전자 오디세이 G3 S27AG300" data-admin-yn="" data-admin-price-yn="" data-task-id="" data-task-dtl-no="">

				<input type="hidden" name="returnUrl" value="./../static/images/product/S27AG300"/>
				<!-- s : 제품구매영역 -->
		...
		<div class="prod-image">
			<div class="prod-image-view">
				<div>
							<img src="./../static/images/product/S27AG300_1.png" alt="삼성전자 오디세이 G3 S27AG300 S27AG300정면" data-img-tp="10" data-seq="1">
				</div>
					<div>
							<img src="./../static/images/product/S27AG300_2.png" data-lazy="./../static/images/product/S27AG300_2.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 좌측 30도" data-img-tp="10" data-seq="2">
								</div>
					<div>
							<img src="./../static/images/product/S27AG300_3.png" data-lazy="./../static/images/product/S27AG300_3.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 우측 30도" data-img-tp="10" data-seq="3">
								</div>
					<div>
							<img src="./../static/images/product/S27AG300_4.png" data-lazy="./../static/images/product/S27AG300_4.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 모서리 디테일" data-img-tp="10" data-seq="4">
								</div>
					<div>
							<img src="./../static/images/product/S27AG300_5.png" data-lazy="./../static/images/product/S27AG300_5.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 피봇" data-img-tp="10" data-seq="5">
								</div>
					</div>
			<div class="prod-image-navi-wrap">
				<ol class="prod-image-navi">
					<li><span><a href="javascript:;"><img src="./../static/images/product/S27AG300_1.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 정면"></a></span></li>
						<li><span><a href="javascript:;"><img src="./../static/images/product/S27AG300_2.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 좌측 30도"></a></span></li>
						<li><span><a href="javascript:;"><img src="./../static/images/product/S27AG300_3.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 우측 30도"></a></span></li>
						<li><span><a href="javascript:;"><img src="./../static/images/product/S27AG300_4.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 모서리 디테일"></a></span></li>
						<li><span><a href="javascript:;"><img src="./../static/images/product/S27AG300_5.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 피봇"></a></span></li>
						</ol>
			</div>
			<div class="opt-btn">
				<!-- 이미지 삭제 및 em 태그 추가 -->
				<!-- 360도 보기 상태에서 확대보기를 클릭하면 btn360 에 act removeClass 해줘야 함. -->
				<span class="btn-bigView">
					<button type="button" class="btnBig" data-focus="dataFocus06"><!-- <img src="/sec/static/_images/common/icon_big-view.svg" alt="확대 이미지 보기"> --><em class="blind">확대 이미지 보기</em>
					</button>
				</span>
           	</div>
           </div>
		...
		$("#mySpriteSpin").spritespin({
              ...
              // 로딩시 자동 롤링
					...
					<script type="text/javascript">
						$(document).ready(function () {
							...
							if(!isReady){
								...
								//옵션 변경
								$(goodsMain.vGoodsWrapId).data("goods-id", "S27AG300");
							}
							...
							//비교하기 버튼 클래스 추가
							$(".link-compare-i").addClass(isCompareDataStorageGoods("S27AG300")?'disabled':'');
				...
				/* 			var goodsOrdTpCd = ""
						...
						<div class="itm-info-detail" id="itmInfoDetail" data-mdl-code="S27AG300" data-url-nm="monitors" data-fmy-grp-nm="gaming-ls27bg654ekxkr-d2c" data-goods-nm="삼성전자 오디세이 G3 S27AG300" data-sale-stat="12" data-mdl-nm="S27AG300" data-fmy-eng-nm="gaming-ls27bg654ekxkr-d2c" data-goods-id="G000277237" data-envmt-gb-cd="prd" data-fast-dlvr-yn="N">
...
function Urlsend(sns) {
    var thisUrl = "http://localhost:8080/GMQDisplay-master/product/S27AG300.jsp";
			...
			<button type="button" class="btn-sns-link" data-title="공유" data-content="" data-close="툴팁 닫기" id="toggle4">
				...
				<div class="btn-underline" style="display:none;" id="divToggle4">
					<ol class="share-tooltip-box">												
						...
						<button type="button" class="btn-good " title="">
							...
							<div>
							 ...
							 <div class="bookmarkTooltip flashTooltip bookmarkOff">
								...
								<div class="itm-sku b2c-itm-sku compare-box-align">S27AG300</div>
										...
										<div class="compare">
												<a href="javascript:void(0);" class="link-compare-i" onclick="readyCompare(this)" data-goods-id="S27AG300" data-mdl-code="S27AG300 " data-comp-disp-clsf-en-nm="monitors">
												비교하기
												</a>
											</div>
										...
										<div class="itm-rating-con">
											<div class="itm-rating b2c-itm-rating">
												...
												<a href="javascript:;" class="itm-review-count" title="상품평 보러가기">(0건)</a>
											</div>
							...
							<!-- 가격이 없을 경우 영역 노출 X -->
								<script>
									...
									<div class="itm-price itm-type">
										<div>
											<input type="hidden" id="originalPrice" value="362980">	                               		
											<input type="hidden" id="discountAmount" value="0">
											<input type="hidden" id="lastPrice" value="362980">
										...
										<dt>기준가
											 ...
											 <dd>
												...
												<dt>회원가</dt>
												<!-- 회원가 -->
												<dd><span class="discount" style="text-decoration-line: line-through">360,000</span>원</dd>
												</dl>
...
<form name="form" method="post" action="../buy/Buy.jsp">
	<input type="hidden" name="Mno" value="S27AG300" />
											...
											<div class="dropDown-content itm-eventInfo">
												<div id="membership-info">
													<a href="javascript:MemDisplay();" class="dropButton" id="membershipDropBtn">
														<span>GMQDisplay 멤버십 <strong id="membership-ptn-top">3529 포인트</strong> 적립</span>
														...
														<div class="dropcontent" id="TabMembership">
															<div class="casewrap point-nomember" style="display: block;" >
																<p class="emphasis-txt border-line">GMQ Display
																	<em class="case-blue membership-ptn"> 포인트 3529 (기본 0.1%)</em> 적립 예정
																</p>
										...
										<!-- 회원 할인 적용 예상가 -->
											...
											<a class="sp-custom-c1071-1 ins-banner" href="javascript:void(0);"><div class="ins-pd-inline-banner" style="margin-top:15px;"></div></a>
												...
												<div  class="tooltip-content1" style="display:none;" id="divToggle3">
													<p style="margin-top:10px;"><b>할인 금액</b> : 10,000원</p>
												</div>
												</dt>
													<strong data-price="352980">352,980</strong><span>원</span>
												</dl>
											</div>
																					 <div class="box-btn">
																								<div class="box-cto">
...
<!-- 추가된 부분 -->
	    ...
	    <section class="component-bar" role="product_content_search">
	        <div class="component-bar-inner">
	            <div>
	                <div class="itm-title-text" id="goods-title-text">삼성전자 오디세이 G3 S27AG300</div>
	                <nav id="anchor-navbar" class="anchor-navbar">
	                    <ul class="anchor-nav">
 	                    	<!--3rd 파티 상품은 특장점/상품평/유의사항만 노출 -->
	        				<li id="compGoodsPurBenefitLi" >
			                            <a data-scroll="compGoodsPurBenefit" href="javascript:void(0);" class="dot topNav active" id="itm-benefit-component">
		                    ...
		                    <li id="compGoodsNoticeInfoLi" >
	                            <a data-scroll="compGoodsNoticeInfo" href="javascript:void(0);" class="dot" id="compGoodsNoticeInfo">
...
<div class="wrap-component feature-full-bleed pt-none pb-none w1440px      ">
	<div class="component-contents  pt-none pb-none txt-mid-center txtm-top-center  "  style="background-color:#fff" data-cptnm="LS27AG320NKXKR-KV-211228">
		<div class="component-text">
			...
			<!-- s : visual type : image -->
			<img src="./../static/images/explain/S27AG300_0.jpg"" class="objGif">
        </div>
</div>
<!-- e : Feature full-bleed -->
<!-- s : Feature Benefit --> 
<div class="wrap-component feature-benefit pt-none pb-none w1440px img-bottom      ">
	<div class="component-contents  pt-wide pb-none txt-mid-center txtm-top-center "  style="background-color:#FFFFFF" data-cptnm="LS27AG320NKXKR-최대 사이즈로 채워지는 3면 슬림 베젤-211228">
		...
		<div class="component-text">
			<div class="component-text-inner">
				<div class="box-title">
					...
					<h2 class="title mo-ver lrg" style="color:#000000">최대 사이즈로 채워지는<br>3면 슬림 베젤</h2>
					
					<h2 class="title pc-ver lrg" style="color:#000000">최대 사이즈로 채워지는<br>3면 슬림 베젤</h2>
					
					
					
					<p class="desc mo-ver " style="color:#000000">더욱 크고 넓은 화면이 한눈에 펼쳐집니다.<br>모니터 끝까지 최대 사이즈의 화면으로 채워주는<br>3면 슬림 베젤 디자인 덕분이죠.<br>듀얼 모니터 설정으로 플레이 시<br>적들이 베젤 사이로 숨는 일도 줄어듭니다.</p>
					
					<p class="desc pc-ver " style="color:#000000">더욱 크고 넓은 화면이 한눈에 펼쳐집니다.<br>모니터 끝까지 최대 사이즈의 화면으로 채워주는 3면 슬림 베젤 디자인 덕분이죠.<br>듀얼 모니터 설정으로 플레이 시 적들이 베젤 사이로 숨는 일도 줄어듭니다.</p>
		...
		<div class="visual-area  ">
			...
			<!-- s : visual type : image -->
			<img src="https://images.samsung.com/kdp/cms_contents/125714/4eb21566-b146-483c-9155-d4b3435a8e9d.jpg?$FB_TYPE_A_MO_JPG$" alt="3면 슬림 베젤 모니터 2대를 붙여 놓은 이미지입니다." 
				class="obj-m objGif">
			<img src="https://images.samsung.com/kdp/cms_contents/125714/e7b00641-a734-45c4-9573-eed09a21ebe2.jpg?$FB_TYPE_A_JPG$" alt="3면 슬림 베젤 모니터 2대를 붙여 놓은 이미지입니다." 
				class="objGif">
...
<!-- s : Feature Benefit --> 
<div class="wrap-component feature-benefit pt-none pb-none w1440px img-bottom      ">
	<div class="component-contents  pt-wide pb-none txt-mid-center txtm-top-center "  style="background-color:#FFFFFF" data-cptnm="LS27AG320NKXKR-잔상 걱정 없이 즐기는 프로급 플레이-211228">
	
		<div class="component-text">
			<div class="component-text-inner">
				<div class="box-title">								
					<h2 class="title mo-ver lrg" style="color:#000000">잔상 걱정 없이 즐기는<br>프로급 플레이</h2>
					
					<h2 class="title pc-ver lrg" style="color:#000000">잔상 걱정 없이 즐기는<br>프로급 플레이</h2>	
						
					<p class="desc mo-ver " style="color:#000000">빠르게 움직이는 적을 놓치지 마세요.<br>165 Hz의 빠른 주사율은 잔상이 생기거나 느려지지 않고<br>장면 하나하나를 선명하게 보여줍니다.<br>긴박한 순간에도 끊김 걱정 없는 영상으로<br>상대의 움직임을 완벽히 읽을 수 있게 해주죠.</p>
					
					<p class="desc pc-ver " style="color:#000000">빠르게 움직이는 적을 놓치지 마세요.<br>165 Hz의 빠른 주사율은 잔상이 생기거나 느려지지 않고 장면 하나하나를 선명하게 보여줍니다.<br>긴박한 순간에도 끊김 걱정 없는 영상으로 상대의 움직임을 완벽히 읽을 수 있게 해주죠.</p>
			...
			<div class="visual-area  ">	
			<!-- 사진 -->
			<img src="./../static/images/explain/S27AG300_1.png"" class="objGif">	
		</div>
	</div>
...
<div class="wrap-component feature-benefit pt-none pb-none w1440px img-bottom      ">
	<div class="component-contents  pt-wide pb-none txt-mid-center txtm-top-center "  style="background-color:#FFFFFF" data-cptnm="">
		...
		<div class="component-text">
			<div class="component-text-inner">
				<div class="box-title">
					...
					<h2 class="title mo-ver lrg" style="color:#000000">상대를 제압하는<br>한 차원 빠른 속도</h2>
					
					<h2 class="title pc-ver lrg" style="color:#000000">상대를 제압하는<br>한 차원 빠른 속도</h2>
					
					
					
					<p class="desc mo-ver " style="color:#000000">치열한 전투의 현장에서 당당하게 캐리를 외칠 시간입니다.<br>입력과 거의 동시에 화면이 바뀌는 1 ms의 응답 속도는 당신의 컨트롤을 즉각적으로 화면에 반영해 줍니다.</p>
					
					<p class="desc pc-ver " style="color:#000000">치열한 전투의 현장에서 당당하게 캐리를 외칠 시간입니다.<br>입력과 거의 동시에 화면이 바뀌는 1 ms의 응답 속도는 당신의 컨트롤을 즉각적으로 화면에 반영해 줍니다.</p>
		...
		<div class="visual-area  ">
			...
			<!-- s : visual type : image -->
			<img src="https://images.samsung.com/kdp/cms_contents/125714/47b0c004-d17a-4404-9c82-0fc878aa338c.jpg?$FB_TYPE_A_MO_JPG$" alt="1 ms 빠른 응답 속도를 비교하는 이미지입니다." 
				class="obj-m objGif">
			<img src="https://images.samsung.com/kdp/cms_contents/125714/8620dd0b-f90c-498c-9816-0b843f041632.jpg?$FB_TYPE_A_JPG$" alt="1 ms 빠른 응답 속도를 비교하는 이미지입니다." 
				class="objGif">
...
<!-- s : Feature Benefit --> 
<div class="wrap-component feature-benefit pt-none pb-none w1440px img-bottom      ">
	<div class="component-contents  pt-wide pb-none txt-mid-center txtm-top-center "  style="background-color:#FFFFFF" data-cptnm="LS27AG320NKXKR-편안한 눈으로 즐기는 승리의 시간-211228">
		...
		<div class="component-text">
			<div class="component-text-inner">
				<div class="box-title">
					...
					<h2 class="title mo-ver lrg" style="color:#000000">편안한 눈으로 즐기는<br>승리의 시간</h2>
					
					<h2 class="title pc-ver lrg" style="color:#000000">편안한 눈으로 즐기는<br>승리의 시간</h2>
					
					
					
					<p class="desc mo-ver " style="color:#000000">켠 김에 랭크 업까지, 더욱 편안한 눈으로 클리어하세요.<br>블루라이트를 줄이는 눈 보호 모드,<br>자극적인 화면 깜박임을 최소화하는 플리커 프리 기술로<br>눈의 피로를 적게 하여 더 오래 집중할 수 있습니다.</p>
					
					<p class="desc pc-ver " style="color:#000000">켠 김에 랭크 업까지, 더욱 편안한 눈으로 클리어하세요.<br>블루라이트를 줄이는 눈 보호 모드, 자극적인 화면 깜박임을 최소화하는 플리커 프리 기술로<br>눈의 피로를 적게 하여 더 오래 집중할 수 있습니다.</p>
					
				</div>
				<div class="box-disc">
					<p class="disc mo-ver" style="color:#363636">* TÜV Rheinland의 Flicker Free 인증을 받았습니다.<br></p> 
					<p class="disc pc-ver" style="color:#363636">* TÜV Rheinland의 Flicker Free 인증을 받았습니다.<br></p>
				</div>
			</div>
		</div>
		<div class="visual-area  ">
			...
			<!-- s : visual type : image -->
			<img src="https://images.samsung.com/kdp/cms_contents/125714/e347340b-12b9-4c03-a434-4a66d702ac18.jpg?$FB_TYPE_A_MO_JPG$" alt="눈 보호 모드와 플리커 프리 기술로 화면 깜빡임과 블루라이트를 없애주는 연출 이미지입니다." 
				class="obj-m objGif">
			<img src="https://images.samsung.com/kdp/cms_contents/125714/0bf1df40-2c42-4f6a-9b20-dddcef8646f8.jpg?$FB_TYPE_A_JPG$" alt="눈 보호 모드와 플리커 프리 기술로 화면 깜빡임과 블루라이트를 없애주는 연출 이미지입니다." 
				class="objGif">
...
<div class="wrap-component feature-benefit pt-none pb-none w1440px img-bottom      ">
	<div class="component-contents  pt-wide pb-none txt-mid-center txtm-top-center "  style="background-color:#FFFFFF" data-cptnm="">
		...
		<div class="component-text">
			<div class="component-text-inner">
				<div class="box-title">
					...
					<h2 class="title mo-ver lrg" style="color:#000000">완벽한 수준의 싱크로<br>몰입감 넘치는 게임</h2>
					
					<h2 class="title pc-ver lrg" style="color:#000000">완벽한 수준의 싱크로<br>몰입감 넘치는 게임</h2>
					
					
					
					<p class="desc mo-ver " style="color:#000000">끊김 걱정 없는 영상으로 게임에 더욱 몰입하세요.<br>AMD FreeSync Premium의 적응형 동기화 기술은<br>화면 찢어짐과 깜박임, 입력 지연을 줄여주며<br>고사양 구간에서 프레임이 낮아지는 장면까지<br>부드럽게 재생합니다.</p>
					
					<p class="desc pc-ver " style="color:#000000">끊김 걱정 없는 영상으로 게임에 더욱 몰입하세요.<br>AMD FreeSync Premium의 적응형 동기화 기술은 화면 찢어짐과 깜박임, 입력 지연을 줄여주며<br>고사양 구간에서 프레임이 낮아지는 장면까지 부드럽게 재생합니다.</p>
		...
		<div class="visual-area  ">
			...
			<!-- s : visual type : image -->
			<img src="https://images.samsung.com/kdp/cms_contents/125714/838435d0-8015-4423-b22e-712b0144677d.jpg?$FB_TYPE_A_MO_JPG$" alt="ADM FrereSync Premium 기술로 빠른 액션 장면도 매끄럽게 감상할 수 있습니다." 
				class="obj-m objGif">
			<img src="https://images.samsung.com/kdp/cms_contents/125714/c380ee13-05e6-4270-aebf-bfa6e44eb9f8.jpg?$FB_TYPE_A_JPG$" alt="ADM FrereSync Premium 기술로 빠른 액션 장면도 매끄럽게 감상할 수 있습니다." 
				class="objGif">
...
<!-- s : Feature Benefit --> 
<div class="wrap-component feature-benefit pt-none pb-none w1440px img-bottom      ">
	<div class="component-contents  pt-wide pb-none txt-mid-center txtm-top-center "  style="background-color:#FFFFFF" data-cptnm="LS27AG320NKXKR-당신과 게임을 위한 맞춤 디자인-211228">
		...
		<div class="component-text">
			<div class="component-text-inner">
				<div class="box-title">
					...
					<p class="desc mo-ver " style="color:#000000">승리를 위한 최상의 눈높이를 찾아보세요.<br>완벽한 시야를 찾을 때까지<br>모니터를 회전하거나 기울여 조정하여<br>게임을 더 편안하게 즐길 수 있죠.</p>
					
					<p class="desc pc-ver " style="color:#000000">승리를 위한 최상의 눈높이를 찾아보세요.<br>완벽한 시야를 찾을 때까지 모니터를 회전하거나 기울여 조정하여 게임을 더 편안하게 즐길 수 있죠.</p>
		...
		<div class="visual-area  ">
			...
			<!-- s : visual type : image -->
			<img src="https://images.samsung.com/kdp/cms_contents/214756/6b64b8fa-3bf9-43d9-90da-4ef6548fb5d0.jpg?$FB_TYPE_A_MO_JPG$" alt="높낮이 조절, 상하 각도 조절, 회전, 가로/세로 모드가 가능한 것을 나타내는 이미지입니다." 
				class="obj-m objGif">
			<img src="https://images.samsung.com/kdp/cms_contents/214756/9d51755c-1b77-4be9-9804-8bfd540e3b4c.jpg?$FB_TYPE_A_JPG$" alt="높낮이 조절, 상하 각도 조절, 회전, 가로/세로 모드가 가능한 것을 나타내는 이미지입니다." 
				class="objGif">
...
<div class="spec-table-wrap"><h3 class="spec-itm-title" id="cstrt-nm">삼성전자 오디세이 G3 S27AG300	</h3>
...
<li>
<strong class="spec-title">디스플레이영역 (W x H) (mm)</strong>
...
<li>
<strong class="spec-title">밝기 (Brightness)</strong>
<p class="spec-desc">250&nbsp;cd/㎡</p>
</li>
<li>
<strong class="spec-title">명암비</strong>
<p class="spec-desc">2,500:1&nbsp;</p>
</li>
<li>
...
<li>
<strong class="spec-title">색재현성(Color Gamut, DCI Coverage)</strong>
...
<ol>
<li>
<strong class="spec-title">에코 세이빙 플러스</strong>
...
<p class="spec-desc">FreeSync Premium&nbsp;</p>
</li>
</ol>
</dd>
</dl>
...
<p class="spec-desc">HAS&nbsp;</p>
</li>
<li>
<strong class="spec-title">HAS(Height Adjustable Stand)</strong>
<p class="spec-desc">120.0 ± 5.0&nbsp;</p>
</li>
<li>
<strong class="spec-title">틸트</strong>
<p class="spec-desc">-5.0º(± 2°) ~ +20.0º(± 2°)&nbsp;</p>
</li>
<li>
<strong class="spec-title">스위블</strong>
<p class="spec-desc">-15.0º(± 2°) ~ +15.0º(± 2°)&nbsp;</p>
</li>
<li>
<strong class="spec-title">피봇</strong>
<p class="spec-desc">-2.0º(± 2°) ~ +92.0º(± 2°)&nbsp;</p>
</li>
<li>
...
<li>
<strong class="spec-title">정격 입력</strong>
<p class="spec-desc">AC100~240V&nbsp;</p>
</li>
<li>
<strong class="spec-title">소비 전력(MAX)</strong>
<p class="spec-desc">27W&nbsp;</p>
</li>
</ol>
</dd>
</dl>
...
<p class="spec-desc">618.2 x 520.5 x 218.9&nbsp;mm</p>
</li>
<li>
<strong class="spec-title">스탠드제외(가로x높이x깊이)</strong>
<p class="spec-desc">618.2 x 377.2 x 77.5&nbsp;mm</p>
</li>
</ol>
</dd>
</dl>
...
<p class="spec-desc">5.3&nbsp;kg</p>
</li>
<li>
<strong class="spec-title">제품 무게 (스탠드 제외)</strong>
<p class="spec-desc">3.8&nbsp;kg</p>
</li>
</ol>
</dd>
</dl>
...
<p class="spec-desc">중국</p>
</li>
<li>
<strong class="spec-title">KC 인증 필 유무</strong>
<p class="spec-desc"><img src="//images.samsung.com/is/image/samsung/p5/sec/common/icon-kc.png?$ORIGIN_PNG$" alt="KC 인증 로고">R-R-SEC-S27AG300N</p>
</li>
<li>
<strong class="spec-title">동일모델의 출시년월</strong>
<p class="spec-desc">2021년 6월</p>
</li>
<li>
...
<p class="spec-desc">결함·하자 등에 따른 소비자 피해에 대해서는 소비자분쟁해결기준(소비자기본법 제16조)에 따라 보상 가능</p>
</li>
</ol>
</dd>
</dl>
						...
						-->
											...
											<div class="review-lt-keywordsbar">
												...
												try {
													...
													sql_keyword += "WHERE Mno='S27AG300' AND review_keyword LIKE '%G01%' UNION ALL ";
													sql_keyword += "SELECT 'G02' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='S27AG300' AND review_keyword LIKE '%G02%' UNION ALL ";
													sql_keyword += "SELECT 'G03' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='S27AG300' AND review_keyword LIKE '%G03%' UNION ALL ";
													sql_keyword += "SELECT 'G04' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='S27AG300' AND review_keyword LIKE '%G04%' UNION ALL ";
													sql_keyword += "SELECT 'G05' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='S27AG300' AND review_keyword LIKE '%G05%' UNION ALL ";
													sql_keyword += "SELECT 'G06' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='S27AG300' AND review_keyword LIKE '%G06%' UNION ALL ";
													sql_keyword += "SELECT 'G07' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='S27AG300' AND review_keyword LIKE '%G07%' UNION ALL ";
													sql_keyword += "SELECT 'G08' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='S27AG300' AND review_keyword LIKE '%G08%' UNION ALL ";
													sql_keyword += "SELECT 'G09' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='S27AG300' AND review_keyword LIKE '%G09%' UNION ALL ";
													sql_keyword += "SELECT 'G10' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='S27AG300' AND review_keyword LIKE '%G10%' UNION ALL ";
													sql_keyword += "SELECT 'G99' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='S27AG300' AND review_keyword LIKE '%G99%'";
									...
									<div class="review-content-body">
										...
										<div id="commentList">
											...
											<%
											// 작성된 리뷰 조회
											String sql_list = "SELECT * FROM review WHERE Mno='S27AG300'";
			...
			<div class="clause-links">
				...
				<div id="dropClauseList02" class="wrap-droplist rounded  clause-private">
					...
					<ul class="droplist" tabindex="-1" aria-labelledby="dropServicePrivateTitle" aria-activedescendant="optServicePrivate01">
						<!--aria-activedescendant에 선택된 li의 id 삽입-->
						<li id="optServicePrivate02" class="droplist-item"><a href="./../person.html">GMQD 개인정보처리방침</a></li>
