	...
	<div id="wrap">
		...
		$.ajax({
			...
			function setLogoutGnbMenu() {
				if (device.agent.indexOf("mobi") >= 0 || device.isGnb === false) {
					...
					htmlMoLoginBefore += '<a href="" onclick="NetFunnel_Action({action_id:\'b2c_gnb_login\'},\'/member/indexLogin/?returnUrl=/monitors/gaming-monitors/\');return false;\" data-omni=\'login\'>로그인</a></li>';
					htmlMoLoginBefore += '';
					htmlMoLoginBefore += '<li class="mob-onlyMenu-join">';
					htmlMoLoginBefore += '<a href="" onclick="NetFunnel_Action({action_id:\'b2c_gnb_login\'},\'/member/signUp/?returnUrl=/monitors/gaming-monitors/\');return false;\" data-omni=\"sign up\">회원가입</a></li>';
					htmlMoLoginBefore += '';
		...
		<header id="header">
			<div class="s-inner">
				<a href="../index.html" class="logo">
					<img src="../static/images/common/logo_gmqd_black.png" alt="GMQD 엄선">
				</a>
				<div class="new-gnb">
															...
															<a href="javascript:void(0);" onclick="openCtaLink('', '');"
																...
																<span class="pic-wrap">
																	<span class="pc-pic lozad"
																		data-background-image="//images.samsung.com/kdp/display/gnb/282e14da-b85a-4c42-b774-10baabfe7860.jpg?$ORIGIN_JPG$"></span>
																...
																<span class="txt-grp">
																	<span class="tit theme-blk">게이밍 모니터 울트라 4K <br> 최초
																		런칭 딜타임 </span>
																	<span class="desc theme-blk">즉시 할인 8% + <br>카드사별 6만원
																		결제일할인</span>
																</span>
															</a>
														</div>
														<div class="sub-prd num-1">
															<a href="javascript:void(0);" onclick="openCtaLink('', '');"
																...
																<span class="txt-grp">
																	...
																	<span class="desc theme-blk">강력한 성능의 GMQD 북3<br>카드사별
																		최대 19만원 결제일할인! </span>
																</span>
															</a>
														</div>
														<div class="sub-prd num-2">
															<a href="javascript:void(0);" onclick="openCtaLink('', '');"
																...
																<span class="txt-grp">
																	...
																	<span class="desc theme-blk">초고화질·초대형 TV의 기준<br>런칭
																		기념 특별한 혜택!</span>
																</span>
															</a>
														</div>
														<div class="sub-prd num-3">
															<a href="javascript:void(0);" onclick="openCtaLink('', '');"
																...
																<span class="txt-grp">
																	...
																	<span class="desc theme-blk">최대 41% 할인 쿠폰 포함<br>최대
																		243만원 상당 혜택</span>
																</span>
															</a>
														</div>
														<div class="sub-prd num-4">
															<a href="javascript:void(0);" onclick="openCtaLink('', '');"
																...
																<span class="txt-grp">
																	...
																	<span class="desc theme-blk">지금 체험단 참여하면<br>최대 67만원
																		상당의 혜택이!</span>
																</span>
															</a>
														</div>
														<div class="sub-prd num-5">
															<a href="javascript:void(0);" onclick="openCtaLink('', '');"
																...
																<span class="txt-grp">
																	...
																	<span class="desc theme-blk">지금 체험단 참여하면<br>최대 35%
																		할인 혜택을!</span>
																</span>
															</a>
														</div>
														<div class="sub-prd num-6">
															<a href="javascript:void(0);" onclick="openCtaLink('', '');"
																...
																<span class="txt-grp">
																	...
																	<span class="desc theme-blk">가전제품 전문세척 | 이전설치 +
											...
											<li class="">
												...
												<div class="gnb3depth ">
																...
																<ul>
																	<li class="">
																		<a href="javascript:void(0);"
																			onclick="openCtaLink('', '');"
																			aria-selected="false"
																			data-omni="Product:mobile:smartphones:smartphones recommendation">인기
																			상품</a>
																	</li>
																	<li class="">
																		<a href="javascript:void(0);"
																			onclick="openCtaLink('', '');"
																			aria-selected="false"
																			data-omni="Product:mobile:smartphones:all-smartphones">전체
																			상품</a>
																	</li>
																	<li class="">
																		<a href="javascript:void(0);"
																			onclick="openCtaLink('', '');"
																			aria-selected="false"
																			data-omni="Product:mobile:smartphones:mobile accessories">추천
																			상품</a>
																	</li>
																</ul>
															</div>
																...
																<ul>
																	<li class="">
																		<a href="javascript:void(0);"
																			onclick="openCtaLink('', '');"
																			aria-selected="false"
																			data-omni="Product:mobile:GMQD Book:Recommended GMQD Book">인기
																			상품</a>
																	</li>
																	<li class="">
																		<a href="javascript:void(0);"
																			onclick="openCtaLink('', '');"
																			aria-selected="false"
																			data-omni="Product:mobile:GMQD Book:All GMQD Book">전체
																			상품</a>
																	</li>
																	<li class="">
																		<a href="javascript:void(0);"
																			onclick="openCtaLink('', '');"
																			aria-selected="false"
																			data-omni="Product:mobile:GMQD Book:galaxybook-ultra">추천
																			상품</a>
																	</li>
															</div>
														</li>
													...
													<div class="gnbBanner type2">
														<a href="javascript:void(0);" onclick="openCtaLink('', '');"
															data-omni="feature image:Product::learn more">
															<div class="img">
																<img src="/static/images/menu/menu01.jpg"
																	alt="2023 Neo QLED I OLED 사전판매 체험단" class="lozad">
															</div>
												...
												<div class="gnb3depth ">
													...
													<div class="gnbBanner type2">
														<a href="javascript:void(0);" onclick="openCtaLink('', '');"
															...
															<div class="img">
																<img src="/static/images/menu/menu01.jpg"
																	alt="GMQD Book3 Series 런칭" class="lozad">
															</div>
															<p class="txt">GMQD Book3 Series 런칭</p>
														</a>
														<div class="link-box flex--center">
															<a href="javascript:void(0);" onclick="openCtaLink('', '');"
																data-omni="feature image:Product:Buying benefit:learn more"
																class="link">
																<span>구매 혜택 보기</span>
															</a>
														</div>
				...
				<div class="header-right gnbMenu">
					<ul>
									...
									<div>
										...
										<div class="btn-box">
											<button type="button" class="btn btn-d btn-type2"
												onclick="NetFunnel_Action({action_id :'b2c_cart_view'},function(ev, ret){location.href='/cart/';});"
						...
						<li>
							...
							<a href="javascript:void(0);" aria-controls="login-menu" aria-selected="false"
		...
		<div class="toast-pop induce-ss-app toast-parent" data-toast-name="toastInduce" data-focus="toastInduce"
			...
			<div class="inner">
				...
				<p>앱 다운받고,<br>GMQDisplay닷컴만의 특별한 혜택을 만나보세요!</p>
		...
		<div class="toast-pop child-pops-form" data-toast-name="toastChild01" data-focus="toastChild01"
			...
			<div class="inner">
				...
				<div class="text-wrap">
					<p>GMQDisplay닷컴 앱 전용 할인 쿠폰이 기다리고 있어요!</p>
		...
		<div id="container" class=''>
			...
			<script type="text/javascript">
				...
				//s : 2021-01-08 접근성 - 아코디언 상태 정보 추가
				$(document).ready(function () {
					if ('80' == '10' && '1' == '122') {
						isGcsLogin();
					}
...
// e : 2021-01-08 접근성 - 아코디언 상태 정보 추가
			</script>
			...
			<div class="pd-Container" id="pd-inner-cont">
				<div class="pg-location ">
					<div class="pg-location-inner">
						...
						<a href="#">게이밍 모니터</a>
						<a href="#">게임용 모니터</a>
						<a href="./../all-monitors.html">FPS/RTS</a>
						<span>삼성전자 오디세이 G3 S27AG300</span>
					</div>
				</div>

				<section class="content" role="product_content_search">
					<div id="goods_detail_wrap" class="conbox" data-ctpath="/sec/"
						data-kakaokey="5880e4317936087f2764a5d340e6bca6" data-facebookid="" data-goods-id="G000253836"
						data-goods-tp-cd="10" data-goods-Nm="삼성전자 오디세이 G3 S27AG300" data-admin-yn=""
						data-admin-price-yn="" data-task-id="" data-task-dtl-no="">

						<input type="hidden" name="returnUrl"
							value="/sec/monitors/gaming-ls24ag320nkxkr-d2c/LS24AG320NKXKR/" />
						<!-- s : 제품구매영역 -->
						<div class="itm-buy-area" data-sticky-container>
								...
								<div id="slickView">
									<div class="prod-image">
										<div class="prod-image-view">
											<div>
												<img src="./../static/images/product/S27AG300_1.png"
													alt="삼성전자 오디세이 G3 S27AG300 정면" data-img-tp="10" data-seq="1">
											</div>
											<div>
												<img src="../../../static/_images/common/pd_gallery_default_visual.png"
													data-lazy="//images.samsung.com/kdp/goods/2022/01/06/c716cc78-f936-4666-866d-c85af0e74a94.png?$PD_GALLERY_L_PNG$"
													alt="오디세이 게이밍 모니터 60.4 cm 블랙 좌측 30도" data-img-tp="10" data-seq="2">
											</div>
											<div>
												<img src="../../../static/_images/common/pd_gallery_default_visual.png"
													data-lazy="//images.samsung.com/kdp/goods/2022/01/06/2e48f9d9-8f84-4ac2-90a5-47b8e5e617dc.png?$PD_GALLERY_L_PNG$"
													alt="오디세이 게이밍 모니터 60.4 cm 블랙 우측 30도" data-img-tp="10" data-seq="3">
											</div>
											<div>
												<img src="../../../static/_images/common/pd_gallery_default_visual.png"
													data-lazy="//images.samsung.com/kdp/goods/2022/01/06/0576ab22-ff8c-411a-96b2-7635dad27d52.png?$PD_GALLERY_L_PNG$"
													alt="오디세이 게이밍 모니터 60.4 cm 블랙 모서리 디테일" data-img-tp="10" data-seq="4">
											</div>
											<div>
												<img src="../../../static/_images/common/pd_gallery_default_visual.png"
													data-lazy="//images.samsung.com/kdp/goods/2022/01/06/f465b7be-f32f-4e74-853a-0196d2ca25ad.png?$PD_GALLERY_L_PNG$"
													alt="오디세이 게이밍 모니터 60.4 cm 블랙 피봇" data-img-tp="10" data-seq="5">
											</div>
											<div>
												<img src="../../../static/_images/common/pd_gallery_default_visual.png"
													data-lazy="//images.samsung.com/kdp/goods/2022/01/06/e38baf07-f5b5-481b-9031-079fa462e686.png?$PD_GALLERY_L_PNG$"
													alt="오디세이 게이밍 모니터 60.4 cm 블랙 틸트" data-img-tp="10" data-seq="6">
											</div>
											<div>
												<img src="../../../static/_images/common/pd_gallery_default_visual.png"
													data-lazy="//images.samsung.com/kdp/goods/2022/01/06/739356cf-bf56-49f9-9472-28f978d3a48f.png?$PD_GALLERY_L_PNG$"
													alt="위에서 본 오디세이 게이밍 모니터 60.4 cm 블랙 " data-img-tp="10" data-seq="7">
											</div>
											<div>
												<img src="../../../static/_images/common/pd_gallery_default_visual.png"
													data-lazy="//images.samsung.com/kdp/goods/2022/01/06/52a134f2-8d52-4db4-a092-78b49c29df76.png?$PD_GALLERY_L_PNG$"
													alt="오디세이 게이밍 모니터 60.4 cm 블랙 후면" data-img-tp="10" data-seq="8">
											</div>
										</div>
										<div class="prod-image-navi-wrap">
											<ol class="prod-image-navi">
												<li><span><a href="javascript:;"><img
																src="./../static/images/product/S27AG300_1.png"
																alt="오디세이 게이밍 모니터 60.4 cm 블랙 정면"></a></span></li>
												<li><span><a href="javascript:;"><img
																src="https://images.samsung.com/kdp/goods/2022/01/06/c716cc78-f936-4666-866d-c85af0e74a94.png?$128_128_PNG$"
																alt="오디세이 게이밍 모니터 60.4 cm 블랙 좌측 30도"></a></span></li>
												<li><span><a href="javascript:;"><img
																src="https://images.samsung.com/kdp/goods/2022/01/06/2e48f9d9-8f84-4ac2-90a5-47b8e5e617dc.png?$128_128_PNG$"
																alt="오디세이 게이밍 모니터 60.4 cm 블랙 우측 30도"></a></span></li>
												<li><span><a href="javascript:;"><img
																src="https://images.samsung.com/kdp/goods/2022/01/06/0576ab22-ff8c-411a-96b2-7635dad27d52.png?$128_128_PNG$"
																alt="오디세이 게이밍 모니터 60.4 cm 블랙 모서리 디테일"></a></span></li>
												<li><span><a href="javascript:;"><img
																src="https://images.samsung.com/kdp/goods/2022/01/06/f465b7be-f32f-4e74-853a-0196d2ca25ad.png?$128_128_PNG$"
																alt="오디세이 게이밍 모니터 60.4 cm 블랙 피봇"></a></span></li>
												<li><span><a href="javascript:;"><img
																src="https://images.samsung.com/kdp/goods/2022/01/06/e38baf07-f5b5-481b-9031-079fa462e686.png?$128_128_PNG$"
																alt="오디세이 게이밍 모니터 60.4 cm 블랙 틸트"></a></span></li>
												<li><span><a href="javascript:;"><img
																src="https://images.samsung.com/kdp/goods/2022/01/06/739356cf-bf56-49f9-9472-28f978d3a48f.png?$128_128_PNG$"
																alt="위에서 본 오디세이 게이밍 모니터 60.4 cm 블랙 "></a></span></li>
												<li><span><a href="javascript:;"><img
																src="https://images.samsung.com/kdp/goods/2022/01/06/52a134f2-8d52-4db4-a092-78b49c29df76.png?$128_128_PNG$"
																alt="오디세이 게이밍 모니터 60.4 cm 블랙 후면"></a></span></li>
											</ol>
										</div>
										<div class="opt-btn">
							...
							<div class="itm-information">
								...
								<script type="text/javascript">
									$(document).ready(function () {
										...
										if (!isReady) {
											...
											//옵션 변경
											$(goodsMain.vGoodsWrapId).data("goods-id", "G000277237");
										}
										...
										//비교하기 버튼 클래스 추가
										$(".link-compare-i").addClass(isCompareDataStorageGoods("G000277237") ? 'disabled' : '');
								...
								<div class="itm-info-detail" id="itmInfoDetail" data-mdl-code="S27AG300"
									data-url-nm="monitors" data-fmy-grp-nm="gaming-ls27bg654ekxkr-d2c"
									data-goods-nm="삼성전자 오디세이 G3 S27AG300" data-sale-stat="12" data-mdl-nm="S27AG300"
									data-fmy-eng-nm="gaming-ls27bg654ekxkr-d2c" data-goods-id="G000277237"
									data-envmt-gb-cd="prd" data-fast-dlvr-yn="N">
									...
									<input type="hidden" name="goodsNm" id="goodsNm" value="삼성전자 오디세이 G3 S27AG300">
									<input type="hidden" name="mdlCode" id="mdlCode" value="S27AG300">
									...
									<input type="hidden" id="imgPath"
										value="//images.samsung.com/kdp/goods/2022/09/30/31cf773c-3852-4816-85a6-ddb0bc2bf78b.png">
									...
									<div class="itm-info-head">
										...
										<div class="social-box">
											<button type="button" class="btn-sns-link" data-title="공유" data-content=""
												data-close="툴팁 닫기"><i class="icon ico-large ico-share">소셜공유</i></button>
											...
											<button type="button" class="btn-good " title=""><i
										...
										<h1 class="itm-info-title" id="goodsDetailNm">삼성전자 오디세이 G3 S27AG300</h1>
										<div class="itm-sku b2c-itm-sku compare-box-align">S27AG300</div>
										<!-- B2C, 패넷, 패넷 디플 PD페이지 비교하기 버튼 추가 s -->
										<div class="compare">
											<a href="javascript:void(0);" class="link-compare-i"
												onclick="readyCompare(this)" data-goods-id="G000277237"
												data-mdl-code="S27AG300 " data-comp-disp-clsf-en-nm="monitors">
												비교하기
											</a>
										</div>
										...
										<div class="itm-rating-con">
											<div class="itm-rating b2c-itm-rating">
												<div class="itm-sart-rating" role="img" aria-label="별점 0.0점">
													<!-- 
												...
												<a href="javascript:;" class="itm-review-count"
													title="상품평 보러가기">(0건)</a>
											</div>
											<div class="itm-rating itm-review">
												<span class="itm-review-write"><a href="javascript:void(0);"
														class="btn-underline" title="상품평 쓰기 바로가기">상품평 쓰기</a></span>
											</div>
									...
									<div class="itm-price itm-type">
										...
										<div>
											<input type="hidden" id="originalPrice" value="720000">
											<input type="hidden" id="discountAmount" value="0">
											<input type="hidden" id="lastPrice" value="720000">
											<dl class="event-price">
												<dt>
													기준가<button type="button" class="btn-tooltop02 price-tooltip"
														data-title="기준가 안내" data-content="" data-close="툴팁 닫기"
														data-width="360"><span>기준가 안내 보기</span></button>
													<div class="tooltip-content" style="display:none;">
														<p>판매가는 <strong>GMQDisplay닷컴에만 적용</strong>됩니다.</p>
													</div>
												</dt>

												<dd>
													<span data-price="362980" class="pd-total-price">362,980</span>원
												</dd>
											</dl>
											<script type="text/javascript">
												if ('362980' == '0') {
											...
											<!-- 최적 일반 쿠폰 -->
											<input type="hidden" id="BaseCpAmt" data-cpamt="21000" data-multiaplyn="N"
												data-cpno="23500" data-apl-strt-dtm="2023-03-31 23:59:59.0"
												data-apl-end-dtm="2023-03-31 23:59:59.0">
											...
											<dl class="event-price">
												...
												<!-- 웹쿠폰 할인가격(앱쿠폰 제외) -->
												<dd><span class="discount"
														style="text-decoration-line: line-through">360,000</span>원</dd>
											</dl>
											<dl class="expected-price">
												<dt>
													회원 할인가
													<button type="button" class="btn-tooltop02 price-tooltip"
														data-title="쿠폰 적용 예상가 안내" data-content="couponDiscountPrice"
														data-close="툴팁 닫기" data-width="500"><span>쿠폰 적용 예상가 툴팁보기(레이어
															열림)</span></button>
												</dt>
												<!-- s : 220920 : 쿠폰 할인가 툴팁 -->
												<div class="tooltip-content" style="display: none;">
													<p>
														해당 상품에 즉시 할인이 적용되어 있으며,<br>
														쿠폰 적용 예상가는 로그인 시 결제 가능한 금액입니다.<br><br>

														회원인 경우 쿠폰을 다운 받은 후 장바구니 또는 주문/결제<br>
														페이지에서 쿠폰 적용을 하면 쿠폰 적용 예상가로 구매 할 수<br>
														있으며, 쿠폰 적용 예상가는 <strong>GMQDisplay닷컴에만 적용</strong>됩니다.<br><br>

														앱 쿠폰은 갤럭시 스토어에서 GMQDisplay닷컴 앱 설치 후 사용 가능합니다.<br>
														쿠폰 할인 상세 정보는 제품 1개 구매 기준이며, 구매 수량에 따라 변경될 수 있습니다.<br><br>

														<span class="bold">쿠폰 할인 상세 정보</span>
														- 할인금액(율) : <strong>
															<!-- 웹쿠폰 할인가격(앱쿠폰 제외) -->
															21,000원
														</strong><br>
														- 유효기간 : <strong>2023.03.01 ~ 2023.03.31</strong>
													</p>
												</div>
												<!-- e : 220920 : 쿠폰 할인가 툴팁 -->
												<!-- 웹쿠폰 할인가격(앱쿠폰 제외) -->
												<dd><span> 352,980</span>원</dd>
											</dl>
											<!-- e : 220920 kdp60추가 -->
										</div>
									</div>
										...
										<dl>
											...
											<dd>
												<div class="dropOption" id="dropOption-1001-1">
													<span class="itm-color-object" style="background-color:#000000;"
														data-omni="color_블랙">블랙</span>
										...
										<dl class="count-show-box">
											...
											<dd>
												<span class="spinner-box pd-spinner goods-count">
													<a href="javascript:void(0);" class="count count-miner"
														id="pd-goods-count-miner">감소</a>
													<label for="countPrd" class="blind">구매수량</label><input type="text"
														class="number count-prd" id="countPrd" value="1"
														data-max-qty="5" data-min-ord-qty="">
													<a href="javascript:void(0);" class="count count-plus"
														id="pd-goods-count-plus">증가</a>
												</span>
											</dd>
										</dl>
										<!-- 2022.11.09 소상공인몰 매장픽업Only일때 수량 노출 시작-->
										<!-- 2022.11.09 소상공인몰 매장픽업Only일때 수량 노출 끝-->
									</div>
									<!-- e : 제품 옵션 -->


									<!-- s : 22-07-19 Samsung Care+ -->
									<!-- e : 22-07-19 Samsung Care+ -->
									...
									<div class="dropDown-content itm-eventInfo">
										...
										<div id="membership-info">
											<a href="javascript:void(0);" class="dropButton" id="membershipDropBtn">
												<span>GMQDisplay 멤버십 <strong id="membership-ptn-top">3529 포인트</strong>
													적립</span>
												<span class="blind">닫힘</span></a>
											<div class="dropcontent">
												<div class="casewrap point-nomember">
													<p class="emphasis-txt border-line">GMQDisplay
														<em class="case-blue membership-ptn"> 포인트 3529 (기본 0.1%)</em> 적립
														예정
													</p>
													<p class="assi-txt">GMQDisplay 포인트는 GMQDisplay계정의 '국가 또는 지역' 정보가
														<br>대한민국인 고객님만 적립 및 사용 가능합니다.
													</p>
													<!-- 패밀리넷, 디스플레이인 경우 노출 제한 -->
													<div class="center-link">
														<a href="https://account.samsung.com" target="_blank"
															class="btn-underline">내 계정정보 확인하기</a>
													</div>
													<p class="assi-txt">적립 예정 포인트는 멤버십 회원 상태와 등급별 최대 적립 <br>한도에 따라 실제 적립
														포인트와 상이할 수 있습니다.</p>
													<div>
														<ul class="detail-view">
															<li>
																<span>GMQDisplay 멤버십 등급혜택</span>
																<a href="https://www.samsung.com/sec/membership/membershipLevel/"
																	target="_blank" class="btn-underline">자세히 보기</a>
															</li>
															<li>
																<span>GMQDisplay 포인트 적립혜택</span>
																<a href="https://www.samsung.com/sec/membership/membershipPoint/"
																	target="_blank" class="btn-underline">자세히 보기</a>
															</li>
														</ul>
													</div>
												</div>
												<div class="casewrap point-member" style="display:none">
													<p class="emphasis-txt">고객님의 등급, 적립한도를 계산하여<br>GMQDisplay <em
															class="case-blue membership-ptn">
														</em> 적립 예정</p>
													<p class="assi-txt border-line pd-top grd-txt" style="display:none">
														멤버십 등급은 <strong id="membershipGrd"></strong>이며,추가포인트의 잔여<br>
														적립한도는 현재 <strong id="limitPoint"></strong>포인트입니다.</p>
													<p class="assi-txt">GMQDisplay 포인트는 GMQDisplay계정의 '국가 또는 지역' 정보가
														<br>대한민국인 고객님만 적립 및 사용 가능합니다.
													</p>
													<!-- 패밀리넷, 디스플레이인 경우 노출 제한 -->
													...
													<p class="assi-txt">적립 예정 포인트는 멤버십 회원 상태와 등급별 최대 적립 <br>한도에 따라 실제 적립
														포인트와 상이할 수 있습니다.</p>
													<!-- 멤버십 등급 혜택, 포인트 적립 혜택: 패넷, 디스플레이 패넷, 등외급 사용안함 -->
													<div>
														<ul class="detail-view">
															<li>
																<span>GMQDisplay 멤버십 등급혜택</span>
									...
									<a class="sp-custom-c1071-1 ins-banner" href="javascript:void(0);">
										<div class="ins-pd-inline-banner" style="margin-top:15px;"></div>
									</a>
									<div class="itm-total-bottom">
										<div class="box-total-price">
											<span>회원 할인 적용 예상가</span>
											<button type="button" class="btn-tooltop02 price-tooltip fixed-tootip"
												data-title="회원 할인 예상가 안내" data-content="" data-close="툴팁 닫기"
												data-width="400"><span>회원 할인 예상가 안내 보기</span></button>
											<div class="tooltip-content" style="display:none;">
												<p>
													해당 상품에 즉시 할인이 적용되어 있으며,<br>
													쿠폰 적용 예상가는 로그인 시 결제 가능한 금액입니다.<br><br>
													...
													앱 쿠폰은 갤럭시 스토어에서 GMQDisplay닷컴 앱 설치 후 사용 가능합니다.<br><br>

													<span class="bold">회원 할인 상세 정보</span>
													- 할인금액(율) : <strong id="lastDiscountPrice"
														data-price="">10,000원</strong><br>
													- 유효기간 : <strong
														id="lastDiccountCpMaxAplStrtDtm">2023.03.01</strong>
													<strong>~</strong> <strong
														id="lastDiccountCpMinAplEndDtm">2023.03.31</strong>
												</p>

											</div>
											<strong data-price="720000"
												class="pd-total-price">352,980</strong><span>원</span>
										</div>
										<div class="box-btn">
											<div class="box-cto">
												...
												<ul>
													...
													<li>
														<button id="btnCart" type="button" class="btn btn-l btn-type6"
															...
															data-close="툴팁 닫기">장바구니</button>

													</li>
													<li>
														<div class="txt-noti-coupon" id="cpPop" style="display: block;">
															<p>회원 할인가를 놓치지마세요</p>
															<script type="text/javascript">
														...
														<button id="btnDirect" type="button" class="btn btn-l btn-type2"
															data-omni="바로구매">바로구매</button>
														<input type="hidden" id="pdAlertYn" value="">
														<input type="hidden" id="pdAlertMsg"
															value="제품이 장바구니에 추가되었습니다.<br>(현재 총 $cnt$개의 제품이 장바구니에 담겼습니다.)">
											...
											<div class="regular" style="display:none;">
												<button id="btnRegular" type="button"
													class="btn btn-l btn-type2 opt-regular-btn" style="width:100%"
													data-omni="shop regular">정기 구매하기</button>
											</div>
									...
									<div class="box-bann">
										...
										<!-- <a href="javascript:;"> -->
										<a href="https://www.samsung.com/sec/event/SuperSale/" target="_blank"
											title="새 창으로 열림">
								...
								<div class="layer-pop layer-normal layer-company layer-tvRuler" id="PfLayerTvRuler"
									tabindex="0" data-popup-layer="PfLayerTvRuler" data-focus="PfLayerTvRuler">
									<div class="layer-header">
									...
									<button type="button" class="pop-close"
										data-focus-next="PfLayerTvRuler">팝업닫기</button>
								</div>
								<!-- e : 일러두기 : TV크기 쉽게 알아보기 -->

								<!-- s : 소상공인몰 구매확인서 popup - 210331 -->
								<div class="layer-pop layer-normal popup-smallb-purchase" id="popupSmallbPurchase"
									tabindex="0" data-popup-layer="popupSmallbPurchase"
									data-focus="popupSmallbPurchase">
									<div class="layer-header">
										<h2>소상공인몰 제품 구매확인서</h2>
									</div>
									<div class="layer-content">
										<div class="box-clause-content clause-family">
											<p class="set txt-box">GMQDisplay판매 주식회사 (이하 '판매자' 라 한다) 와의 사업자 납품 거래를 아래와
												같이 확인합니다.</p>
											<p class="set ac">- 아 래 -</p>
											<div class="set">
												<p class="set-tit">제1조 (목적)</p>
												<ul class="list-dash">
													<li class="item">본 판매건은 사업자 납품 계약 제품 (이하 '제품'이라 한다) 을 구매자 에게 납품하고
														'구매자'가 그 제품대금을 결재함에 있어 필요한 제반사항을 규정하여 상호간 거래를 명확히 함에 목적이 있다.
													</li>
												</ul>
											</div>
											<div class="set">
												...
												<ul class="list-dash">
													<li class="item">'판매자'는 '구매자'가 요청한 인도처 로 설치배송을 해야하며 '구매자'는 제품설치를
														받아야한다</li>
											...
											<div class="set">
												...
												<ul class="list-dash">
													<li class="item">'구매자'는 '판매자'의 제품을 실사용 용도 이외에 다른 용도로 판매, 전용(이하
														'물량유출'이라 칭함) 하여서는 아니되며, '구매자'가 이를 위한한 경우 '판매자'는 '구매자'와 의 거래를
														중단조치 할 수 있다.</li>
												</ul>
											</div>
										</div>
										...
										<div class="btn-box double">
											<a href="javascript:void(0)"
												onclick="javascript:closeLayer('popupSmallbPurchase');"
												class="btn btn-d btn-type1">취소</a>
											<a href="javascript:void(0)" id="smallbPurchaseAgreeBtn"
												class="btn btn-d btn-type2">동의</a>
										</div>
									</div>
								...
								<div class="layer-pop layer-normal max850" id="PfLayerPdfView" tabindex="0"
									data-popup-layer="PfLayerPdfView" data-focus="PfLayerPdfView">
									<div class="layer-header">
										<h2>에어컨 추가 설치비</h2>
									</div>
									<div class="layer-content">
										<div class="wrap-scroll">
											<div>
												<img src="https://images.samsung.com/kdp/sohomall/images/img_sohoAirConditioner01.png"
													alt="23년 일반 에어컨 추가 설치비 운영 기준">
												<img src="https://images.samsung.com/kdp/sohomall/images/img_sohoAirConditioner02.png"
													alt="23년 중대형 에어컨(냉/난방기) 스탠드 추가 설치비 운영 기준">
											</div>
										</div>
									</div>
									<button type="button" class="pop-close"
										data-focus-next="PfLayerPdfView">팝업닫기</button>
								</div>
								<!-- e : 20211210 소상공인몰 PF 팝업 - 에어컨 추가 설치비 -->

								<!-- s : 소상공인몰 PF 팝업 - 플립2 구매 안내 -->
								<div class="layer-pop layer-normal max850" id="popupFilp2" tabindex="0"
									data-popup-layer="popupFilp2" data-focus="popupFilp2">
									<div class="layer-header">
										<h2>플립2 구매 안내</h2>
									</div>
									<div class="layer-content">
										<div class="wrap-scroll">
											<div>
												<img
													src="//images.samsung.com/kdp/editor/common/202203/d7f1da5a-82c2-491f-943f-d906da6820e1.jpg">
											</div>
										</div>
									</div>
									<button type="button" class="pop-close"
								...
								<div class="layer-pop layer-normal component-head popupLayer104"
									id="fnMultiPurchaseGuidance" tabindex="0" data-popup-layer="fnMultiPurchaseGuidance"
									data-focus="fnMultiPurchaseGuidance">
									<div class="layer-header">
									...
									<div class="layer-content">
										<div class="privacy-terms">
											<div class="terms-box">
												...
												<p class="mt20">
													패밀리넷은 제품의 사외 유출 및 부정 사용 예방을 위해 동일품목 다량 구매 시 본 서약 절차를 진행하고
													있습니다.<br><br>
										...
										<div class="flex-btw-c mt20">
											...
											<div class="inp-wrap">
												<input type="text" id="agreeInput" class="inp-line"
													placeholder="본인은 상기 내용에 동의합니다.">
										...
										<div class="btn-box double">
											...
											<button type="button" class="btn btn-d btn-type1" title="동의 안함"
												id="multiPurchaseCancelBtn">동의 안함</button>
											<button type="button" class="btn btn-d btn-type2" title="동의함"
												id="multiPurchaseAgreeBtn">동의함</button>
										</div>

									</div>
									<button type="button" class="pop-close" id="multiPurchasePopupClose"
										data-focus-next="fnMultiPurchaseGuidance">팝업닫기</button>
								</div>
								<!-- e : 210402 패밀리넷 동일 품목 다량 구매 관련 안내 -->

								<!-- s : 210402 패밀리넷 품목별 초과 구매 관련 신청 안내 -->
								<div class="layer-pop layer-normal component-head" id="fnOverpurchaseApplyGuidance"
									tabindex="0" data-popup-layer="fnOverpurchaseApplyGuidance"
									data-focus="fnOverpurchaseApplyGuidance">
									<div class="layer-header">
									...
									<div class="layer-content">
										<div class="privacy-terms">
											<div class="terms-box">
												...
												<div class="txt-box"> 패밀리넷은 임직원들이 저렴한 가격으로 자사 제품을 구매할 수 있도록 마련되었지만,
													...
													그러나, 지정 수량을 초과하여 구매가 필요한 경우에는 부서장 승인 후 구매가 가능하오니 아래 '바로가기' 를 클릭하셔서
													품의를 진행해주시기 바랍니다.<br><br>
										...
										<div class="btn-box double">
											<!-- 버튼 두개시 클래스 double 추가 -->
											<button type="button" class="btn btn-d btn-type1" title="취소"
												id="overpurchaseApplyCancelBtn">취소</button>
											<button type="button" class="btn btn-d btn-type2" title="바로가기"
												id="overpurchaseApplyDirectBtn">바로가기</button>
										</div>
									</div>
									<button type="button" class="pop-close" id="fnOverpurchasePopupClose"
										data-focus-next="fnOverpurchaseApplyGuidance">팝업닫기</button>
								</div>
								<!-- e : 210402 패밀리넷 품목별 초과 구매 관련 신청 안내 -->

								<!-- s : 혼수/이사 바로 구매 -->
								<div class="layer-pop layer-default" id="popupFamilyWeddingOrder" tabindex="0"
									data-popup-layer="popupFamilyWeddingOrder" data-focus="popupFamilyWeddingOrder">
								</div>
								<div class="layer-pop layer-default" id="popupFamilyWeddingOrderReal" tabindex="0"
									data-popup-layer="popupFamilyWeddingOrder" data-focus="popupFamilyWeddingOrder">
									...
									<button type="button" class="pop-close"
										data-focus-next="popupFamilyWeddingOrder">팝업닫기</button>
								</div>
								<!-- e : 혼수/이사 바로 구매 -->

								<!-- s : 혼수/이사 장바구니 -->
								<div class="layer-pop layer-default" id="popupFamilyWeddingCart" tabindex="0"
									data-popup-layer="popupFamilyWeddingCart" data-focus="popupFamilyWeddingCart"></div>
								<div class="layer-pop layer-default" id="popupFamilyWeddingCartReal" tabindex="0"
									data-popup-layer="popupFamilyWeddingCart" data-focus="popupFamilyWeddingCart">
									<div class="layer-header blind">
										<h2>혼수/이사 장바구니 추가</h2>
									</div>
									<div class="layer-content">
									...
									<button type="button" class="pop-close"
										data-focus-next="popupFamilyWeddingCart">팝업닫기</button>
								</div>
								<div class="layer-pop layer-normal layer-agreement" id="popupBannerPopup01" tabindex="0"
									data-popup-layer="popupBannerPopup01" data-focus="popupBannerPopup01">
									<div class="layer-header blind">
										<h2></h2>
									</div>
									<div class="layer-content">
								...
								<div class="layer-pop layer-normal component-head" id="fnOverpurchaseGuidanceByEppmall"
									tabindex="0" data-popup-layer="fnOverpurchaseGuidanceByEppmall"
									data-focus="fnOverpurchaseGuidanceByEppmall">
									<div class="layer-header">
									...
									<div class="layer-content">
										<div class="privacy-terms">
											<div class="point">귀하는 품목별 구매 가능 수량을 초과하여 구매하고 계십니다.</div><br>
											<div class="txt-box">
												패밀리몰은 임직원들이 저렴한 가격으로 자사 제품을 구매할 수 있도록 마련되었지만, 일부 직원이 같은 품목의 제품을 다수 구매하고
												재판매 했던 사례가 있어 품목별 구매 수량을 제한하여 운영 중입니다.
											</div>
										</div>
									</div>
									<button type="button" class="pop-close" id="fnOverpurchasePopupClose"
										data-focus-next="fnOverpurchaseGuidanceByEppmall">팝업닫기</button>
								</div>
								...
								<div class="pfpd-compare if2item close" style="bottom: 0px;">
									<div class="compare-innerWrap">
										<div class="toggle-toast">
											<a href="javascript:;" class="arrow-i" onclick="openCloseArrow()"><span
													class="blind">비교하기 펼치기</span></a>
										</div>
										...
										<div class="compare-inner flex-box">
											<div class="compare-catagory">
												<div class="box-droplist" id="compareDiv">
													<div id="compareDropList" class="wrap-droplist"><button
															id="compareDropListBtnSelect"
															class="droplist-button selected" title="최근 비교한 카테고리">최근 비교한
															카테고리</button>
														<ul class="droplist" id="dropList" tabindex="-1"
															data-roll="listbox">
															<li id="compareDropList" data-roll="option"
																class="droplist-item"
																data-comp-disp-clsf-en-nm="tablets"
																data-comp-disp-clsf-nm="태블릿" onclick="selectBtn(this)">
																<button type="button" id="dropListBtn">태블릿
																	(1/4)</button>
															</li>
														</ul>
													</div>
														...
														<div id="pfpdSlideCompare" class="">
															...
															<div class="prd" value="tablets"><!-- 221230 : id 값 삭제 -->
																...
																<div class="box">
																	<div class="prd-left">
																		...
																		<a href="/sec/tablets/galaxy-tab-s8-ultra-wifi-x900/SM-X900NZAFKOO/"
																			class="prd-img"><img
																				src="//images.samsung.com/kdp/goods/2022/10/25/53dba4fe-65b2-463a-b0a3-a89f7fc91996.png?$PG_PRD_CARD_PNG$"
																				alt="갤럭시 탭 S8 Ultra (Wi-Fi)"></a><!-- 221230 : href 값 변경 -->
																		...
																		<div class="prd-review">
																			...
																			<a class="link-review" target="_blank"
																				href="/sec/tablets/galaxy-tab-s8-ultra-wifi-x900/SM-X900NZAFKOO/?focus=review"
																				title="상품평점">4.9
																				(517)</a><!-- 221230 -->
																	...
																	<div class="prd-info">
																		<strong class="name">갤럭시 탭 S8 Ultra
																			(Wi-Fi)</strong>
																	...
																	<button type="button"
																		class="prd-delete prd-delete-mo"
																		onclick="deleteCompare(this)" value="G000260027"
																		data-omni="compare:delete"><span
															...
															<div class="prd" id="">
																<div class="box compare-emptyBox">
																	<a href="#none" type="button" class=""
																		onclick="openCompareAddPop(this)">
																		<div class="prd-info">
																			<span class="blind">plus(더하기)아이콘
																				버튼</span><span class="plus-i"></span>
																			<span class="notice">비교하고 싶은 제품 최대<br
																					class="mobile"> 4개까지 선택 가능해요!</span>
																		</div>
																	</a>
																</div>
															</div>
												...
												<div class="compare-btns">
													<ul>
														<li class="reset-i"><button class="btn-underline btn-reset"
																onclick="btnReset(this)" data-omni="compare:reset"
																value="tablets">비우기</button></li>
														<li><button class="btn btn-d btn-type2 btn-compare"
																id="compareBtn" data-popup-target="popupPrdCompare"
																value="tablets" onclick="openCompareWindow(this)"
																data-omni="compare:pop-up">비교하기 (1/4)</button></li>
													</ul>
												</div>
											</div>
										</div>
								...
								<!-- s : 제품을 선택하세요(alert) -->
								<div class="layer-pop layer-default alert" id="choicePrdAlert"
									data-popup-layer="choicePrdAlert" data-focus="choicePrdAlert">
									<div class="layer-header blind">
										<h2> 제품을 선택하세요.</h2>
									</div>
									<div class="layer-content">
								...
								<div class="layer-pop layer-normal chooseComparePrd" id="chooseComparePrd" tabindex="0"
									data-popup-layer="chooseComparePrd" data-focus="chooseComparePrd"
									aria-hidden="false" data-zindex="300" style="z-index: 300;">
									...
									<div class="btn-box">
										<button type="button" class="btn btn-d btn-type1"
											onclick="compareSelect()">비교하기</button> <!-- 제품 selected 되면 btn-type2 -->
									</div>
									<button type="button" class="pop-close"
										data-focus-next="chooseComparePrd">팝업닫기</button>
								</div>
								<!-- e : 제품 추가 팝업 -->

								<!-- s : 비교하기 팝업 -->
								<div class="layer-pop layer-normal popupPrdCompare" id="popupPrdCompare"
									data-popup-layer="popupPrdCompare" data-focus="popupPrdCompare" style="">
									<div class="layer-header-compare">
										<span>비교하기</span>
										<div class="selectBox-right">
											<div class="box-droplist" id="compareDiv">
												<div id="compareDropList" class="wrap-droplist"><button
														id="compareDropListBtnSelect" class="droplist-button selected"
														title="최근 비교한 카테고리">최근 비교한 카테고리</button>
													<ul class="droplist" id="dropList" tabindex="-1"
														data-roll="listbox">
														<li id="compareDropList" data-roll="option"
															class="droplist-item" data-comp-disp-clsf-en-nm="tablets"
															data-comp-disp-clsf-nm="태블릿" onclick="selectBtn(this)">
															<button type="button" id="dropListBtn">태블릿 (1/4)</button>
														</li>
													</ul>
												</div>
											</div>
									...
									<div class="layer-content-compare-wrap">
										<div class="layer-content-compare"
											style="max-height: 479.999998px; height: 479.999998px;">
									...
									<button type="button" class="pop-close"
										data-focus-next="popupPrdCompare">팝업닫기</button>
								</div>
								<!-- e : 비교하기 팝업-->

								<!-- s : 비교하기 mobile > select 221110 -->
								<div class="layer-pop moSelectPop" id="popupMobileSelect"
									data-popup-layer="popupMobileSelect" data-focus="popupMobileSelect">
									<div class="layer-header blind">
									...
									<button type="button" class="pop-close"
										data-focus-next="popupMobileSelect">팝업닫기</button>
								</div>
					...
					<div class="prdBox">
						<div class="spec emptyBox"> <!-- 값 뿌리면서 emptyBox 삭제 -->
							...
							/* 특별판매가 */if (price[4] !== '' && price[3] !== price[4]) { html += '<span class="price">' + titPrice10 + '<em class="num">' + fnComma(price[4]) + ' 원</em></span><br>'; }
								...
								<div class="layer-pop layer-default basic-pop" id="popupTradeIn" tabindex="0"
									data-popup-layer="popupTradeIn" data-focus="popupTradeIn" aria-hidden="false"
									data-zindex="300" style="z-index: 300;">
									<div class="layer-header">
										<h3>중고제품 추가보상 프로그램 (트레이드인)</h3>
									</div>
									<div class="layer-content">
										<p>
										...
										<p>
											...
											* My 갤럭시 클럽 세부안내 페이지에서 조회 바랍니다. <a
												href="https://www.samsung.com/sec/galaxyclub/" class="btn-underline"
												target="_blank">[바로가기]</a>
										</p>
										<div class="btn-box double">
											<a href="javascript:void(0)" class="btn btn-d btn-type1"
												id="tradeCancelBtn">아니오</a>
											<a href="javascript:void(0)" class="btn btn-d btn-type2"
												id="tradeOkBtn">예</a>
										</div>
									</div>
								</div>
								<div class="layer-pop layer-default basic-pop" id="popupGlxClubJoin" tabindex="0"
									data-popup-layer="popupGlxClubJoin" data-focus="popupGlxClubJoin"
									aria-hidden="false" data-zindex="300" style="z-index: 300;">
									<div class="layer-header">
										<h3>My 갤럭시 클럽 신청하기</h3>
									</div>
									<div class="layer-content">
										<p>
										...
										<div class="btn-box double">
											<a href="javascript:void(0)" class="btn btn-d btn-type1"
												id="galClubCancelBtn">취소</a>
											<a href="javascript:void(0)" class="btn btn-d btn-type2"
												id="galClubOkBtn">신청</a>
										</div>
									</div>
								</div>
			...
			<section class="component-bar" role="product_content_search">
				<div class="component-bar-inner">
					<div>
						<div class="itm-title-text" id="goods-title-text">오디세이 G3 60.4 cm</div>
						<nav id="anchor-navbar" class="anchor-navbar">
							<ul class="anchor-nav">
								<!--3rd 파티 상품은 특장점/상품평/유의사항만 노출 -->
								<li id="compGoodsPurBenefitLi">
									<a data-scroll="compGoodsPurBenefit" href="javascript:void(0);"
										class="dot topNav active" id="itm-benefit-component">
										<span data-omni="purchase benefits">구매혜택</span>
									</a>
								</li>
								<li>
									<a id="acompGoodsFeatures" data-scroll="compGoodsFeatures"
										href="javascript:void(0);" class="dot">
								...
								<li id="compGoodsManualLi">
									<a data-scroll="compGoodsManual" href="javascript:void(0);" class="dot">
										<span data-omni="support">매뉴얼 </span>
									</a>
								</li>
								<li>
									<a data-scroll="compGoodsComment" href="javascript:void(0);" class="dot"
										id="itm-review-component">
								...
								<li id="compGoodsNoticeInfoLi">
									<a data-scroll="compGoodsNoticeInfo" href="javascript:void(0);" class="dot">
										<span data-omni="purchasenotes">유의사항</span>
									</a>
								</li>
								<!-- 제품 연관성 링크 노출 -->
							</ul>
						...
						<div class="btn-direct-div">
							<button type="button" style="display:none;" id="btnDirectSub"
								class="btn btn-l btn-type3 btn-direct -sg" data-omni="buy now">바로구매</button>
							<button type="button" style="display:none;" id="btnCombineSub"
								class="btn btn-l btn-type3 btn-direct -sg" data-omni="buy now">조합하여 구매하기</button>
							<button type="button" style="display:none;" id="btnRegularSub" style="display:none;"
								class="btn btn-l btn-type3 btn-direct btn-otherAction" data-omni="shop regular">정기배송
								결제하기</button>
							<button type="button" style="display:none;" id="btnRestoreSub" data-scroll="restoreAlarm"
								class="btn btn-l btn-type3 btn-restore" data-omni="stock alert">재입고 알림</button>
							<button type="button" style="display:none;" id="findStoreSub"
								class="btn btn-l btn-type3 btn-direct btn-otherAction" data-omni="store locator"
								ga-ca="Where to buy" ga-la="S24AG320NK" ga-ac="store locator">매장찾기</button>
							<button type="button" style="display:none;" id="btnContactSub"
								class="btn btn-l btn-type3 btn-direct btn-otherAction btn-pd-contact"
								data-omni="contact us">견적문의</button>
							<!-- 210406 정재동 ST_ID 193 임직원몰(e카달로그) 일때 표시하는 버튼  -->
							<button type="button" style="display:none;" id="reservStoreSub"
								class="btn btn-l btn-type3 btn-direct -sg" data-omni="store locator">매장상담 예약하기</button>
			...
			<section class="itm-component">
				<div class="component-body" tabindex="0">
					<!--3rd 파티 상품은 특장점/상품평/유의사항만 노출 -->
					<article class="component-content component02" id="compGoodsPurBenefit"
						role="product_content_search">
						<!-- 구매혜택 -->
						<div>
							<div class="target">
								...
								<div class="target">
									...
									<p class="pc-ver" style="text-align: center;" align="center">
										...
										<a href="../../../bespokeshop/index.html" target="_blank">
											...
											<img src="https://images.samsung.com/kdp/editor/goods_desc/202209/39c1381a-ecb1-4b48-8fd7-62f975fb41c5.jpg"
												alt="img">
									...
									<p class="mo-ver" style="text-align: center;" align="center">
										...
										<a href="../../../bespokeshop/index.html" target="_blank">
											...
											<img src="https://images.samsung.com/kdp/editor/goods_desc/202209/84c2887d-9e3e-4748-8fd5-24b034c4ba7c.jpg"
												alt="img">
								...
								<style>
									.component-body .component02 .target .pc-ver {
										display: block;
									}

									.component-body .component02 .target .mo-ver {
										display: none;
									}
					...
					<article class="component-content component01 " id="compGoodsFeatures"
						role="product_content_search">
						<!-- 특장점 -->
						<!-- s : Feature full-bleed -->


						<div class="wrap-component feature-full-bleed pt-none pb-none w1440px      ">
							<div class="component-contents  pt-none pb-none txt-mid-center txtm-top-center  "
								style="background-color:#fff" data-cptnm="LS27AG320NKXKR-KV-211228">
								...
								<div class="visual-area ">
									<!-- s : visual type : image -->
									<img src="https://images.samsung.com/kdp/cms_contents/132957/4f1d642b-9f51-4283-b46c-bee503c48a77.jpg?$ORIGIN_JPG$"
										alt="오디세이 G3 게이밍 모니터가 오른쪽을 바라보고 있고, 깔끔한 Y-스탠드, 165 Hz 주사율, 1 ms 응답 속도 특장점을 강조하고 있습니다."
										class="obj-m objGif">
									<img src="https://images.samsung.com/kdp/cms_contents/132957/1e72a610-8e84-4d71-9e6d-b8a5c04824b8.jpg?$ORIGIN_JPG$"
										alt="오디세이 G3 게이밍 모니터가 오른쪽을 바라보고 있고, 깔끔한 Y-스탠드, 165 Hz 주사율, 1 ms 응답 속도 특장점을 강조하고 있습니다."
										class="objGif">
						...
						<div class="wrap-component feature-benefit pt-none pb-none w1440px img-bottom      ">
							<div class="component-contents  pt-wide pb-none txt-mid-center txtm-top-center "
								style="background-color:#FFFFFF"
								data-cptnm="LS27AG320NKXKR-최대 사이즈로 채워지는 3면 슬림 베젤-211228">
								...
								<div class="component-text">
									<div class="component-text-inner">
										<div class="box-title">
											...
											<h2 class="title mo-ver lrg" style="color:#000000">최대 사이즈로 채워지는<br>3면 슬림 베젤
											</h2>

											<h2 class="title pc-ver lrg" style="color:#000000">최대 사이즈로 채워지는<br>3면 슬림 베젤
											</h2>



											<p class="desc mo-ver " style="color:#000000">더욱 크고 넓은 화면이 한눈에 펼쳐집니다.<br>모니터
												끝까지 최대 사이즈의 화면으로 채워주는<br>3면 슬림 베젤 디자인 덕분이죠.<br>듀얼 모니터 설정으로 플레이 시<br>적들이
												베젤 사이로 숨는 일도 줄어듭니다.</p>

											<p class="desc pc-ver " style="color:#000000">더욱 크고 넓은 화면이 한눈에 펼쳐집니다.<br>모니터
												끝까지 최대 사이즈의 화면으로 채워주는 3면 슬림 베젤 디자인 덕분이죠.<br>듀얼 모니터 설정으로 플레이 시 적들이 베젤 사이로
												숨는 일도 줄어듭니다.</p>

										</div>
										<div class="box-disc">
											<p class="disc mo-ver" style="color:#363636">* 추가 모니터는 별매입니다.</p>
											<p class="disc pc-ver" style="color:#363636">* 추가 모니터는 별매입니다.</p>
										</div>
									</div>
								</div>
								<div class="visual-area  ">
									...
									<!-- s : visual type : image -->
									<img src="https://images.samsung.com/kdp/cms_contents/125714/4eb21566-b146-483c-9155-d4b3435a8e9d.jpg?$FB_TYPE_A_MO_JPG$"
										alt="3면 슬림 베젤 모니터 2대를 붙여 놓은 이미지입니다." class="obj-m objGif">
									<img src="https://images.samsung.com/kdp/cms_contents/125714/e7b00641-a734-45c4-9573-eed09a21ebe2.jpg?$FB_TYPE_A_JPG$"
										alt="3면 슬림 베젤 모니터 2대를 붙여 놓은 이미지입니다." class="objGif">
						...
						<div class="wrap-component feature-benefit pt-none pb-none w1440px img-bottom      ">
							<div class="component-contents  pt-wide pb-none txt-mid-center txtm-top-center "
								style="background-color:#FFFFFF"
								data-cptnm="LS27AG320NKXKR-잔상 걱정 없이 즐기는 프로급 플레이-211228">
								...
								<div class="component-text">
									<div class="component-text-inner">
										<div class="box-title">
											...
											<h2 class="title mo-ver lrg" style="color:#000000">잔상 걱정 없이 즐기는<br>프로급 플레이
											</h2>

											<h2 class="title pc-ver lrg" style="color:#000000">잔상 걱정 없이 즐기는<br>프로급 플레이
											</h2>



											<p class="desc mo-ver " style="color:#000000">빠르게 움직이는 적을 놓치지 마세요.<br>165
												Hz의 빠른 주사율은 잔상이 생기거나 느려지지 않고<br>장면 하나하나를 선명하게 보여줍니다.<br>긴박한 순간에도 끊김 걱정
												없는 영상으로<br>상대의 움직임을 완벽히 읽을 수 있게 해주죠.</p>

											<p class="desc pc-ver " style="color:#000000">빠르게 움직이는 적을 놓치지 마세요.<br>165
												Hz의 빠른 주사율은 잔상이 생기거나 느려지지 않고 장면 하나하나를 선명하게 보여줍니다.<br>긴박한 순간에도 끊김 걱정 없는
												영상으로 상대의 움직임을 완벽히 읽을 수 있게 해주죠.</p>
								...
								<div class="visual-area  ">
									...
									<!-- s : visual type : image -->
									<img src="https://images.samsung.com/kdp/cms_contents/132957/7690ccae-3a04-4d3b-b3b9-cba6ce125dcf.jpg?$FB_TYPE_A_MO_JPG$"
										alt="60 Hz 와 165 Hz 의 차이를 비교하는 이미지입니다." class="obj-m objGif">
									<img src="https://images.samsung.com/kdp/cms_contents/132957/0b8e4ce5-4346-40ed-afe3-c3968b275780.jpg?$FB_TYPE_A_JPG$"
										alt="60 Hz 와 165 Hz 의 차이를 비교하는 이미지입니다." class="objGif">
						...
						<div class="wrap-component feature-benefit pt-none pb-none w1440px img-bottom      ">
							<div class="component-contents  pt-wide pb-none txt-mid-center txtm-top-center "
								style="background-color:#FFFFFF" data-cptnm="LS27AG320NKXKR-상대를 제압하는 한 차원 빠른 속도-211228">
								...
								<div class="component-text">
									<div class="component-text-inner">
										<div class="box-title">
											...
											<h2 class="title mo-ver lrg" style="color:#000000">상대를 제압하는<br>한 차원 빠른 속도
											</h2>

											<h2 class="title pc-ver lrg" style="color:#000000">상대를 제압하는<br>한 차원 빠른 속도
											</h2>



											<p class="desc mo-ver " style="color:#000000">치열한 전투의 현장에서 당당하게 캐리를 외칠
												시간입니다.<br>입력과 거의 동시에 화면이 바뀌는 1 ms의 응답 속도는 당신의 컨트롤을 즉각적으로 화면에 반영해 줍니다.
											</p>

											<p class="desc pc-ver " style="color:#000000">치열한 전투의 현장에서 당당하게 캐리를 외칠
												시간입니다.<br>입력과 거의 동시에 화면이 바뀌는 1 ms의 응답 속도는 당신의 컨트롤을 즉각적으로 화면에 반영해 줍니다.
											</p>

										</div>
										<div class="box-disc">
											<p class="disc mo-ver" style="color:#363636">* 응답 속도는 실사용 환경에 따라 다를 수 있습니다.
											</p>
											<p class="disc pc-ver" style="color:#363636">* 응답 속도는 실사용 환경에 따라 다를 수 있습니다.
											</p>
										</div>
									</div>
								</div>
								<div class="visual-area  ">
									...
									<!-- s : visual type : image -->
									<img src="https://images.samsung.com/kdp/cms_contents/125714/47b0c004-d17a-4404-9c82-0fc878aa338c.jpg?$FB_TYPE_A_MO_JPG$"
										alt="1 ms 빠른 응답 속도를 비교하는 이미지입니다." class="obj-m objGif">
									<img src="https://images.samsung.com/kdp/cms_contents/125714/8620dd0b-f90c-498c-9816-0b843f041632.jpg?$FB_TYPE_A_JPG$"
										alt="1 ms 빠른 응답 속도를 비교하는 이미지입니다." class="objGif">

									<div class="box-disc">
										<p class="disc mo-ver " style="color:#363636">* 응답 속도는 실사용 환경에 따라 다를 수 있습니다.</p>
										<p class="disc pc-ver " style="color:#363636">* 응답 속도는 실사용 환경에 따라 다를 수 있습니다.</p>
									</div>
								</div>
						...
						<div class="wrap-component feature-benefit pt-none pb-none w1440px img-bottom      ">
							<div class="component-contents  pt-wide pb-none txt-mid-center txtm-top-center "
								style="background-color:#FFFFFF" data-cptnm="LS27AG320NKXKR-편안한 눈으로 즐기는 승리의 시간-211228">
								...
								<div class="component-text">
									<div class="component-text-inner">
										<div class="box-title">
											...
											<h2 class="title mo-ver lrg" style="color:#000000">편안한 눈으로 즐기는<br>승리의 시간
											</h2>

											<h2 class="title pc-ver lrg" style="color:#000000">편안한 눈으로 즐기는<br>승리의 시간
											</h2>



											<p class="desc mo-ver " style="color:#000000">켠 김에 랭크 업까지, 더욱 편안한 눈으로
												클리어하세요.<br>블루라이트를 줄이는 눈 보호 모드,<br>자극적인 화면 깜박임을 최소화하는 플리커 프리 기술로<br>눈의
												피로를 적게 하여 더 오래 집중할 수 있습니다.</p>

											<p class="desc pc-ver " style="color:#000000">켠 김에 랭크 업까지, 더욱 편안한 눈으로
												클리어하세요.<br>블루라이트를 줄이는 눈 보호 모드, 자극적인 화면 깜박임을 최소화하는 플리커 프리 기술로<br>눈의 피로를
												적게 하여 더 오래 집중할 수 있습니다.</p>

										</div>
										<div class="box-disc">
											<p class="disc mo-ver" style="color:#363636">* TÜV Rheinland의 Flicker Free
												인증을 받았습니다.<br></p>
											<p class="disc pc-ver" style="color:#363636">* TÜV Rheinland의 Flicker Free
												인증을 받았습니다.<br></p>
										</div>
									</div>
								</div>
								<div class="visual-area  ">
									...
									<!-- s : visual type : image -->
									<img src="https://images.samsung.com/kdp/cms_contents/125714/e347340b-12b9-4c03-a434-4a66d702ac18.jpg?$FB_TYPE_A_MO_JPG$"
										alt="눈 보호 모드와 플리커 프리 기술로 화면 깜빡임과 블루라이트를 없애주는 연출 이미지입니다." class="obj-m objGif">
									<img src="https://images.samsung.com/kdp/cms_contents/125714/0bf1df40-2c42-4f6a-9b20-dddcef8646f8.jpg?$FB_TYPE_A_JPG$"
										alt="눈 보호 모드와 플리커 프리 기술로 화면 깜빡임과 블루라이트를 없애주는 연출 이미지입니다." class="objGif">

									<div class="box-disc">
										<p class="disc mo-ver " style="color:#363636">* TÜV Rheinland의 Flicker Free 인증을
											받았습니다.<br></p>
										<p class="disc pc-ver " style="color:#363636">* TÜV Rheinland의 Flicker Free 인증을
											받았습니다.<br></p>
									</div>
								</div>
						...
						<div class="wrap-component feature-benefit pt-none pb-none w1440px img-bottom      ">
							<div class="component-contents  pt-wide pb-none txt-mid-center txtm-top-center "
								style="background-color:#FFFFFF"
								data-cptnm="LS27AG320NKXKR-완벽한 수준의 싱크로 몰입감 넘치는 게임-211228">
								...
								<div class="component-text">
									<div class="component-text-inner">
										<div class="box-title">
											...
											<h2 class="title mo-ver lrg" style="color:#000000">완벽한 수준의 싱크로<br>몰입감 넘치는 게임
											</h2>

											<h2 class="title pc-ver lrg" style="color:#000000">완벽한 수준의 싱크로<br>몰입감 넘치는 게임
											</h2>



											<p class="desc mo-ver " style="color:#000000">끊김 걱정 없는 영상으로 게임에 더욱
												몰입하세요.<br>AMD FreeSync Premium의 적응형 동기화 기술은<br>화면 찢어짐과 깜박임, 입력 지연을
												줄여주며<br>고사양 구간에서 프레임이 낮아지는 장면까지<br>부드럽게 재생합니다.</p>

											<p class="desc pc-ver " style="color:#000000">끊김 걱정 없는 영상으로 게임에 더욱
												몰입하세요.<br>AMD FreeSync Premium의 적응형 동기화 기술은 화면 찢어짐과 깜박임, 입력 지연을
												줄여주며<br>고사양 구간에서 프레임이 낮아지는 장면까지 부드럽게 재생합니다.</p>
								...
								<div class="visual-area  ">
									...
									<!-- s : visual type : image -->
									<img src="https://images.samsung.com/kdp/cms_contents/125714/838435d0-8015-4423-b22e-712b0144677d.jpg?$FB_TYPE_A_MO_JPG$"
										alt="ADM FrereSync Premium 기술로 빠른 액션 장면도 매끄럽게 감상할 수 있습니다." class="obj-m objGif">
									<img src="https://images.samsung.com/kdp/cms_contents/125714/c380ee13-05e6-4270-aebf-bfa6e44eb9f8.jpg?$FB_TYPE_A_JPG$"
										alt="ADM FrereSync Premium 기술로 빠른 액션 장면도 매끄럽게 감상할 수 있습니다." class="objGif">
						...
						<div class="wrap-component feature-benefit pt-none pb-none w1440px img-bottom      ">
							<div class="component-contents  pt-wide pb-none txt-mid-center txtm-top-center "
								style="background-color:#FFFFFF" data-cptnm="LS27AG320NKXKR-당신과 게임을 위한 맞춤 디자인-211228">
								...
								<div class="component-text">
									<div class="component-text-inner">
										<div class="box-title">
											...
											<h2 class="title mo-ver " style="color:#000000">당신과 게임을 위한<br>맞춤 디자인</h2>

											<h2 class="title pc-ver " style="color:#000000">당신과 게임을 위한<br>맞춤 디자인</h2>



											<p class="desc mo-ver " style="color:#000000">승리를 위한 최상의 눈높이를 찾아보세요.<br>완벽한
												시야를 찾을 때까지<br>모니터를 회전하거나 기울여 조정하여<br>게임을 더 편안하게 즐길 수 있죠.</p>

											<p class="desc pc-ver " style="color:#000000">승리를 위한 최상의 눈높이를 찾아보세요.<br>완벽한
												시야를 찾을 때까지 모니터를 회전하거나 기울여 조정하여 게임을 더 편안하게 즐길 수 있죠.</p>
								...
								<div class="visual-area  ">
									...
									<!-- s : visual type : image -->
									<img src="https://images.samsung.com/kdp/cms_contents/214756/6b64b8fa-3bf9-43d9-90da-4ef6548fb5d0.jpg?$FB_TYPE_A_MO_JPG$"
										alt="높낮이 조절, 상하 각도 조절, 회전, 가로/세로 모드가 가능한 것을 나타내는 이미지입니다." class="obj-m objGif">
									<img src="https://images.samsung.com/kdp/cms_contents/214756/9d51755c-1b77-4be9-9804-8bfd540e3b4c.jpg?$FB_TYPE_A_JPG$"
										alt="높낮이 조절, 상하 각도 조절, 회전, 가로/세로 모드가 가능한 것을 나타내는 이미지입니다." class="objGif">
							...
							$(document).ready(function () {
								$('.feature-bar').on('click', '.btn-ctrl', function () {
									var featureWrwap = $(this).closest('.feature-wrap'),
										...
										pointHeight = $('.family-point-wrapper').height() || 0, // 20200923 추가
										barHeight = $('.component-bar').height() + pointHeight, // 20200923 수정
										moveTop = featureWrwap.offset().top - barHeight; // 20200921 수정
					...
					<article class="component-con spec-all drop-component component03" id="compGoodsSpec"
						role="product_content_search">
						<!-- 스펙 -->
						<div>
							<div class="dropcontent fixWidth" id="specContents" style="">
								<script type="text/javascript">
									$(document).ready(function () {
								...
								<a href="javascript:;" class="dropButton" id="specDropBtn" title=""
									data-omni="all:specs">
									<span>스펙</span>
								</a>
								<div class="spec-tabcontent-content tab-content" id="specTabContent" role="tabpanel"
									style="display: block;">
									<div class="spec-table-wrap">
										<h3 class="spec-itm-title" id="cstrt-nm">삼성전자 오디세이 G3 S27AG300 </h3>
										<div class="spec-table">
											<dl>
												...
												<dd>
													<ol>
														<li>
															<strong class="spec-title">화면사이즈 (cm)</strong>
															<p class="spec-desc">80.0&nbsp;</p>
														</li>
														<li>
														...
														<li>
															<strong class="spec-title">엑티브 디스플레이 사이즈 (H x V)
																(mm)</strong>
															<p class="spec-desc">697.344 x 392.256&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">화면 곡률</strong>
															<p class="spec-desc">1000 R&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">화면비율</strong>
															<p class="spec-desc">16:9&nbsp;</p>
														</li>
														<li><strong class="spec-title">패널 타입</strong>
															<p class="spec-desc">VA&nbsp;</p>
														</li>
														<li><strong class="spec-title">밝기 (Typical)</strong>
															<p class="spec-desc">350&nbsp;cd/㎡</p>
														</li>
														<li>
															<strong class="spec-title">밝기 (Min)</strong>
															<p class="spec-desc">300&nbsp;cd/㎡</p>
														</li>
														<li>
															<strong class="spec-title">명암비</strong>
															<p class="spec-desc">2,500:1(Typ.)&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">HDR(High Dynamic Range)</strong>
															<p class="spec-desc">VESA DisplayHDR 600&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">해상도</strong>
															<p class="spec-desc">2,560 x 1,440&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">응답속도 (ms)</strong>
															<p class="spec-desc">1 (GTG)&nbsp;</p>
														</li>
														<li>
														...
														<li>
															<strong class="spec-title">칼라지원</strong>
															<p class="spec-desc">Max 1 B&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">색재현성(Color Gamut, DCI
																Coverage)</strong>
															<p class="spec-desc">95 % (Typ), 88 % (Min)&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">주사율</strong>
															<p class="spec-desc">Max 240 Hz&nbsp;</p>
														</li>
													</ol>
												</dd>
											</dl>
											<dl>
												...
												<dd>
													<ol>
														<li>
															<strong class="spec-title">스마트 여부</strong>
															<p class="spec-desc">Smart&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">운영체제</strong>
															<p class="spec-desc">Tizen™&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">빅스비</strong>
															<p class="spec-desc">US English, UK English, India English,
																Korean, French, German, Italian, Spanish, BR Portuquese
																(features vary by language)&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">원거리 음성인식</strong>
															<p class="spec-desc">있음&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">TV Plus</strong>
															<p class="spec-desc">있음&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">SmartThings 모바일 앱 호환</strong>
															<p class="spec-desc">있음&nbsp;</p>
														</li>
														<li>
														...
														<li>
															<strong class="spec-title">유니버설 가이드</strong>
															<p class="spec-desc">있음&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">비디오 커뮤니케이션</strong>
															<p class="spec-desc">Google Duo&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">웹 서비스</strong>
															<p class="spec-desc">Microsoft 365&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">Mobile to Screen 미러링</strong>
															<p class="spec-desc">있음&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">탭 뷰</strong>
															<p class="spec-desc">있음&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">워크스페이스</strong>
															<p class="spec-desc">있음&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">사운드 미러링</strong>
															<p class="spec-desc">있음&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">ConnectShare™ (USB 2.0)</strong>
															<p class="spec-desc">있음&nbsp;</p>
														</li>
													</ol>
												</dd>
											...
											<dl>
												...
												<dd>
													<ol>
														<li>
															<strong class="spec-title">눈 보호 모드</strong>
															<p class="spec-desc">있음&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">플리커프리</strong>
															<p class="spec-desc">있음&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">퀀텀 닷 컬러</strong>
															<p class="spec-desc">있음&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">게임모드</strong>
															<p class="spec-desc">있음&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">이미지 사이즈</strong>
															<p class="spec-desc">있음&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">Window 인증</strong>
															<p class="spec-desc">Windows 10&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">FreeSync</strong>
															<p class="spec-desc">FreeSync Premium Pro&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">Virtual AIM Point</strong>
															<p class="spec-desc">있음&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">HDMI-CEC</strong>
															<p class="spec-desc">있음&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">Core Sync</strong>
															<p class="spec-desc">있음&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">게임 바</strong>
															<p class="spec-desc">있음&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">게이밍 허브</strong>
															<p class="spec-desc">있음&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">외부입력 자동 전환+</strong>
															<p class="spec-desc">있음&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">AI 화질 최적화</strong>
															<p class="spec-desc">있음&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">슈퍼 울트라와이드 게임뷰</strong>
															<p class="spec-desc">있음&nbsp;</p>
														</li>
													</ol>
												</dd>
											...
											<dl>
												...
												<dd>
													<ol>
														<li>
															<strong class="spec-title">무선 Display 연결</strong>
															<p class="spec-desc">없음&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">D-Sub</strong>
															<p class="spec-desc">없음&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">DVI</strong>
															<p class="spec-desc">없음&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">Dual Link DVI</strong>
															<p class="spec-desc">없음&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">Display Port</strong>
															<p class="spec-desc">1&nbsp;개</p>
														</li>
														<li>
															<strong class="spec-title">Display Port 버전</strong>
															<p class="spec-desc">1.4&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">Display Port Out</strong>
															<p class="spec-desc">없음&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">Mini-Display Port</strong>
															<p class="spec-desc">없음&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">HDMI</strong>
															<p class="spec-desc">2&nbsp;개</p>
														</li>
														<li>
															<strong class="spec-title">HDMI 버전</strong>
															<p class="spec-desc">2.1&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">Audio In</strong>
															<p class="spec-desc">없음&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">Headphone</strong>
															<p class="spec-desc">있음&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">USB Ports</strong>
															<p class="spec-desc">2&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">USB Hub 버전</strong>
															<p class="spec-desc">3&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">USB-C</strong>
															<p class="spec-desc">없음&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">Ethernet (LAN)</strong>
															<p class="spec-desc">1&nbsp;개</p>
														</li>
														<li>
															<strong class="spec-title">HDCP 버전 (HDMI)</strong>
															<p class="spec-desc">2.2&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">WiFi</strong>
															<p class="spec-desc">있음 (WiFi5)&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">블루투스</strong>
															<p class="spec-desc">있음 (BT5.2)&nbsp;</p>
														</li>
													</ol>
												</dd>
											</dl>
											<dl>
												...
												<dd>
													<ol>
														...
														<li>
															<strong class="spec-title">AI 사운드 최적화+</strong>
															<p class="spec-desc">있음&nbsp;</p>
														</li>
													</ol>
												</dd>
											...
											<dl>
												...
												<dd>
													<ol>
														<li>
															<strong class="spec-title">온도</strong>
															<p class="spec-desc">10~40&nbsp;℃</p>
														</li>
														<li>
															<strong class="spec-title">습도</strong>
															<p class="spec-desc">10~80 (non-condensing)&nbsp;%</p>
														</li>
													</ol>
												</dd>
											</dl>
											<dl>
												...
												<dd>
													<ol>
														<li>
															<strong class="spec-title">Factory 튜닝</strong>
															<p class="spec-desc">있음&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">컬러모드</strong>
															<p class="spec-desc">
																Standard/Dynamic/Movie/Graphic/Entertain&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">Factory 캘리브레이션 레포트</strong>
															<p class="spec-desc">있음&nbsp;</p>
														</li>
													</ol>
												</dd>
											...
											<dl>
												...
												<dd>
													<ol>
														<li>
															<strong class="spec-title">스탠드 형태</strong>
															<p class="spec-desc">HAS PIVOT&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">HAS(Height Adjustable
																Stand)</strong>
															<p class="spec-desc">120.0 ± 5.0&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">틸트</strong>
															<p class="spec-desc">-9.0º(± 2°) ~ +13.0º(± 2°)&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">스위블</strong>
															<p class="spec-desc">-15.0º ~ +15.0º&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">피봇</strong>
															<p class="spec-desc">-92.0º ~ +92.0º&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">월 마운트</strong>
															<p class="spec-desc">100 x 100&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">전면 색상</strong>
															<p class="spec-desc">BLACK&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">후면 색상</strong>
															<p class="spec-desc">BLACK&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">스탠드 색상</strong>
															<p class="spec-desc">Black&nbsp;</p>
														</li>
													</ol>
												</dd>
											...
											<dl>
												...
												<dd>
													<ol>
														<li>
															<strong class="spec-title">전원 타입</strong>
															<p class="spec-desc">External Adaptor&nbsp;</p>
														</li>
													</ol>
												</dd>
											</dl>
											<dl>
												...
												<dd>
													<ol>
														<li>
															<strong class="spec-title">스탠드포함(가로x높이x깊이)</strong>
															<p class="spec-desc">713.0 x 606.2 x 311.1&nbsp;mm</p>
														</li>
														<li>
															<strong class="spec-title">스탠드제외(가로x높이x깊이)</strong>
															<p class="spec-desc">713.0 x 439.7 x 181.5&nbsp;mm</p>
														</li>
														<li>
															<strong class="spec-title">포장(가로x높이x깊이)</strong>
															<p class="spec-desc">827.0 x 226.0 x 494.0&nbsp;mm</p>
														</li>
													</ol>
												</dd>
											</dl>
											<dl>
												...
												<dd>
													<ol>
														<li>
															<strong class="spec-title">제품 무게 (스탠드 포함)</strong>
															<p class="spec-desc">7.4&nbsp;kg</p>
														</li>
														<li>
															<strong class="spec-title">제품 무게 (스탠드 제외)</strong>
															<p class="spec-desc">5.5&nbsp;kg</p>
														</li>
														<li>
															<strong class="spec-title">무게 (박스 포장)</strong>
															<p class="spec-desc">10.1&nbsp;kg</p>
														</li>
													</ol>
												</dd>
											</dl>
											<dl>
												...
												<dd>
													<ol>
														<li>
															<strong class="spec-title">전원 케이블 길이</strong>
															<p class="spec-desc">1.5 m&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">HDMI 케이블</strong>
															<p class="spec-desc">없음&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">DP 케이블</strong>
															<p class="spec-desc">있음&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">Mini-DP 젠더</strong>
															<p class="spec-desc">없음&nbsp;</p>
														</li>
														<li>
															<strong class="spec-title">리모컨</strong>
															<p class="spec-desc">있음&nbsp;</p>
														</li>
													</ol>
												</dd>
											...
											<dl>
												...
												<dd>
													<ol>
														<li>
															<strong class="spec-title">제품명</strong>
															<p class="spec-desc">LED 모니터</p>
														</li>
														<li>
															<strong class="spec-title">제조자/수입자</strong>
															<p class="spec-desc">삼성전자㈜</p>
														</li>
														<li>
															<strong class="spec-title">제조국가</strong>
															<p class="spec-desc">한국 (중국,헝가리,멕시코,슬로바키아,베트남)</p>
														</li>
														<li>
															<strong class="spec-title">KC 인증 필 유무</strong>
															<p class="spec-desc"><img
																	src="//images.samsung.com/is/image/samsung/p5/sec/common/icon-kc.png?$ORIGIN_PNG$"
																	alt="KC 인증 로고">R-R-SEC-S32BG650E</p>
														</li>
														<li>
															<strong class="spec-title">동일모델의 출시년월</strong>
															<p class="spec-desc">2022년 10월</p>
														</li>
														<li>
															<strong class="spec-title">A/S 책임자와 전화번호</strong>
															<p class="spec-desc">삼성전자서비스센터 / 1588-3366</p>
														</li>
														<li>
															<strong class="spec-title">품질보증기준</strong>
															<p class="spec-desc">결함·하자 등에 따른 소비자 피해에 대해서는
																소비자분쟁해결기준(소비자기본법 제16조)에 따라 보상 가능</p>
														</li>
													</ol>
												</dd>
											</dl>
				...
				<article class="component-con install-guide drop-component component04" id="compGoodsInstallGuide"
					role="product_content_search" style="display:none;">
					<!-- 설치가이드 -->
					<div>
						<a href="javascript:;" class="dropButton" title="">
							<span>설치가이드</span>
						</a>
						<div class="dropcontent fixWidth target" style="display:none;">
						</div>
					</div>
				</article>
				<article class="component-con customer-center drop-component component05" id="compGoodsManual"
					role="product_content_search">
					<!-- 매뉴얼 -->
					<div>
						<a href="javascript:;" class="dropButton" id="manualDropBtn" title="" data-omni="all:support">
							<span>매뉴얼</span>
						</a>
						<div class="dropcontent fixWidth" id="manualContents" style="display:none;"></div>
					</div>
				</article>
				<article class="component-con component07" id="compGoodsComment">
					<!-- 상품평 고도화  ee-->
					<style>
						.dropdownMenu .account-types {
							display: none;
						}

						.dropdownMenu.active .account-types {
							display: block;
						}
					</style>
					<script>
					...
					<div class="fixWidth" id="comment-information">
												...
												<ul>
													<li>
														...
														<div class="status-bar">
															<div class="gauge" style="width: 87%"></div>
														</div>
														<span>87%</span>
													</li>
													<li>
						...
						-->
											...
											<div class="review-lt-keywordsbar">
												...
												<ul>
													<li>
														...
														<div class="gauge pct25" style="width:41%"></div>
														<div class="keyword-info">
															<img src="../../../static/_images/emoji/emoji-01.png"
																class="" alt="" width="20" height="20">
															<span class="keyword-value"><!-- -->성능이 좋아요<!-- --></span>
															<span class="keyword-total">
																<span class="sr-only">이 키워드를 선택한 인원</span>10</span>
														</div>
													</li>
													<li>
														<!-- <div class="gauge" style="width:92%"></div> -->
														<div class="gauge pct25" style="width:29%"></div>
														<div class="keyword-info">
															<img src="../../../static/_images/emoji/emoji-02.png"
																class="" alt="" width="20" height="20">
															<span class="keyword-value"><!-- -->사용하기 편리해요<!-- --></span>
															<span class="keyword-total">
																<span class="sr-only">이 키워드를 선택한 인원</span>7</span>
														</div>
													</li>
													<li>
														<!-- <div class="gauge" style="width:92%"></div> -->
														<div class="gauge pct0" style="width:25%"></div>
														<div class="keyword-info">
															<img src="../../../static/_images/emoji/emoji-10.png"
																class="" alt="" width="20" height="20">
															<span class="keyword-value"><!-- -->배송이 빨라요<!-- --></span>
															<span class="keyword-total">
																<span class="sr-only">이 키워드를 선택한 인원</span>6</span>
														</div>
													</li>
													<li>
														<!-- <div class="gauge" style="width:92%"></div> -->
														<div class="gauge pct0" style="width:25%"></div>
														<div class="keyword-info">
															<img src="../../../static/_images/emoji/emoji-09.png"
																class="" alt="" width="20" height="20">
													...
													<li style="display: none;">
														<!-- <div class="gauge" style="width:92%"></div> -->
														<div class="gauge pct0" style="width:16%"></div>
														<div class="keyword-info">
															<img src="../../../static/_images/emoji/emoji-04.png"
																class="" alt="" width="20" height="20">
															<span class="keyword-value"><!-- -->디자인이 마음에
																들어요<!-- --></span>
															<span class="keyword-total">
																<span class="sr-only">이 키워드를 선택한 인원</span>4</span>
														</div>
													</li>
													<li style="display: none;">
														<!-- <div class="gauge" style="width:92%"></div> -->
														<div class="gauge pct0" style="width:16%"></div>
														<div class="keyword-info">
															<img src="../../../static/_images/emoji/emoji-06.png"
																class="" alt="" width="20" height="20">
													...
													<li style="display: none;">
														<!-- <div class="gauge" style="width:92%"></div> -->
														<div class="gauge pct0" style="width:12%"></div>
														<div class="keyword-info">
															<img src="../../../static/_images/emoji/emoji-03.png"
																class="" alt="" width="20" height="20">
															<span class="keyword-value"><!-- -->튼튼해요<!-- --></span>
															<span class="keyword-total">
																<span class="sr-only">이 키워드를 선택한 인원</span>3</span>
														</div>
													</li>
													<li style="display: none;">
														<!-- <div class="gauge" style="width:92%"></div> -->
														<div class="gauge pct0" style="width:12%"></div>
														<div class="keyword-info">
															<img src="../../../static/_images/emoji/emoji-08.png"
																class="" alt="" width="20" height="20">
													...
													<li style="display: none;">
														<!-- <div class="gauge" style="width:92%"></div> -->
														<div class="gauge pct0" style="width:4%"></div>
														<div class="keyword-info">
															<img src="../../../static/_images/emoji/emoji-05.png"
																class="" alt="" width="20" height="20">
															<span class="keyword-value"><!-- -->색상이 마음에
																들어요<!-- --></span>
															<span class="keyword-total">
																<span class="sr-only">이 키워드를 선택한 인원</span>1</span>
														</div>
													</li>
													<li style="display: none;">
														<!-- <div class="gauge" style="width:92%"></div> -->
														<div class="gauge pct0" style="width:0%"></div>
														<div class="keyword-info">
															<img src="../../../static/_images/emoji/emoji-07.png"
																class="" alt="" width="20" height="20">
															<span class="keyword-value"><!-- -->소재가 마음에
																들어요<!-- --></span>
															<span class="keyword-total">
																<span class="sr-only">이 키워드를 선택한 인원</span>0</span>
														</div>
													</li>
													<li style="display: none;">
														<!-- <div class="gauge" style="width:92%"></div> -->
														<div class="gauge pct0" style="width:0%"></div>
														<div class="keyword-info">
															<img src="../../../static/_images/emoji/emoji-11.png"
																class="" alt="" width="20" height="20">
										...
										<div class="box-btn" id="box-btn-review">
											...
											<!-- 상품평 작성 버튼 -->
											<!-- 상품평 가이드 버튼 -->
											<div class="button-review-guide" id="commentGuideBtnArea"
												style="display: none;">
												<span class="title-bubble">베스트 리뷰어가 되려면?</span>
												<a href="javascript:;" class="btn btn-s btn-type3"
													data-popup-target="popupReviewGuide"><span>상품평 가이드</span></a>
											</div>
											<!-- 상품평 가이드 버튼 -->
										</div>
										<p class="review-total-count">전체 상품평 <strong>24</strong>건</p>
									</div>
				...
				$("#writeArea").css("display", "flex");
								...
								<div class="layer-content" id="writeArea" style="display: none;">
									...
									<div class="review-wt-form">
										...
										<div class="review-wt-best">
											<div class="inner">
												<h4>베스트 상품평 기준</h4>
												<ul>
													<li id="bestCommentOnOff" class="bestCommentOnOff ">상품평 100자 이상
													</li>
													<li id="fileAttachOnOff" class="fileAttachOnOff ">포토/동영상 첨부</li>
													<!-- <li>도움이 돼요 획득</li> -->
												</ul>
												<p>2개의 조건을 충족하면 <span class="mo_ent"></span>베스트 상품평 선정될 확률 UP!</p>
											</div>
											<p><span class="c_red">*</span>표시가 있는 항목은 필수 입력 항목입니다.</p>
										</div>
										...
										<div class="review-wt-textarea">
											<div class="review-wt-title">
												<span class="title-bubble">이벤트 참여 고객님께서는 #삼성전자이벤트참여 해시태그를 꼭 기입해 주세요!
												</span>
											...
											<div class="review-wt-content">
												<textarea id="commentArea" name="commentArea" cols="200" wrap="hard"
													title="리뷰 작성하는 공간" placeholder="상세한 상품평을 작성해 주세요! (100자 이상 작성 시 베스트 상품평 선정 확률 UP!)
										고객님의 소중한 상품평은 저희 삼성닷컴에게도, 다른 고객님께도 큰 도움이 되어요.
										...
										<!-- 패넷은 이벤트 배너 제외 -->
										<!-- PD 이벤트 배너 -->
										<div class="review-event-banner pc">
											<img src="//images.samsung.com/kdp/review/review_01_01_pc.png"
												alt="스타벅스 받는 방법, 베스트 상품평 쓰고 스타벅스 커피 받아가세요. 01 베스트 상품평 쓰고 동영상/사진+100자 이상 현재 위치, 02 제품 등록하고 03 응모하기">
										</div>
										<div class="review-event-banner mo">
											<img src="//images.samsung.com/kdp/review/review_01_01_mo.png"
												alt="스타벅스 받는 방법, 베스트 상품평 쓰고 스타벅스 커피 받아가세요. 01 베스트 상품평 쓰고 동영상/사진+100자 이상 현재 위치, 02 제품 등록하고 03 응모하기">
										</div>
										<!-- PD 이벤트 배너 -->
										<!-- 패넷은 이벤트 배너 제외 -->
										<!-- 상품평 이벤트 영역 -->
										<input type="hidden" id="entryEventLinkUrl" name="eventLinkUrl"
											value="event/regist-review/">
										<div class="review-event-agreement">
											<div class="review-event-agreement-wrap">
												<div class="event-apply-agree">
													<div class="inner">
														<p>2개의 조건을 충족하면 다양한 혜택이 있는 상품평 이벤트에 응모할 수 있어요!</p>
														<ul>
															<!-- 
																		* li는 조건이 충족되는 경우만 on클래스가 붙습니다.
																		* on 이 붙으면 컬러상태가 됩니다.
																	-->
															<li class="bestCommentOnOff">상품평 100자 이상</li>
															<li class="fileAttachOnOff">포토/동영상 첨부</li>
														</ul>
													</div>
													<div class="chk-form">
														<input id="chk-enter-all" type="checkbox" required="" title=""
															disabled="">
														<label for="chk-enter-all" class="chk-enter-all">상품평 이벤트 응모
															및 약관 동의(전체 동의하기)</label>
													</div>
												</div>
												<div class="event-apply-infoBox">
													<form id="eventEntryFrm" onsubmit="return false;">
														<input type="hidden" id="entryEventNo" name="eventNo"
															value="32109">
														<legend>회사 이메일 입력</legend>
														<ul class="info-list">
															<li class="">
																<div class="td-01">
																	<label for="inpEnterName" class="">성명 <span
																			class="ico-required">*<span>필수입력</span></span></label>
																</div>
																<div class="td-02">
																	<div class="srh-zoom">
																		<input type="text" id="inpEnterName"
																			name="inpEnterName" class="inp-line inp-req"
																			value="홍경표" placeholder="이름을 입력해 주세요.">
																	</div>
																</div>
															</li>
															<li class="">
																<div class="td-01">
																	<label for="inpEnterCall" class="">전화번호 <span
																			class="ico-required">*<span>필수입력</span></span></label>
																</div>
																<div class="td-02">
																	<div class="srh-zoom">
																		<input type="text" id="inpEnterCall"
																			name="inpEnterCall" class="inp-line inp-req"
																			placeholder="숫자만 입력해 주세요 ('-'제외)">
																		<div class="error-msg" id="inpEnterCallErr">
																			<p>연락처를 입력해 주세요.</p>
																		</div>
																	</div>
																</div>
														...
														<div class="dropDown-content-wrap">
															<div class="terms-area">
																<div class="chk-form">
																	<input type="checkbox" class="inp-terms entryAgreeY"
																		id="chk-policy-0" name="chk-policy-0"
																		data-policyno="53231">
																	<label for="chk-policy-0" title="개인정보 수집∙이용 동의">
																		<span class="terms-tit"><span>개인정보 수집∙이용
																				동의</span> <strong
																				class="opt">(필수)</strong></span>
																	</label>
																	<button class="moreBtn">자세히 보기</button>
																</div>
																<div class="drop-content terms-txt-wrap">
																	<div class="terms-txt">
																		<p>
																			삼성전자 주식회사(이하 ‘회사’라 합니다)는 이용자가 이벤트 참여 시
																			아래와 같은 개인정보를 수집하고 있습니다. <br>
																			이용자는 본 개인정보 수집 · 이용 동의서에 따른 동의 시, '필요한
																			최소한의 정보 외의 개인정보' 수집 · 이용에 동의하지 아니할 권리가
																			있습니다.<br>
																			개인정보 처리에 대한 상세한 사항은 삼성닷컴 홈페이지
																			(<a href="http://www.samsung.com/sec/"
																				title="새 창" target="_blank"
																				class="link blue-color">http://www.samsung.com/sec/</a>)에
																			공개한 '삼성닷컴 이벤트 개인정보처리방침'을 참조하십시오.
																			다만, 본 동의서 내용과 상충되는 부분은 본 동의서의 내용이 우선합니다.
																		</p>
																		<p>※ 귀하께서는 필수항목 수집 · 이용에 대한 동의를 거부하실 수 있으나,
																			이는 서비스 제공에 필수적으로 제공되어야 하는 정보이므로, 동의를
																			거부하실 경우 이벤트에 참여하실 수 없습니다.</p>
																		<div class="box-clause-content">
																			<div class="set">
																				<table class="termsTb">
															...
															<div class="terms-area">
																<div class="chk-form">
																	<input type="checkbox" class="inp-terms inp-opt"
																		id="chk-policy-1" name="chk-policy-1"
																		data-policyno="53229">
																	<label for="chk-policy-1"
																		title="마케팅/광고 활용 목적의 개인정보 수집·이용 동의">
																		<span class="terms-tit"><span>마케팅/광고 활용 목적의
																				개인정보 수집·이용 동의</span> <strong
																				class="opt">(선택)</strong></span>
																	</label>
																	<button class="moreBtn">자세히 보기</button>
																</div>
																<div class="drop-content terms-txt-wrap">
																	<div class="terms-txt">
																		<p>※ 귀하께서는 선택항목 수집 · 이용에 대한 동의를 거부하실 수 있으며,
																			이는 서비스 제공에 필수적으로 제공되어야 하는 정보가 아니므로, 동의를
																			거부하시더라도 이벤트 참여는 가능합니다. 다만 선택항목 수집 · 이용에
																			대하여 동의하지 않으실 경우, 이벤트 관련 제품 정보 알림, 혜택 안내
																			및 혜택 제공을 받으실 수 없으십니다.</p>
																		<div class="box-clause-content">
																			<div class="set">
																				<table class="termsTb">
																					<caption>마케팅/광고 활용 목적의 개인정보
																						수집∙이용 동의</caption>
																					<colgroup>
																						<col style="width: 25%;">
																						<col style="width: 25%;">
																					...
																					<tbody>
																						<tr>
																							...
																							<td
																								...
																								사은ㆍ판촉행사, 이벤트, 사전 알림,
																								프로모션 관련
																								SMS/MMS/LMSㆍDMㆍTMㆍE-mailㆍPush-mailㆍ카카오톡
																								등을 통한 광고 발송
																							</td>
																							<td
																								class="samsungblue-color">
															...
															<div class="terms-area">
																<div class="chk-form">
																	<input type="checkbox" class="inp-terms inp-opt"
																		id="chk-policy-2" name="chk-policy-2"
																		data-policyno="53230">
																	<label for="chk-policy-2" title="광고성 정보 수신 동의">
																		<span class="terms-tit"><span>광고성 정보 수신
																				동의</span> <strong
																				class="opt">(선택)</strong></span>
																	</label>
																	<button class="moreBtn">자세히 보기</button>
																...
																<div class="drop-content terms-txt-wrap">
																	<div class="terms-txt">
																		회사는 회사 및 제3자의 상품 또는 서비스에 대한 광고∙정보를 전송할 수
																		있습니다.
																		<p class="red-color">※ 광고성 정보 수신 동의를 거부하실 경우
																			이벤트 관련 제품 정보 알림, 혜택 안내 및 혜택 제공을 받으실 수
																			없습니다.</p>
																		※ 귀하께서 수신동의를 철회하고자 할
																		경우080-866-1166[무료수신거부]으로 철회요청을 할 수 있습니다. 한편,
																		다시 광고성 정보 수신에 동의하시려면 1588-6084에 연락하여 요청하실 수
																		있습니다.
																	</div>
																</div>
															</div>
														</div>
														<div class="dropDown-content-wrap disc">
															<div class="terms-area">
																<div class="chk-form">
																	<span class="terms-tit">상품평 이벤트 관련 유의사항</span>
																	<button class="moreBtn"></button>
																</div>
																<div class="drop-content terms-txt-wrap">
																	<div class="review-wt-caution">
																		<ul>
																			<li>
																				상품평 등록 이후 수정/삭제하여 베스트 기준 미충족 시, 베스트
																				상품평 및 이벤트 당첨에서 제외될 수 있습니다.
																			</li>
																			<li>
																				베스트 상품평 이벤트는 한 모델코드에 대해 상품평 최초 작성시에만
																				응모 가능하며, 이미 등록된 상품평 수정 시 재응모 불가능합니다.
																			</li>
																			<li>
																				하나의 모델코드 당 1회 참여 가능합니다.
																			</li>
																			<li>
																				만 14세 미만은 이벤트 참여가 불가합니다.
																			</li>
																			<li>
																				잘못된 개인정보 입력, 기타 사유 등으로 인해 연락이 불가능하거나
																				경품이 분실, 오발송 또는 반송될 경우 재발송 되지 않으며
																				당사에서 책임지지 않습니다.
																			</li>
																			<li>
																				스타벅스 기프티콘은 매월 첫째주 월요일 삼성닷컴에 등록된 핸드폰
																				번호로 mms 발송 예정입니다.
																			</li>
																			<li>
																				기프티콘 사용 기한은 발송일로부터 3개월입니다.
																			</li>
																		</ul>
																	</div>
																</div>
										...
										<script>
											$(document).ready(function () {
												$(".moreBtn").on("click", function (e) {
													...
													_this.parent().parent().children(".drop-content").toggleClass('show');
												});

												$("#chk-enter-all").change(function () {
													console.log($("#chk-enter-all").is(":checked"));
													eventBtnCtl();
												});
											});
											var eventAlertIndex = 0;
										</script>
										<!-- 상품평 이벤트 영역 -->
...
%>
					...
					<!-- s : 221221 상품평 작성가이드 -->
					<div class="layer-pop layer-normal layer-review-guide" id="popupReviewGuide" tabindex="0"
						data-popup-layer="popupReviewGuide" data-focus="popupReviewGuide">
						<div class="layer-header">
							<h2>상품평 가이드</h2>
						</div>
						<div class="layer-content">
									...
									<dl class="step">
										...
										<dd>
											...
											<dl class="pic">
												<div>
													<dt>
														<img src="https://images.samsung.com/kdp/test/review_guide_test_01.jpg"
															alt="팔목에 워치가 착용 되어있는 사진">
														<b>착용샷</b>
													</dt>
												...
												<div>
													<dt>
														<img src="https://images.samsung.com/kdp/test/review_guide_test_02.jpg"
															alt="집안에 냉장고가 배치되어있는 사진">
														<b>설치샷</b>
													</dt>
												...
												<div>
													<dt>
														<img src="https://images.samsung.com/kdp/test/review_guide_test_03.jpg"
															alt="냉장고 문을 열어 내부를 찍은 사진">
														<b>디테일</b>
													</dt>
					...
					<div class="layer-pop layer-normal layer-bestReview best-video" tabindex="0" id="popBestVideo"
						data-popup-layer="popBestVideo" data-focus="popBestVideo"><!-- 230130 best-video 클래스 추가 -->
					</div>
					<!-- e : 230106 상품평 전체보기 보기 팝업 -->

					<!-- s : 230106 상세리스트 보기 팝업-->
					<div class="layer-pop layer-normal layer-bestReview" tabindex="0" id="popBestReview"
						data-popup-layer="popBestReview" data-focus="popBestReview">
					</div>
					<!-- e : 230106 상세리스트 보기 팝업 -->

					<!-- s : 이벤트 상품평 팝업 -->
					<button type="button" style="display:none" id="completeReviewEvent"
						data-popup-target="popupReviewEventAgreement"></button>
					<div class="layer-pop layer-normal review-event-agreement-pop" id="popupReviewEventAgreement"
						tabindex="0" data-popup-layer="popupReviewEventAgreement" data-focus="popupReviewEventAgreement"
						aria-hidden="false" data-zindex="303" style="z-index: 303;">
						...
						<div class="layer-footer">
							<button type="button" class="btn btn-d btn-type3" onclick="resultLinkUrl()">이벤트
								확인하기</button>
						</div>
						<button type="button" class="pop-close-review" id="reviewEventPopClose"
							data-focus-next="popupReviewEventAgreement">팝업닫기</button>
					</div>
					<!-- e : 이벤트 상품평 팝업 -->
				</article>
				<!--3rd 파티 상품은 특장점/상품평/유의사항만 노출 -->
				...
				<article class="component-con component09" id="compGoodsNoticeInfo">
					<!-- 구매시 유의사항-->
					<div class="fixWidth">
						...
						<div class="product-purchase-wrap">
							<div class="product-purchase-wrap_tab-wrap">
								<ul class="product-purchase-caus_tab tab-style-btn target" role="tablist">
									<li><a href="javascript:;" class="on" role="tab" aria-controls="tabContent0"
											aria-selected="true" data-omni="배송정책 안내">배송정책 안내</a></li>
									<li><a href="javascript:;" class="on" role="tab" aria-controls="tabContent1"
											aria-selected="false" data-omni="교환/반품/AS 안내">교환/반품/AS 안내</a></li>
									<li><a href="javascript:;" class="on" role="tab" aria-controls="tabContent2"
											aria-selected="false" data-omni="교환/반품 불가 안내">교환/반품 불가 안내</a></li>
									<li><a href="javascript:;" class="on" role="tab" aria-controls="tabContent3"
											aria-selected="false" data-omni="판매자 정보">판매자 정보</a></li>
								</ul>
								<div class="product-purchase-caus_contents tab-content" id="tabContent0" role="tabpanel"
									style="display:block;">
									<div class="product-purchase-sec_contents" style="">
										...
										<dl class="product-purchase-sec_note">
											...
											<dd class="product-purchase-sec_note-cont">전 상품 무료배송
												<br> (단, 제주도 등 일부 도서/산간 지역은 별도 배송비가 발생할 수 있으며, 설치상품의 경우 설치 환경 등에 따라 추가
												설치비가 발생할 수 있습니다.)
											</dd>
										</dl>
										<dl class="product-purchase-sec_note">
											...
											<dd class="product-purchase-sec_note-cont">
												주문결제 후 평균 3일 이내 배송 (일, 공휴일 제외) 단, 도서/산간지역은 배송일이 추가적으로 소요될 수 있으며, 상품
												보유현황에 따라 배송일이 지연될 수 있습니다.
												<br> 아래 상품군은 지정하신 희망배송일에 상품을 배송 해 드리나 상품 보유현황 및 설치기사 상황에 따라 배송이 다소 지연될 수
												있습니다.
												<ul>
													<li>- 희망배송일 지정 가능 상품군 : 전자레인지, 청소기, 자연가습청정기</li>
													<li>- 희망배송일 지정 및 설치 상품군 : PC/모니터, 프린터, 오븐, 에어케어, 에어트랙,
														무선도킹오디오,블루레이/DVD플레이어</li>
												</ul>
										...
										<dl class="product-purchase-sec_note">
											...
											<dd class="product-purchase-sec_note-cont">
												배송 당일 오전에 SMS로 배송예정을 알리는 문자를 발송해드리며, 고객 댁에 도착하기 전 배달설치 기사가 연락 드립니다. 스팸
												처리 등으로 인해 문자를
												<br> 받지 못하는 경우가 있으니 주문내역에서 배송 상황을 확인해주시기 바랍니다.GMQDisplay 배송 상품 중에는 고가의
												프리미엄 상품들이 포함되어 있어 고객님께
												<br> 직접 전달을 원칙으로 하고 있습니다. 안전한 배송을 위해 고객님이 주문 시 지정한 배송장소 외 제3자 전달이나
												임의장소로의 배송은 제공하지 않습니다.
												<br> 설치상품을 주문 시에는 설치환경을 꼭 체크하여 주십시오.
												<ul>
													<li>- TV: 벽걸이 설치 시 설치 불가한 벽면 재질은 아닌지 확인하여 주십시오.</li>
													<li>- 냉장고/세탁기 : 설치공간 사이즈, 출입문 사이즈, 제품 사이즈를 주문 전에 확인하여 주십시오.</li>
													<li>- TV 138 cm 이상, 양문형 냉장고, 비스포크 냉장고, 스탠드형 김치냉장고, 세탁기 7 kg 이상, 건조기,
														에어드레서는 반드시 설치가 필요한 품목으로, 설치 전문가가 직접 설치, 시운전 후 이상 여부를 점검하고 있습니다.
														<br>미설치 단순 수령이 불가한 제품이오니, 고객님의 사정으로 미설치 시 배송 보류 또는 반품될 수 있습니다.
													</li>
												</ul>
											</dd>
										</dl>
										<dl class="product-purchase-sec_note">
											...
											<dd class="product-purchase-sec_note-cont">
												GMQDisplay닷컴 상단 '마이 GMQDisplay -&gt; 주문/배송조회 -&gt; 주문정보'에서 배송상태 및 배달설치
												기사 전화번호 조회가 가능합니다.</dd>
										</dl>
									</div>
								</div>
								<div class="product-purchase-caus_contents tab-content" id="tabContent1" role="tabpanel"
									style="display:none;">
									<div class="product-purchase-sec_contents" style="">
										<dl class="product-purchase-sec_note">
											<dt class="product-purchase-sec_note-title">교환/반품 기간</dt>
											<dd class="product-purchase-sec_note-cont">
												단순변심에 의한 상품의 교환ㆍ반품은 실제 상품 등을 수령하신 날부터 7일 이내에 가능합니다. 단, 상품안내 페이지에 표시된
												교환/반품 기간이 7일보다 긴 경우에는 그 기간을 따릅니다.<br>
												휴대폰/PC/프린터/태블릿/웨어러블 제품의 교환은 서비스센터에서 발급받은 불량판정서 지참시 배송완료+7일 가능합니다.<br>
												수령한 상품 등의 내용이 표시ㆍ광고 내용과 다르거나 오배송 등 계약내용과 다르게 이행된 경우에는 수령하신 날부터 3개월 이내, 그
												사실을 안 날 또는 알 수 있었던 날부터 30일 이내에 가능합니다.
												<br>제품을 교환/반품 하기 전 고객센터로 미리 연락을 주셔야 합니다.
												<br>제품 자체에 하자가 있는 경우 GMQDisplay 서비스센터(1588-3366)로 접수하시면 A/S 기사의 판정을 거친 후
												소비자분쟁해결기준에 의거하여 GMQDisplay 서비스 센터를 통해 교환/환불/수리해드립니다.
												<br> 미성년자인 고객이 구매계약을 체결한 후, 법정대리인이 그 계약에 동의하지 아니하면 본인 또는 법정대리인이 취소할 수
												있습니다.
											</dd>
										</dl>
										<dl class="product-purchase-sec_note">
											...
											<dd class="product-purchase-sec_note-cont">
												구매하신 상품의 교환ㆍ반품을 하시는 경우에는 상품 등의 반환에 필요한 비용(2,500원)을 고객님이 부담하셔야 합니다. 단,
												고객님이 받으신 상품 등의 내용이 표시ㆍ광고 내용과 다르거나 제품하자ㆍ오배송 등 계약내용과 다르게 이행되어 교환/반품을 하시는
												경우에는, 교환ㆍ반품 배송비는 무료입니다.</dd>
										</dl>
										<dl class="product-purchase-sec_note">
										...
										<dl class="product-purchase-sec_note">
											...
											<dd class="product-purchase-sec_note-cont">
												<span id="harman-text" style="display: none;">GMQDisplay닷컴에서 판매되는 상품에
													대해서는 하만오디오 전문서비스센터로 문의하시면 A/S가 가능합니다. (상품A/S 문의전화: <a
														href="tel:02-553-3494" class="phone">02-553-3494</a>)</span>
												<span id="general-text">GMQDisplay닷컴에서 판매되는 상품에 대해서는 가까운
													GMQDisplay서비스센터를 방문하시면 A/S가 가능합니다. (상품A/S 문의전화: <a
														href="tel:1588-3366" class="phone">1588-3366</a>) <br>
													일부제품의 경우 GMQDisplay 서비스센터에서 A/S가 불가능하므로, [스펙] -&gt; [상품기본정보] 의 [A/S
													책임자와 전화번호] 정보를 확인하시기 바랍니다</span>
											</dd>
										</dl>
									</div>
								</div>
								<div class="product-purchase-caus_contents tab-content" id="tabContent2" role="tabpanel"
									style="display:none;">
									<div class="product-purchase-sec_contents" style="">
										<dl class="product-purchase-sec_note">
											...
											<dd class="product-purchase-sec_note-cont">
												<ul>
													<li>- 고객님의 책임 있는 사유로 상품이 멸실 또는 훼손된 경우
														<br> (다만, 단순히 상품의 내용을 확인하기 위해 포장 등을 훼손한 경우는 제외)
													</li>
													<li>- 고객님의 사용으로 상품가치가 현저히 감소된 경우</li>
													<li>- 패키지 상품의 경우 구성상품 일부의 개봉/설치/사용으로 상품가치가 현저히 감소된 경우</li>

													<li>* 무약정폰의 경우 반품은 상품을 수령하신 날부터 7일 이내, 통신사 개통 이전에만 가능합니다.</li>
													<li>- 시간이 경과되어 재판매가 곤란할 정도로 상품가치가 상실된 경우</li>
													<li>- 복제가 가능한 상품의 경우 그 원본인 상품의 포장이 훼손된 경우</li>
													<li>- 설치완료 상품에 하자가 없는 경우</li>
													<li>- 상품 등의 내용이 표시ㆍ광고 내용 및 계약내용과 같고, 별도의 하자가 없음에도 단순변심으로 인한 교환을 요구하는
														경우</li>
													<li>- 기타, '전자상거래 등에서의 소비자보호에 관한 법률' 등 관계법령이 정하는 교환/반품 제한사유에 해당되는 경우
													</li>
													<ul>
													</ul>
												</ul>
								...
								<div class="product-purchase-caus_contents tab-content" id="tabContent3" role="tabpanel"
									style="display:none;">
										...
										<div class="product-purchase-sec_sellerwrap">
											...
											<div class="product-purchase-sec_seller">
												...
												<dl>
													...
													<dd><a href="tel:1588-3366"
															class="phone">1588-3366(GMQDisplay고객센터)</a></dd>
											...
											<div class="product-purchase-sec_seller">
												...
												<dl style="margin-top:0">
													...
													<dd>경기도 수원시 영통구 GMQDisplay로 129(매탄동)</dd>
	...
	<!-- s : 패밀리넷 구매 동의 -->
	<div class="layer-pop layer-normal layer-family-agree" id="popupFmailyAgree" tabindex="0"
		data-popup-layer="popupFmailyAgree" data-focus="popupFmailyAgree">
		<div class="layer-header">
			<h2>패밀리넷 동일 품목 다량 구매 관련 안내</h2>
		</div>
		<div class="layer-content">
		...
		<div class="menu-list">
			<div class="inner">
				...
				<ul>
					...
					<li class="menuGift"><a href="javascript:gift_open();" data-omni="float chat:event gift">선물하기</a>
					</li>
				</ul>
			</div>
		</div>
	...
	<footer id="footer" class="footer_b2c">
				...
				<ul>
					...
					<li class="productLine2">
						...
						<ul>
							...
							<li><a href="./qooker/bespoke-qooker/index.html" data-omni="product_qooker">GMQD Live</a>
							</li>
						</ul>
					</li>
					<li>
						...
						<ul>
							...
							<li><a href="./GMQDisplay-Care-Plus/CE/index.html"
									data-omni="faq_samsung care plus CE">GMQDisplay Care+</a></li>
						</ul>
					</li>
					<li>
						<h3>
							...
							<li>
								...
								<ul>
									<li><a href="./about-us/company-info/index.html"
											data-omni="about-us_company-info">사이트 정보</a></li>
									<li><a href="./about-us/business-area/index.html"
											data-omni="about-us_business-area">사이트 개요</a></li>
									<li><a href="./about-us/brand-identity/index.html"
											data-omni="about-us_brand-identity">아이덴티티</a></li>
								</ul>
							</li>
						</ul>
					</li>
						...
						<ul>
							<li>
								...
								<ul>
									...
									<li><a href="./about-us/brand-identity/index.html"
											data-omni="about-us_brand-identity">브랜드 아이덴티티</a></li>
								</ul>
							</li>
						</ul>
					</li>
				...
				<div class="info-detail">
					<p>
						...
						<span class="comp-wrap"><a
								...
								class="comp" title="새창 열림" target="_blank">사업자 정보확인</a></span>
					...
					<div class="dis-resol">
						<p>개별 판매자 판매 상품의 경우 GMQDisplay(주)는 통신판매중개업자로서 통신판매의 당사자가 아니므로, 개별 판매자가 등록한 상품, 거래정보 및 거래 등에 대해
							책임을 지지 않습니다.</p>
		...
		<div class="footer-content">
			<div class="footer-inner btnBottomGroup">
				<div class="cs-btn">
					<ul class="korean">
						<li><a href="./function/ipredirection/ipredirectionLocalList/index.html">한국/한국어 </a></li>
						<!-- 200918 추가 -->
					</ul>
					<ul>
						<li><a href="javascript:void(0);" title="이메일 무단 수집거부" data-popup-target="popupGatherRefuse"
								data-omni="footer:bottom_email_security">이메일 무단 수집거부</a></li>
					...
					<div id="dropClauseList01" class="wrap-droplist rounded clause-use">
						...
						<ul class="droplist" tabindex="-1" aria-labelledby="dropServiceClauseTitle"
							...
							<li id="optServiceClause02" class="droplist-item" data-omni="footer:terms_legal"><a
									...
									target="_blank" title="새 창으로 열림">GMQDisplay 대표사이트 이용약관</a></li>
							<li id="optServiceClause03" class="droplist-item" data-omni="footer:terms_conditions"><a
									href="./membership/terms/index.html">GMQDisplay멤버십 이용약관</a></li>
							<li id="optServiceClause04" class="droplist-item" data-omni="footer:terms_contents"><a
									...
									title="새 창으로 열림">GMQDisplay 서비스 이용약관</a></li>
						</ul>
					</div>
					<!-- s : Accessible Dropdown -->
					<div id="dropClauseList02" class="wrap-droplist rounded  clause-private">
						...
						<ul class="droplist" tabindex="-1" aria-labelledby="dropServicePrivateTitle"
							...
							<li id="optServicePrivate02" class="droplist-item"><a
									href="./info/privacy/01/index.html">GMQD 개인정보처리방침</a></li>
							<li id="optServicePrivate03" class="droplist-item"><a
									href="./info/privacy/02/index.html">GMQD 이벤트 개인정보처리방침</a></li>
							<li id="optServicePrivate04" class="droplist-item"><a
									href="./info/privacy/03/index.html">GMQDisplay멤버십 개인정보처리방침</a></li>
							<li id="optServicePrivate05" class="droplist-item"><a
									href="./info/privacy/04/index.html">멤버십블루 개인정보처리방침</a></li>
							<li id="optServicePrivate06" class="droplist-item"><a
									href="./info/privacy/05/index.html">경력채용 개인정보처리방침</a></li>
						</ul>
					</div>
	...
	<div class="layer-pop layer-normal" id="popupIdeaPolicy" tabindex="0" data-popup-layer="popupIdeaPolicy"
		...
		<div class="layer-content">
			<div class="etc-divWrap">
				<p>GMQDisplay 및 GMQDisplay 임직원은 당사가 공식적으로 요청하지 않았음에도 불구하고 여러분께서 일방적으로 당사에 제출하는 아이디어나 제안 등을 수령하거나 검토하지
					않습니다.</p>
				<p>이는 제출하신 내용이 당사 내부적으로 개발한 제품, 기술, 서비스와 유사할 경우 발생할 수 있는 오해와 분쟁을 방지하고 나아가 여러분의 창의적인 아이디어를 적극 보호하기 위함입니다.
				</p>
