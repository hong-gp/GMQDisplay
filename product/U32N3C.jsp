	...
	<div class="pd-Container" id="pd-inner-cont">
		<div class="pg-location ">
			<div class="pg-location-inner">
				...
				<span>알파스캔 AOC U32N3C 4K UHD USB-C 프리싱크 높낮이 HDR 무결점</span>
			</div>
		</div>

		<section class="content" role="product_content_search">
			<div id="goods_detail_wrap" class="conbox" data-ctpath="/sec/" data-kakaokey="5880e4317936087f2764a5d340e6bca6" data-facebookid="" data-goods-id="U32N3C"
			data-goods-tp-cd="10" data-goods-Nm="알파스캔 AOC U32N3C 4K UHD USB-C 프리싱크 높낮이 HDR 무결점" data-admin-yn="" data-admin-price-yn="" data-task-id="" data-task-dtl-no="">

				<input type="hidden" name="returnUrl" value="./../static/images/product/U32N3C"/>
				<!-- s : 제품구매영역 -->
		...
		<div class="prod-image">
			<div class="prod-image-view">
				<div>
							<img src="./../static/images/product/U32N3C_1.png" alt="알파스캔 AOC U32N3C 4K UHD USB-C 프리싱크 높낮이 HDR 무결점 U32N3C정면" data-img-tp="10" data-seq="1">
				</div>
					<div>
							<img src="./../static/images/product/U32N3C_2.png" data-lazy="./../static/images/product/U32N3C_2.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 좌측 30도" data-img-tp="10" data-seq="2">
								</div>
					<div>
							<img src="./../static/images/product/U32N3C_3.png" data-lazy="./../static/images/product/U32N3C_3.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 우측 30도" data-img-tp="10" data-seq="3">
								</div>
					<div>
							<img src="./../static/images/product/U32N3C_4.png" data-lazy="./../static/images/product/U32N3C_4.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 모서리 디테일" data-img-tp="10" data-seq="4">
								</div>
					<div>
							<img src="./../static/images/product/U32N3C_5.png" data-lazy="./../static/images/product/U32N3C_5.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 피봇" data-img-tp="10" data-seq="5">
								</div>
					</div>
			<div class="prod-image-navi-wrap">
				<ol class="prod-image-navi">
					<li><span><a href="javascript:;"><img src="./../static/images/product/U32N3C_1.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 정면"></a></span></li>
						<li><span><a href="javascript:;"><img src="./../static/images/product/U32N3C_2.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 좌측 30도"></a></span></li>
						<li><span><a href="javascript:;"><img src="./../static/images/product/U32N3C_3.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 우측 30도"></a></span></li>
						<li><span><a href="javascript:;"><img src="./../static/images/product/U32N3C_4.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 모서리 디테일"></a></span></li>
						<li><span><a href="javascript:;"><img src="./../static/images/product/U32N3C_5.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 피봇"></a></span></li>
						</ol>
			</div>
			<div class="opt-btn">
				<!-- 이미지 삭제 및 em 태그 추가 -->
		...
		$("#mySpriteSpin").spritespin({
              ...
              // 로딩시 자동 롤링
					...
					<script type="text/javascript">
						$(document).ready(function () {
							...
							if(!isReady){
								...
								//옵션 변경
								$(goodsMain.vGoodsWrapId).data("goods-id", "U32N3C");
							}
							...
							//비교하기 버튼 클래스 추가
							$(".link-compare-i").addClass(isCompareDataStorageGoods("U32N3C")?'disabled':'');
				...
				/* 			var goodsOrdTpCd = ""
						...
						<div class="itm-info-detail" id="itmInfoDetail" data-mdl-code="U32N3C" data-url-nm="monitors" data-fmy-grp-nm="gaming-ls27bg654ekxkr-d2c" data-goods-nm="알파스캔 AOC U32N3C 4K UHD USB-C 프리싱크 높낮이 HDR 무결점" data-sale-stat="12" data-mdl-nm="U32N3C" data-fmy-eng-nm="gaming-ls27bg654ekxkr-d2c" data-goods-id="G000277237" data-envmt-gb-cd="prd" data-fast-dlvr-yn="N">
							...
							<input type="hidden" name="goodsNm" id="goodsNm" value="알파스캔 AOC U32N3C 4K UHD USB-C 프리싱크 높낮이 HDR 무결점">
							<input type="hidden" name="mdlCode" id="mdlCode" value="U32N3C">
...
function Urlsend(sns) {
    var thisUrl = "http://localhost:8080/GMQDisplay-master/product/U32N3C.jsp";
						...
						<div class="bookmarkTooltip flashTooltip bookmarkOn">
							<div>
							 ...
							 <div class="bookmarkTooltip flashTooltip bookmarkOff">
								...
								<h1 class="itm-info-title" id="goodsDetailNm">알파스캔 AOC U32N3C 4K UHD USB-C 프리싱크 높낮이 HDR 무결점</h1>
								<div class="itm-sku b2c-itm-sku compare-box-align">U32N3C</div>
										<!-- B2C, 패넷, 패넷 디플 PD페이지 비교하기 버튼 추가 s --> 
										<div class="compare">
												<a href="javascript:void(0);" class="link-compare-i" onclick="readyCompare(this)" data-goods-id="U32N3C" data-mdl-code="U32N3C " data-comp-disp-clsf-en-nm="monitors">
												비교하기
												</a>
											</div>
							...
							<!-- 가격이 없을 경우 영역 노출 X -->
								<script>
									...
									<div class="itm-price itm-type">
										<div>
											<input type="hidden" id="originalPrice" value="591260">	                               		
											<input type="hidden" id="discountAmount" value="0">
											<input type="hidden" id="lastPrice" value="591260">
										...
										<dt>기준가
											 ...
											 <dd>
												<span data-price="591260" class="pd-total-price">591,260</span>원
											</dd>
										</dl>
												<script type="text/javascript">
													if('591260' == '0'){
												...
												<dt>회원가</dt>
												<!-- 회원가 -->
												<dd><span class="discount" style="text-decoration-line: line-through">570,000</span>원</dd>
												</dl>
...
<form name="form" method="post" action="/GMQDisplay-master/order/order.jsp">
	<input type="hidden" name="Mno" value="U32N3C" />
											...
											<div class="dropDown-content itm-eventInfo">
												<div id="membership-info">
													<a href="javascript:MemDisplay();" class="dropButton" id="membershipDropBtn">
														<span>GMQDisplay 멤버십 <strong id="membership-ptn-top">5512 포인트</strong> 적립</span>
														...
														<div class="dropcontent" id="TabMembership">
															<div class="casewrap point-nomember" style="display: block;" >
																<p class="emphasis-txt border-line">GMQ Display
																	<em class="case-blue membership-ptn"> 포인트 5512 (기본 0.1%)</em> 적립 예정
																</p>
										...
										<!-- 회원 할인 적용 예상가 -->
											...
											<a class="sp-custom-c1071-1 ins-banner" href="javascript:void(0);"><div class="ins-pd-inline-banner" style="margin-top:15px;"></div></a>
												...
												<div  class="tooltip-content1" style="display:none;" id="divToggle3">
													<p style="margin-top:10px;"><b>할인 금액</b> : 40,000원</p>
												</div>
												</dt>
													<strong data-price="551260">551,260</strong><span>원</span>
												</dl>
											</div>
																					 <div class="box-btn">
																								<div class="box-cto">
...
<!-- 추가된 부분 -->
	    ...
	    <section class="component-bar" role="product_content_search">
	        <div class="component-bar-inner">
	            <div>
	                <div class="itm-title-text" id="goods-title-text">알파스캔 AOC U32N3C 4K UHD USB-C 프리싱크 높낮이 HDR 무결점</div>
...
<div class="wrap-component feature-benefit pt-none pb-none w1440px img-bottom" >
	<div class="component-contents  pt-wide pb-none txt-mid-center txtm-top-center "  style="background-color=black " data-cptnm="">
		<div class="visual-area ">
			<img src="./../static/images/explain/U32N3C_1.png"" class="objGif">
			<img src="./../static/images/explain/U32N3C_2.png"" class="objGif">
			<img src="./../static/images/explain/U32N3C_3.png"" class="objGif">
			<img src="./../static/images/explain/U32N3C_4.png"" class="objGif">
			<img src="./../static/images/explain/U32N3C_5.png"" class="objGif">
			<img src="./../static/images/explain/U32N3C_6.png"" class="objGif">
			<img src="./../static/images/explain/U32N3C_7.png"" class="objGif">
			<img src="./../static/images/explain/U32N3C_8.png"" class="objGif">
		</div>
	</div>
</div>
...
<div class="spec-table-wrap"><h3 class="spec-itm-title" id="cstrt-nm">알파스캔 AOC U32N3C 4K UHD USB-C 프리싱크 높낮이 HDR 무결점</h3>
...
<p class="spec-desc">4ms (GTG, OD)&nbsp;</p>
</li>
<li>
...
<p class="spec-desc">715 x 504 x 273mmmm&nbsp;</p>
</li>
<li>
<strong class="spec-title">제품 무게(kg)</strong>
<p class="spec-desc">9.86 kg&nbsp;</p>
</li>
</ol>
</dd>
</dl>
...
<p class="spec-desc">R-R-TPF-U32N3&nbsp;</p>
</li>
<li>
						...
						-->
											...
											<div class="review-lt-keywordsbar">
												...
												try {
													...
													sql_keyword += "WHERE Mno='U32N3C' AND review_keyword LIKE '%G01%' UNION ALL ";
													sql_keyword += "SELECT 'G02' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='U32N3C' AND review_keyword LIKE '%G02%' UNION ALL ";
													sql_keyword += "SELECT 'G03' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='U32N3C' AND review_keyword LIKE '%G03%' UNION ALL ";
													sql_keyword += "SELECT 'G04' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='U32N3C' AND review_keyword LIKE '%G04%' UNION ALL ";
													sql_keyword += "SELECT 'G05' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='U32N3C' AND review_keyword LIKE '%G05%' UNION ALL ";
													sql_keyword += "SELECT 'G06' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='U32N3C' AND review_keyword LIKE '%G06%' UNION ALL ";
													sql_keyword += "SELECT 'G07' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='U32N3C' AND review_keyword LIKE '%G07%' UNION ALL ";
													sql_keyword += "SELECT 'G08' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='U32N3C' AND review_keyword LIKE '%G08%' UNION ALL ";
													sql_keyword += "SELECT 'G09' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='U32N3C' AND review_keyword LIKE '%G09%' UNION ALL ";
													sql_keyword += "SELECT 'G10' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='U32N3C' AND review_keyword LIKE '%G10%' UNION ALL ";
													sql_keyword += "SELECT 'G99' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='U32N3C' AND review_keyword LIKE '%G99%'";
									...
									<div class="review-content-body">
										...
										<div id="commentList">
											...
											<%
											// 작성된 리뷰 조회
											String sql_list = "SELECT * FROM review WHERE Mno='U32N3C'";
