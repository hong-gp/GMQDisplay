	...
	<div class="pd-Container" id="pd-inner-cont">
		<div class="pg-location ">
			<div class="pg-location-inner">
				...
				<span>ASUS VG278QR 165 게이밍</span>
			</div>
		</div>

		<section class="content" role="product_content_search">
			<div id="goods_detail_wrap" class="conbox" data-ctpath="/sec/" data-kakaokey="5880e4317936087f2764a5d340e6bca6" data-facebookid="" data-goods-id="VG278QR"
			data-goods-tp-cd="10" data-goods-Nm="ASUS VG278QR 165 게이밍" data-admin-yn="" data-admin-price-yn="" data-task-id="" data-task-dtl-no="">

				<input type="hidden" name="returnUrl" value="./../static/images/product/VG278QR"/>
				<!-- s : 제품구매영역 -->
		...
		<div class="prod-image">
			<div class="prod-image-view">
				<div>
							<img src="./../static/images/product/VG278QR_1.png" alt="ASUS VG278QR 165 게이밍 VG278QR정면" data-img-tp="10" data-seq="1">
				</div>
					<div>
							<img src="./../static/images/product/VG278QR_2.png" data-lazy="./../static/images/product/VG278QR_2.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 좌측 30도" data-img-tp="10" data-seq="2">
								</div>
					<div>
							<img src="./../static/images/product/VG278QR_3.png" data-lazy="./../static/images/product/VG278QR_3.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 우측 30도" data-img-tp="10" data-seq="3">
								</div>
					<div>
							<img src="./../static/images/product/VG278QR_4.png" data-lazy="./../static/images/product/VG278QR_4.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 모서리 디테일" data-img-tp="10" data-seq="4">
								</div>
					<div>
							<img src="./../static/images/product/VG278QR_5.png" data-lazy="./../static/images/product/VG278QR_5.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 피봇" data-img-tp="10" data-seq="5">
								</div>
					</div>
			<div class="prod-image-navi-wrap">
				<ol class="prod-image-navi">
					<li><span><a href="javascript:;"><img src="./../static/images/product/VG278QR_1.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 정면"></a></span></li>
						<li><span><a href="javascript:;"><img src="./../static/images/product/VG278QR_2.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 좌측 30도"></a></span></li>
						<li><span><a href="javascript:;"><img src="./../static/images/product/VG278QR_3.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 우측 30도"></a></span></li>
						<li><span><a href="javascript:;"><img src="./../static/images/product/VG278QR_4.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 모서리 디테일"></a></span></li>
						<li><span><a href="javascript:;"><img src="./../static/images/product/VG278QR_5.png" alt="오디세이 게이밍 모니터 60.4 cm 블랙 피봇"></a></span></li>
						</ol>
			</div>
			<div class="opt-btn">
				<!-- 이미지 삭제 및 em 태그 추가 -->
		...
		$("#mySpriteSpin").spritespin({
              ...
              // 로딩시 자동 롤링
					...
					<script type="text/javascript">
						$(document).ready(function () {
							...
							if(!isReady){
								...
								//옵션 변경
								$(goodsMain.vGoodsWrapId).data("goods-id", "VG278QR");
							}
							...
							//비교하기 버튼 클래스 추가
							$(".link-compare-i").addClass(isCompareDataStorageGoods("VG278QR")?'disabled':'');
				...
				/* 			var goodsOrdTpCd = ""
						...
						<div class="itm-info-detail" id="itmInfoDetail" data-mdl-code="VG278QR" data-url-nm="monitors" data-fmy-grp-nm="gaming-ls27bg654ekxkr-d2c" data-goods-nm="ASUS VG278QR 165 게이밍" data-sale-stat="12" data-mdl-nm="VG278QR" data-fmy-eng-nm="gaming-ls27bg654ekxkr-d2c" data-goods-id="G000277237" data-envmt-gb-cd="prd" data-fast-dlvr-yn="N">
							...
							<input type="hidden" name="goodsNm" id="goodsNm" value="ASUS VG278QR 165 게이밍">
							<input type="hidden" name="mdlCode" id="mdlCode" value="VG278QR">
...
function Urlsend(sns) {
    var thisUrl = "http://localhost:8080/GMQDisplay-master/product/VG278QR.jsp";
						...
						<div class="bookmarkTooltip flashTooltip bookmarkOn">
							<div>
							 ...
							 <div class="bookmarkTooltip flashTooltip bookmarkOff">
								...
								<h1 class="itm-info-title" id="goodsDetailNm">ASUS VG278QR 165 게이밍</h1>
								<div class="itm-sku b2c-itm-sku compare-box-align">VG278QR</div>
										<!-- B2C, 패넷, 패넷 디플 PD페이지 비교하기 버튼 추가 s --> 
										<div class="compare">
												<a href="javascript:void(0);" class="link-compare-i" onclick="readyCompare(this)" data-goods-id="VG278QR" data-mdl-code="VG278QR " data-comp-disp-clsf-en-nm="monitors">
												비교하기
												</a>
											</div>
							...
							<!-- 가격이 없을 경우 영역 노출 X -->
								<script>
									...
									<div class="itm-price itm-type">
										<div>
											<input type="hidden" id="originalPrice" value="268990">	                               		
											<input type="hidden" id="discountAmount" value="0">
											<input type="hidden" id="lastPrice" value="268990">
										...
										<dt>기준가
											 ...
											 <dd>
												<span data-price="268990" class="pd-total-price">268,990</span>원
											</dd>
										</dl>
												<script type="text/javascript">
													if('268990' == '0'){
												...
												<dt>회원가</dt>
												<!-- 회원가 -->
												<dd><span class="discount" style="text-decoration-line: line-through">250,000</span>원</dd>
												</dl>
...
<form name="form" method="post" action="/GMQDisplay-master/order/order.jsp">
	<input type="hidden" name="Mno" value="VG278QR" />
											...
											<div class="dropDown-content itm-eventInfo">
												<div id="membership-info">
													<a href="javascript:MemDisplay();" class="dropButton" id="membershipDropBtn">
														<span>GMQDisplay 멤버십 <strong id="membership-ptn-top">2389 포인트</strong> 적립</span>
														...
														<div class="dropcontent" id="TabMembership">
															<div class="casewrap point-nomember" style="display: block;" >
																<p class="emphasis-txt border-line">GMQ Display
																	<em class="case-blue membership-ptn"> 포인트 2389 (기본 0.1%)</em> 적립 예정
																</p>
										...
										<!-- 회원 할인 적용 예상가 -->
											...
											<a class="sp-custom-c1071-1 ins-banner" href="javascript:void(0);"><div class="ins-pd-inline-banner" style="margin-top:15px;"></div></a>
												...
												<div  class="tooltip-content1" style="display:none;" id="divToggle3">
													<p style="margin-top:10px;"><b>할인 금액</b> : 30,000원</p>
												</div>
												</dt>
													<strong data-price="238990">238,990</strong><span>원</span>
												</dl>
											</div>
																					 <div class="box-btn">
																								<div class="box-cto">
...
<!-- 추가된 부분 -->
	    ...
	    <section class="component-bar" role="product_content_search">
	        <div class="component-bar-inner">
	            <div>
	                <div class="itm-title-text" id="goods-title-text">ASUS VG278QR 165 게이밍</div>
...
<div class="wrap-component feature-benefit pt-none pb-none w1440px img-bottom" >
	<div class="component-contents  pt-wide pb-none txt-mid-center txtm-top-center "  style="background-color:white;" data-cptnm="">	
<div class="visual-area">
	<img src="./../static/images/explain/asus.png">
	<img src="./../static/images/explain/VG278QR_1.png" class="objGif">
</div>
</div>
</div>
		...
		<div class="component-text">
			<div class="component-text-inner">
				<div class="box-title">
					...
					<h2 class="title mo-ver lrg" style="color:red">ASUS VG278QR 165 Gaming</h2><br>
					<h2 class="title pc-ver lrg" style="color:red">ASUS VG278QR 165 Gaming</h2><br>

					<h2 class="title mo-ver lrg" style="color:black">&nbsp;<br>·&nbsp;한계를 뛰어넘는 165Hz 주사율<br>·&nbsp;초고속 0.5ms 응답속도<br>·&nbsp;어떠한 속도에도 끊김 없는 극한의 반응속도</h2>
					<h2 class="title pc-ver lrg" style="color:black">&nbsp;<br>·&nbsp;한계를 뛰어넘는 165Hz 주사율<br>·&nbsp;초고속 0.5ms 응답속도<br>·&nbsp;어떠한 속도에도 끊김 없는 극한의 반응속도</h2>
				</div>
			</div>
		</div>	
	</div>
...
<div class="wrap-component feature-benefit pt-none pb-none w1440px img-bottom      ">
	<div class="component-contents  pt-wide pb-none txt-mid-center txtm-top-center "  style="background-color:#FFFFFF" data-cptnm="">
		<div class="visual-area  ">
			<img src="./../static/images/explain/VG278QR_2.png" class="objGif">
		</div>
		<div class="component-text">
			<div class="component-text-inner">
				<div class="box-title">
					<h2 class="title mo-ver lrg" style="color:#FFB400">ASUS만의 Gameplus 기술</h2><br>	
					<h2 class="title pc-ver lrg" style="color:#FFB400">ASUS만의 Gameplus 기술</h2><br>

					<p class="desc mo-ver "style="color:black;">ASUS VG278QR은 게임에서 게이머를 유리하게 하고 향상시킬 수 있는 기능을 제공하는 <br>ASUS만의 GamePlus Hotkey를 제공합니다.</p>
					<p class="desc pc-ver "style="color:black;">ASUS VG278QR은 게임에서 게이머를 유리하게 하고 향상시킬 수 있는 기능을 제공하는 <br>ASUS만의 GamePlus Hotkey를 제공합니다.</p>

					<p class="desc mo-ver "style="color:black;">이 기능은 프로게이머와의 공조로 개발되었으며 게임 내 스킬을 연마하고 향상시킬 수 있습니다.<br><br>크로스헤어 오버레이는 4가지 타입 제공으로 게이머에게 가장 적합한 형태의 크로스헤어를 선택하여 플레이할 수 있습니다.</p>
					<p class="desc pc-ver "style="color:black;">이 기능은 프로게이머와의 공조로 개발되었으며 게임 내 스킬을 연마하고 향상시킬 수 있습니다.<br><br>크로스헤어 오버레이는 4가지 타입 제공으로 게이머에게 가장 적합한 형태의 크로스헤어를 선택하여 플레이할 수 있습니다.</p>
				</div>
			</div>
		</div>		
	</div>
...
<div class="wrap-component feature-benefit pt-none pb-none w1440px img-bottom      ">
	<div class="component-contents  pt-wide pb-none txt-mid-center txtm-top-center "  style="background-color:#FFFFFF" data-cptnm="">
	<div class="visual-area  ">
		<img src="./../static/images/explain/VG278QR_3.png" class="objGif">
	</div>
		<div class="component-text">
			<div class="component-text-inner">
				<div class="box-title">
					<h2 class="title mo-ver lrg" style="color:#FFB400">ASUS만의 독점 GameVisual 기술</h2><br>	
					<h2 class="title pc-ver lrg" style="color:#FFB400">ASUS만의 독점 GameVisual 기술</h2><br>

					<p class="desc mo-ver "style="color:black;">ASUS GameVisual 기술은 다양한 유형 그리고 게임 장르에 대한 영상 최적화를 위해 7가지의 디스플레이모드를 제공합니다.<br><br>이 고유한 기능은 Hotkey 및 OSD(On Screen Display) 설정 메뉴를 통해 쉽게 접근할 수 있습니다.<br><br><br></p><br>
					<p class="desc pc-ver "style="color:black;">ASUS GameVisual 기술은 다양한 유형 그리고 게임 장르에 대한 영상 최적화를 위해 7가지의 디스플레이모드를 제공합니다.<br><br>이 고유한 기능은 Hotkey 및 OSD(On Screen Display) 설정 메뉴를 통해 쉽게 접근할 수 있습니다.<br><br><br></p><br>

					<h2 class="title mo-ver lrg" style="color:#FFB400">ASUS-exclusive GamePlus Technology</h2><br>	
					<h2 class="title pc-ver lrg" style="color:#FFB400">ASUS-exclusive GamePlus Technology</h2><br>

					<p class="desc mo-ver "style="color:black;">인 게임에서 필요한 필수 정보만을 표시하여 전략적으로 한 발 더 앞서 나갈 수 있는 상황을 제공합니다.</p>
					<p class="desc pc-ver "style="color:black;">인 게임에서 필요한 필수 정보만을 표시하여 전략적으로 한 발 더 앞서 나갈 수 있는 상황을 제공합니다.</p>
				</div>
			</div>
		</div>
	</div>
...
<div class="component-contents  pt-wide pb-none txt-mid-center txtm-top-center "  style="background-color:#FFFFFF" data-cptnm="">
		<div class="visual-area  ">
<!-- 세번째 사진 -->
<img src="./../static/images/explain/VG278QR_4.png"" class="objGif">	
</div>
...
<div class="spec-table-wrap"><h3 class="spec-itm-title" id="cstrt-nm">ASUS VG278QR 165 게이밍</h3>
...
<p class="spec-desc">TN&nbsp;</p>
</li>
<li><strong class="spec-title">백라이트 유형</strong>
<p class="spec-desc">LED&nbsp;</p>
</li>
<li><strong class="spec-title">밝기(Brightness)</strong>
<p class="spec-desc">400cd&nbsp;</p>
</li>
<li>
...
<p class="spec-desc">1,920 x 1,080(UHD)&nbsp;</p>
</li>
<li>
<strong class="spec-title">응답속도 (ms)</strong>
<p class="spec-desc">0.5ms(GTG)&nbsp;</p>
</li>
<li>
<strong class="spec-title">시야각(수평/수직)</strong>
<p class="spec-desc">170°(H)/160°(V)&nbsp;</p>
</li>
<li>
...
<li>
<strong class="spec-title">블루라이트 차단</strong>
<p class="spec-desc">지원&nbsp;</p>
</li>
<li>
<strong class="spec-title">눈부심 방지</strong>
<p class="spec-desc">지원&nbsp;</p>
</li>
<li>
<strong class="spec-title">헤드폰 아웃</strong>
<p class="spec-desc">지원&nbsp;</p>
</li>
<li>
<strong class="spec-title">Trace Free Technology</strong>
<p class="spec-desc">지원&nbsp;</p>
</li>
<li>
<strong class="spec-title">HDCP 지원</strong>
<p class="spec-desc">지원&nbsp;</p>
</li>
<li>
<strong class="spec-title">ARR 기술</strong>
<p class="spec-desc">지원&nbsp;</p>
</li>
<li>
<strong class="spec-title">FreeSync Premium</strong>
<p class="spec-desc">지원&nbsp;</p>
</li>
<li>
<strong class="spec-title">AMD FreeSync™</strong>
<p class="spec-desc">지원&nbsp;</p>
</li>
<li>
...
<li>
<strong class="spec-title">Adaptive Sync</strong>
<p class="spec-desc">지원&nbsp;</p>
</li>
</ol>
</dd>
...
<ol>
<li>
<strong class="spec-title">HDMI 1.4</strong>
...
<ol>
<li>
<strong class="spec-title">스텐드 포함 시 제품크기(HxWxD)(mm)</strong>
<p class="spec-desc">619 x 506 x 211mm&nbsp;</p>
</li>
<li>
<strong class="spec-title">스텐드 제외 제품크기(HxWxD)(mm)</strong>
<p class="spec-desc"> 619 x 363 x 50mm&nbsp;</p>
</li>
<li>
<strong class="spec-title">제품 무게(kg)</strong>
<p class="spec-desc">5.6kg&nbsp;</p>
</li>
</ol>
</dd>
</dl>
...
<p class="spec-desc">Display Port케이블, 듀얼 링크 DVI 케이블, HDMI 케이블, 전원 어댑터, 전원코드, 빠른 시작 가이드, 보증 카드&nbsp;</p>
</li>
</ol>
</dd>
</dl>
...
<p class="spec-desc">ASUS&nbsp;</p>
</li>
<li>
<strong class="spec-title">등록년월</strong>
<p class="spec-desc">2019년 03월&nbsp;</p>
</li>
</ol>
</dd>
</dl>
						...
						-->
											...
											<div class="review-lt-keywordsbar">
												...
												try {
													...
													sql_keyword += "WHERE Mno='VG278QR' AND review_keyword LIKE '%G01%' UNION ALL ";
													sql_keyword += "SELECT 'G02' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='VG278QR' AND review_keyword LIKE '%G02%' UNION ALL ";
													sql_keyword += "SELECT 'G03' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='VG278QR' AND review_keyword LIKE '%G03%' UNION ALL ";
													sql_keyword += "SELECT 'G04' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='VG278QR' AND review_keyword LIKE '%G04%' UNION ALL ";
													sql_keyword += "SELECT 'G05' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='VG278QR' AND review_keyword LIKE '%G05%' UNION ALL ";
													sql_keyword += "SELECT 'G06' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='VG278QR' AND review_keyword LIKE '%G06%' UNION ALL ";
													sql_keyword += "SELECT 'G07' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='VG278QR' AND review_keyword LIKE '%G07%' UNION ALL ";
													sql_keyword += "SELECT 'G08' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='VG278QR' AND review_keyword LIKE '%G08%' UNION ALL ";
													sql_keyword += "SELECT 'G09' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='VG278QR' AND review_keyword LIKE '%G09%' UNION ALL ";
													sql_keyword += "SELECT 'G10' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='VG278QR' AND review_keyword LIKE '%G10%' UNION ALL ";
													sql_keyword += "SELECT 'G99' AS category, COUNT(*) AS count FROM review ";
													sql_keyword += "WHERE Mno='VG278QR' AND review_keyword LIKE '%G99%'";
									...
									<div class="review-content-body">
										...
										<div id="commentList">
											...
											<%
											// 작성된 리뷰 조회
											String sql_list = "SELECT * FROM review WHERE Mno='VG278QR'";
