...
try {
	...
	String sql = "SELECT * FROM product WHERE Mgenre=? AND Mresolution=? AND Mform=? AND Msize=? AND (Mprice BETWEEN ? AND ?) AND Msupport=?"; 
										...
										<div class="dtl">
											...
											<div class="price-detail">
												...
												<div class="sale">
													...
													<button class="btn-downtool" aria-hidden="true" id="toggle<%=rs2.getString("Mno")%>">
